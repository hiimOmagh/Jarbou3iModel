# Public Demo — v1.4.0-alpha.6 Provider Execution Harness Mock-to-Live Equivalence

The public demo remains a static/manual workflow surface. v1.4.0-alpha.6 adds deterministic dry-run replay packaging and operator approval simulation only.
