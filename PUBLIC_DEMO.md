# Public Demo — v1.1.0-rc.2-fix.1 — Lock Evidence Workspace Hygiene Fix
...
Public surface: `v1.1.0 Stable Candidate`. Internal RC validation metadata remains `1.1.0-rc.2-fix.1` until stable lock.
