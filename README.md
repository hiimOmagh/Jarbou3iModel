...
- Current package version: `1.4.0-alpha.18`.
- Current release: `v1.4.0-alpha.18 — Alpha.17 Lock Completion + Evidence Budget Dashboard Actionability`.
- Public version label: v1.4.0-alpha.18 Evidence Budget Dashboard Actionability.
