...
- Current package version: `1.4.0-alpha.20`.
- Current release: `v1.4.0-alpha.20 — Alpha.19 Lock Completion + Evidence Decision Ledger Handoff Audit`.
- Public version label: v1.4.0-alpha.20 Evidence Decision Ledger Handoff Audit.
