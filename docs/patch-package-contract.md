...
Public label: v1.4.0-alpha.64 Live Evidence Performance Trend Diff Bundle Inclusion
...
Patch packages remain manual-copy only. Live Evidence Performance Trend Diff Bundle Inclusion adds no executable patch workflow and preserves changed-files-only hygiene.
