...
Public label: v1.4.0-alpha.60 Evidence Performance Ledger Reader + Trend Diff Guard
...
Patch packages remain manual-copy only. Evidence Performance Ledger Reader + Trend Diff Guard adds no executable patch workflow and preserves changed-files-only hygiene.
