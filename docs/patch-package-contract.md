...
Public label: v1.4.0-alpha.59 Evidence Capture Performance Trend Ledger
...
Patch packages remain manual-copy only. Evidence Capture Performance Trend Ledger adds no executable patch workflow and preserves changed-files-only hygiene.
