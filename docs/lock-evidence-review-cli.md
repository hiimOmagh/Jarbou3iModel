...
Current release: v1.4.0-alpha.59 — Evidence Capture Performance Trend Ledger
...
```powershell
node scripts/lock-evidence-review.mjs --bundle .\lock-evidence-bundle_1.4.0-alpha.59_<run_id>
```
...
```powershell
node scripts/lock-evidence-review.mjs --bundle .\lock-evidence-bundle_1.4.0-alpha.59_<run_id>.zip
```
...
```powershell
node scripts/lock-evidence-review.mjs --bundle .\lock-evidence-bundle_1.4.0-alpha.59_<run_id>.zip --json
```
