...
Current release: v1.4.0-alpha.58 — Hosted Evidence Capture Timeout Budget Guard
...
```powershell
node scripts/lock-evidence-review.mjs --bundle .\lock-evidence-bundle_1.4.0-alpha.58_<run_id>
```
...
```powershell
node scripts/lock-evidence-review.mjs --bundle .\lock-evidence-bundle_1.4.0-alpha.58_<run_id>.zip
```
...
```powershell
node scripts/lock-evidence-review.mjs --bundle .\lock-evidence-bundle_1.4.0-alpha.58_<run_id>.zip --json
```
