...
```powershell
node scripts/lock-evidence-review.mjs --bundle .\lock-evidence-bundle_1.4.0-alpha.64_<run_id>
```
...
```powershell
node scripts/lock-evidence-review.mjs --bundle .\lock-evidence-bundle_1.4.0-alpha.64_<run_id>.zip
```
...
```powershell
node scripts/lock-evidence-review.mjs --bundle .\lock-evidence-bundle_1.4.0-alpha.64_<run_id>.zip --json
```
