...
`v1.1.0-alpha.22` treats every exported JSON payload as a security boundary and preserves the privacy gate while public-demo release approval is locked.
...
Current release reference: v1.1.0-alpha.22 — Evidence Pack Export v3 + Brief Traceability. release-lock evidence remains required.
