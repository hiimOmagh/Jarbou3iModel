...
`v1.1.0-rc.2` treats every exported JSON payload as a security boundary and preserves the privacy gate while public-demo release approval is locked.
...
Current release reference: v1.1.0-rc.2 — Canonical Lock Evidence Bundle + Final Stable Handoff. release-lock evidence remains required.
