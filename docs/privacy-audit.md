...
`v1.1.0-rc.2-fix.1` treats every exported JSON payload as a security boundary and preserves the privacy gate while public-demo release approval is locked.
...
Current release reference: v1.1.0-rc.2-fix.1 — Lock Evidence Workspace Hygiene Fix. release-lock evidence remains required.
