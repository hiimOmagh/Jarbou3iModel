...
`v1.1.0-rc.2-fix.3` treats every exported JSON payload as a security boundary and preserves the privacy gate while public-demo release approval is locked.
...
Evidence manifest continuity: v1.1.0-rc.2-fix.3 preserves the single final metadata hosted-demo evidence manifest gate.
...
Release-lock guard: v1.1.0-rc.2-fix.3 Evidence Workflow Exit-Code + Matrix Activation Fix requires green no-browser CI, green browser CI, and reviewed hosted-demo evidence. Screenshots alone are insufficient. ZIP existence alone is insufficient. A local ZIP archive alone is insufficient.

Current release reference: v1.1.0-rc.2-fix.3 — Evidence Workflow Exit-Code + Matrix Activation Fix. release-lock evidence remains required.
