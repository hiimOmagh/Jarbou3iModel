...
`v1.1.0-alpha.25` treats every exported JSON payload as a security boundary and preserves the privacy gate while public-demo release approval is locked.
...
Current release reference: v1.1.0-alpha.25 — Release Candidate Hardening + Final Repo Hygiene. release-lock evidence remains required.
