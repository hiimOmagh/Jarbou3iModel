...
`v1.1.0-rc.1-copyfix.1` treats every exported JSON payload as a security boundary and preserves the privacy gate while public-demo release approval is locked.
...
Current release reference: v1.1.0-rc.1-copyfix.1 — Stable Consolidation + Public Surface Freeze. release-lock evidence remains required.
