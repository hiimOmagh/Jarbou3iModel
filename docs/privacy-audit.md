...
`v1.1.0-alpha.20` treats every exported JSON payload as a security boundary and preserves the privacy gate while public-demo release approval is locked.
...
Current release reference: v1.1.0-alpha.20 — Provider Router + Cost-Aware Run Ledger. release-lock evidence remains required.
