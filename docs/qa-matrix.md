...
Current release candidate: v1.2.0-alpha.4 — Evidence Review Throughput + Source-to-Brief Export Polish
...
Node 24 CI compatibility is preserved for v1.2.0-alpha.4.
