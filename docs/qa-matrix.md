...
- `tests/evidence-surface-budget-enforcement-lock-completion-check.mjs`
...
Current release candidate: v1.4.0-alpha.16 — Alpha.15 Lock Completion + Evidence Surface Budget Enforcement
