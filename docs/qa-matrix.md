...
- v1.1.0-alpha.10 — Hosted Evidence Capture Polish + Visual Artifact Guard: test-matrix runtime optimization, release doc timeline pruning, no runtime behavior change.
