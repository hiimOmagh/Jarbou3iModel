...
Current release reference: v1.4.0-alpha.19 — Alpha.18 Lock Completion + Evidence Dashboard Decision Ledger. No-network replay QA only; no default live execution, hidden network calls, real credentials, live/provider/OAuth/backend/source/storage expansion, credential persistence, or automatic source fetching. Locked stable baseline: v1.3.0 — Stable Manual Workflow Release. Locked mock-to-live baseline: v1.4.0-alpha.6 — Provider Execution Harness Mock-to-Live Equivalence. Locked trace/readiness baseline: v1.4.0-alpha.4 — Dry-Run Trace Inspector + Execution Readiness Report.
...
- Release: `v1.4.0-alpha.19 — Alpha.18 Lock Completion + Evidence Dashboard Decision Ledger`
