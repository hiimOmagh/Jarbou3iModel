...
The screenshots must show no horizontal overflow, visible first-run/public-demo/hosted-demo/evidence-review panels, reachable provider/export states, and a metadata snapshot with app version `1.1.0-alpha.21` and the evidence-review panel present.
...
- Current root artifact consolidation: `v1.1.0-alpha.21 — Evidence Workspace UX Hardening + Review Throughput`
