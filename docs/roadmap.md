...
Current milestone: `v1.4.0-alpha.2 — Provider/Source Execution Policy Matrix + Failure UX Contracts`

Purpose: define provider/source execution policy states and failure UX contracts after the locked `v1.4.0-alpha.1 — Controlled Provider/Source Execution Preparation`. This is a planning/control-plane milestone only.
...
1. `v1.4.0-alpha.2 — Provider/Source Execution Policy Matrix + Failure UX Contracts` — planning/control-plane only.
2. `v1.4.0-alpha.3 — Provider Execution Harness Mock-to-Live Equivalence` — still no default live execution.
3. `v1.4.0-alpha.4 — Source Acquisition Control Surface` — controlled source modes without uncontrolled scraping.
4. `v1.4.0-alpha.5 — Credential Boundary Runtime Drill` — leak tests and redaction drills.
...
No alpha.3 should start until v1.4.0-alpha.2 is locked with green no-browser CI, green browser CI, hosted evidence, and canonical lock evidence bundle.
...
Node 24 CI compatibility remains mandatory for v1.4.0-alpha.2 and later.
