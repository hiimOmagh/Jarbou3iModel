...
|---|---:|---|---|
| Current alpha | `v1.1.0-alpha.2` | **Version Suite Registry + Package Script Compression** | Current |
...
| Next implementation candidate | `v1.1.0-alpha.5` | **Version Suite Registry + Package Script Compression** | Planned |
