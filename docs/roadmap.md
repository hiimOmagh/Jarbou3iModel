...
Current milestone: `v1.4.0-alpha.4 — Dry-Run Trace Inspector + Execution Readiness Report`

Purpose: make deterministic dry-run traces reviewable and report execution-readiness gaps after the locked `v1.4.0-alpha.3 — Provider/Source Dry-Run Execution Harness + Policy Simulator`. This is a planning/control-plane milestone only.
...
1. `v1.4.0-alpha.4 — Dry-Run Trace Inspector + Execution Readiness Report` — deterministic trace review/readiness reporting only.
2. `v1.4.0-alpha.5 — Provider Execution Harness Mock-to-Live Equivalence` — still no default live execution.
3. `v1.4.0-alpha.6 — Source Acquisition Control Surface` — controlled source modes without uncontrolled scraping.
4. `v1.4.0-alpha.7 — Credential Boundary Runtime Drill` — leak tests and redaction drills.
...
No alpha.5 should start until v1.4.0-alpha.4 is locked with green no-browser CI, green browser CI, hosted evidence, and canonical lock evidence bundle.
...
Node 24 CI compatibility remains mandatory for v1.4.0-alpha.4 and later.
