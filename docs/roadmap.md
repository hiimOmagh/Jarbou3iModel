...
|---|---:|---|---|
| Current alpha | `v1.1.0-alpha.2` | **Root Manifest + Release Artifact Consolidation** | Current |
...
| Next implementation candidate | `v1.1.0-alpha.6` | **Root Manifest + Release Artifact Consolidation** | Planned |
