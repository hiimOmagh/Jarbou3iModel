...
assert.equal(
  ...
  false,
  'CI workflow must not pin Node 20 after v1.1.0-alpha.1 Node 24 action-runtime migration'
);
...
assert.ok(
  ...
  'CI workflow must pin project test runtime to Node 24 for v1.1.0-alpha.1 compatibility validation'
);
