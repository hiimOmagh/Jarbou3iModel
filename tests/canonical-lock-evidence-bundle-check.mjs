...
const PUBLIC_LABEL = 'v1.2.0-alpha.7 Review Quality Diagnostics + Weak-Claim Repair Suggestions';
...
for (const token of [
  ...
  'lock-evidence-bundle_1.2.0-alpha.7_${{ github.run_id }}',
...
assert.ok(workflow.includes("summary.internal_build_version !== '1.2.0-alpha.7'"), 'browser job must assert matrix summary version');
