...
assert.ok(fs.existsSync(path.join(bundleDir, 'performance-trends', 'hosted-evidence-performance-trend-ledger.json')), 'bundle must include hosted evidence trend diff ledger JSON');
assert.ok(fs.existsSync(path.join(bundleDir, 'performance-trends', 'hosted-evidence-performance-trend-ledger.md')), 'bundle must include hosted evidence trend diff ledger Markdown');
