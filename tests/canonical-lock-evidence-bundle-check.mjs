...
const PUBLIC_LABEL = 'v1.3.0-alpha.6 Operator Signoff State + Export Lock Ledger';
...
for (const token of [
  ...
  'lock-evidence-bundle_1.3.0-alpha.6_${{ github.run_id }}',
...
assert.ok(workflow.includes("summary.internal_build_version !== '1.3.0-alpha.6'"), 'browser job must assert matrix summary version');
