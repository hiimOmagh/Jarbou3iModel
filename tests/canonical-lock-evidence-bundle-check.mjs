...
const PUBLIC_LABEL = 'v1.2.0-alpha.1 Post-Stable Capability Roadmap + Expansion Gate';
...
for (const token of [
  ...
  'lock-evidence-bundle_1.2.0-alpha.1_${{ github.run_id }}',
...
assert.ok(workflow.includes("summary.internal_build_version !== '1.2.0-alpha.1'"), 'browser job must assert matrix summary version');
