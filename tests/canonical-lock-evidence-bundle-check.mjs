...
for (const token of [
  ...
  'lock-evidence-bundle_1.3.0-rc.1_${{ github.run_id }}',
...
assert.ok(workflow.includes("summary.internal_build_version !== '1.3.0-rc.1'"), 'browser job must assert matrix summary version');
