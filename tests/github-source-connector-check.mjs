...
const req = connectors.buildSourceTaskRequest({ version:'1.1.0-rc.2-fix.1', connector:'github_public_repo', github_repo:'octocat/Hello-World', topic:'GitHub source test', task:'source_plan' });
...
globalThis.fetch = async (url, options = {}) => {
  ...
  if (String(url).includes('/releases')) {
    return new Response(JSON.stringify([{ id:1, tag_name:'v1.1.0-rc.2-fix.1', name:'v1.1.0-rc.2-fix.1', draft:false, prerelease:false, created_at:'2026-01-04T00:00:00Z', published_at:'2026-01-05T00:00:00Z', html_url:'https://github.com/octocat/Hello-World/releases/tag/v1.1.0-rc.2-fix.1' }]), {status:200, headers:{'content-type':'application/json'}});
  }
...
assert.equal(body.proxy_version, '1.1.0-rc.2-fix.1');
