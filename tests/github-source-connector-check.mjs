...
const req = connectors.buildSourceTaskRequest({ version:'1.1.0-alpha.16', connector:'github_public_repo', github_repo:'octocat/Hello-World', topic:'GitHub source test', task:'source_plan' });
...
assert.equal(body.proxy_version, '1.1.0-alpha.16');
