...
assert.ok(index.includes('v1.3.0-alpha.8 · Signed Export Handoff Pack + Lock Ledger Review Surface'), 'index badge must expose v1.1.0 visual-freeze identity');
...
assert.ok(migrations.includes("'1.0.28','1.0.29','1.0.30','1.1.0-alpha.1','1.1.0-alpha.2','1.1.0-alpha.3','1.1.0-alpha.8','1.1.0-alpha.9','1.1.0-alpha.10','1.3.0-alpha.8'"), 'migration order must preserve v1.0.30 freeze baseline and append v1.1.0');
