...
assert.equal(lock.version, CURRENT_VERSION, 'package-lock root version must be v1.4.0-alpha.7');
assert.equal(lock.packages[''].version, CURRENT_VERSION, 'package-lock package version must be v1.4.0-alpha.7');
