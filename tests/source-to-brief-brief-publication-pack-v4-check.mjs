...
for (const marker of ['Provider/Source Execution Policy Matrix + Failure UX Contracts','حزمة النشر v4','Matrice de politique d’exécution fournisseur/source + contrats UX d’échec']) assert.ok(helpers.includes(marker), `localized copy missing ${marker}`);
