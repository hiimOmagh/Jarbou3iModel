...
for (const marker of ['Source Acquisition Control Surface','سطح التحكم في اكتساب المصادر','Surface de contrôle d’acquisition des sources']) assert.ok(helpers.includes(marker), `localized copy missing ${marker}`);
