...
for (const marker of ['Dry-Run Replay Pack + Operator Approval Simulation','حزمة النشر v4','Pack de rejeu dry-run + simulation d’approbation opérateur']) assert.ok(helpers.includes(marker), `localized copy missing ${marker}`);
