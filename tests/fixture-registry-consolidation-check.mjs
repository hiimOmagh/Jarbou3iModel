...
const PATCH_ARTIFACT = 'jarbou3i-research-engine-v1.3.0-rc.1-manual-workflow-release-candidate-freeze.zip';
...
const currentMigration = getMigrationFixture('fixtures/migrations/v1.3.0-rc.1-packet.json');
const currentPrivacy = getPrivacyFixture('fixtures/privacy/browser-generated-export-v1.3.0-rc.1.json');
