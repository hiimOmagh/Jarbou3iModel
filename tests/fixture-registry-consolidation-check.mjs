...
const PATCH_ARTIFACT = 'jarbou3i-research-engine-v1.3.0-alpha.8-signed-export-handoff-pack-lock-ledger-review-surface.zip';
...
const currentMigration = getMigrationFixture('fixtures/migrations/v1.3.0-alpha.8-packet.json');
const currentPrivacy = getPrivacyFixture('fixtures/privacy/browser-generated-export-v1.3.0-alpha.8.json');
