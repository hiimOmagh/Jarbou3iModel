...
const PATCH_ARTIFACT = 'jarbou3i-research-engine-v1.3.0-alpha.7-post-stable-capability-roadmap-expansion-gate.zip';
...
const currentMigration = getMigrationFixture('fixtures/migrations/v1.3.0-alpha.7-packet.json');
const currentPrivacy = getPrivacyFixture('fixtures/privacy/browser-generated-export-v1.3.0-alpha.7.json');
