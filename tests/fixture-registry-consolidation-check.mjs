...
const currentMigration = getMigrationFixture('fixtures/migrations/v1.1.0-packet.json');
const currentPrivacy = getPrivacyFixture('fixtures/privacy/browser-generated-export-v1.1.0.json');
