...
const PATCH_ARTIFACT = 'jarbou3i-research-engine-v1.3.0-rc.2-rc-evidence-tightening-release-notes-finalization.zip';
...
const currentMigration = getMigrationFixture('fixtures/migrations/v1.3.0-rc.2-packet.json');
const currentPrivacy = getPrivacyFixture('fixtures/privacy/browser-generated-export-v1.3.0-rc.2.json');
