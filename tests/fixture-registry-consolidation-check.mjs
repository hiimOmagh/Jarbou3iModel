...
const PATCH_ARTIFACT = 'jarbou3i-research-engine-v1.2.0-alpha.8-post-stable-capability-roadmap-expansion-gate.zip';
...
const currentMigration = getMigrationFixture('fixtures/migrations/v1.2.0-alpha.8-packet.json');
const currentPrivacy = getPrivacyFixture('fixtures/privacy/browser-generated-export-v1.2.0-alpha.8.json');
