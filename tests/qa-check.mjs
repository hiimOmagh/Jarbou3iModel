...
if (pkg.version !== '1.4.0-alpha.2') fail('package version must be 1.4.0-alpha.2');
if (!index.includes('name="app-version" content="1.4.0-alpha.2"')) fail('app version metadata missing');
