...
if (pkg.version !== '1.3.0-alpha.8') fail('package version must be 1.3.0-alpha.8');
if (!index.includes('name="app-version" content="1.3.0-alpha.8"')) fail('app version metadata missing');
...
if (researchSchema.properties?.workflow_version?.const !== '1.3.0-alpha.8') fail('research workflow schema version mismatch');
