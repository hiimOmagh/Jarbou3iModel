...
if (!index.includes('name="app-version" content="1.1.0"')) fail('app version metadata missing');
...
if (researchSchema.properties?.workflow_version?.const !== '1.1.0') fail('research workflow schema version mismatch');
