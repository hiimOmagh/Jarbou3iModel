...
if (pkg.version !== '1.3.0-rc.2') fail('package version must be 1.3.0-rc.2');
if (!index.includes('name="app-version" content="1.3.0-rc.2"')) fail('app version metadata missing');
...
if (researchSchema.properties?.workflow_version?.const !== '1.3.0-rc.2') fail('research workflow schema version mismatch');
