...
if (pkg.version !== '1.0.20') fail('package version must be 1.0.20');
if (!index.includes('name="app-version" content="1.0.20"')) fail('app version metadata missing');
...
if (researchSchema.properties?.workflow_version?.const !== '1.0.20') fail('research workflow schema version mismatch');
