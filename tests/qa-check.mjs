...
if (pkg.version !== '1.1.0-rc.1-copyfix.1') fail('package version must be 1.1.0-rc.1-copyfix.1');
if (!index.includes('name="app-version" content="1.1.0-rc.1-copyfix.1"')) fail('app version metadata missing');
...
if (researchSchema.properties?.workflow_version?.const !== '1.1.0-rc.1-copyfix.1') fail('research workflow schema version mismatch');
