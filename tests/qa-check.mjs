...
if (pkg.version !== '1.2.0-alpha.5') fail('package version must be 1.2.0-alpha.5');
if (!index.includes('name="app-version" content="1.2.0-alpha.5"')) fail('app version metadata missing');
...
if (researchSchema.properties?.workflow_version?.const !== '1.2.0-alpha.5') fail('research workflow schema version mismatch');
