...
assert.ok(index.includes('v1.2.0-alpha.1 Post-Stable Capability Roadmap + Expansion Gate') && index.includes('Post-Stable Capability Roadmap + Expansion Gate'), 'index visible badge must show stable candidate consolidation');
...
assert.ok(publicDemo.includes('1.2.0-alpha.1') && /hosted.*evidence|hosted.*metadata/i.test(publicDemo), 'public demo must state hosted evidence lock requirement');
...
console.log('Post-Stable Capability Roadmap + Expansion Gate checks passed.');
process.exit(0);
