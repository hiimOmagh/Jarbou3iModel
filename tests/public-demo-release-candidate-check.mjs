...
assert.ok(index.includes('v1.1.0 Stable Candidate') && index.includes('Canonical Lock Evidence Bundle + Final Stable Handoff'), 'index visible badge must show stable candidate consolidation');
...
assert.ok(publicDemo.includes('1.1.0-rc.2') && /hosted.*evidence|hosted.*metadata/i.test(publicDemo), 'public demo must state hosted evidence lock requirement');
...
console.log('Canonical Lock Evidence Bundle + Final Stable Handoff checks passed.');
process.exit(0);
