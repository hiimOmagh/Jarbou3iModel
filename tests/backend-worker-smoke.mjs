...
if (!body.ok || body.proxy_version !== '1.1.0-rc.1') fail('health response missing expected version/ok fields');
...
if (body.proxy_version !== '1.1.0-rc.1') fail('provider task response version mismatch');
