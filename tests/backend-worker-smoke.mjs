...
if (!body.ok || body.proxy_version !== '1.2.0-alpha.6') fail('health response missing expected version/ok fields');
...
if (body.proxy_version !== '1.2.0-alpha.6') fail('provider task response version mismatch');
