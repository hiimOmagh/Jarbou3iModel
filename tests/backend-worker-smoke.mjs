...
if (!body.ok || body.proxy_version !== '1.3.0-rc.2') fail('health response missing expected version/ok fields');
...
if (body.proxy_version !== '1.3.0-rc.2') fail('provider task response version mismatch');
