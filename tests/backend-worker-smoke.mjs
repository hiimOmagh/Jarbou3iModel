...
if (!body.ok || body.proxy_version !== '1.2.0-alpha.5') fail('health response missing expected version/ok fields');
...
if (body.proxy_version !== '1.2.0-alpha.5') fail('provider task response version mismatch');
