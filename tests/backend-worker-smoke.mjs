...
if (!body.ok || body.proxy_version !== '1.3.0-alpha.10') fail('health response missing expected version/ok fields');
...
if (body.proxy_version !== '1.3.0-alpha.10') fail('provider task response version mismatch');
