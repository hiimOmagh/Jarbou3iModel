...
if (!body.ok || body.proxy_version !== '1.0.21') fail('health response missing expected version/ok fields');
...
if (body.proxy_version !== '1.0.21') fail('provider task response version mismatch');
