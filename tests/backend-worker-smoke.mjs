...
if (!body.ok || body.proxy_version !== '1.1.0-alpha.23') fail('health response missing expected version/ok fields');
...
if (body.proxy_version !== '1.1.0-alpha.23') fail('provider task response version mismatch');
