...
assert.equal(mod.MODEL, 'source_to_brief_publication_readiness_suite.v1');
...
assert.equal(suite.source_to_brief_publication_readiness_suite_version, VERSION);
assert.equal(suite.milestone, MILESTONE);
assert.equal(suite.model, 'source_to_brief_publication_readiness_suite.v1');
...
assert.equal(suite.publication_readiness_safety_contract.source_to_brief_publication_readiness_suite_only, true);
...
assert.ok(index.includes('Source-to-Brief Publication Readiness Suite'), 'index must expose current publication readiness title');
assert.ok(index.includes('src="src/research/source-to-brief-publication-readiness-suite.js" defer'), 'index must load current publication readiness module');
assert.ok(index.includes('data-browser-qa="source-to-brief-publication-readiness-suite"'), 'index must expose current publication readiness browser QA surface');
