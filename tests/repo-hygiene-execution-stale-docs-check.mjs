...
for (const corpus of [releaseDoc, manifest, notes, changelog, roadmap, qaMatrix]) {
  assert.ok(corpus.includes('v1.1.0-alpha.25'), 'release corpus must mention v1.1.0-alpha.25');
...
assert.ok(aiIntegration.includes('## Current state: v1.1.0-alpha.25'), 'AI integration doc must name current v1.1.0-alpha.25 state');
...
assert.ok(architecture.includes('## Current v1.1.0-alpha.25 pipeline'), 'architecture doc must name current v1.1.0-alpha.25 pipeline');
...
assert.ok(privacyAudit.includes('`v1.1.0-alpha.25` treats every exported JSON payload as a security boundary'), 'privacy audit doc must name v1.1.0-alpha.25 boundary');
...
assert.ok(migrations.includes("release_title:'v1.1.0-alpha.25 — Release Candidate Hardening + Final Repo Hygiene'"), 'migration default release title must identify v1.1.0-alpha.25');
