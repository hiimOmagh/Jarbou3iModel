...
assert.ok(migrations.includes("release_title:'v1.2.0-alpha.1 — Post-Stable Capability Roadmap + Expansion Gate'"), 'migration default release title must identify v1.1.0');
