...
assert.ok(releaseDocExists(`docs/v${VERSION}-graph-export-strategic-evidence-map.md`), 'alpha.19 release doc must exist in release history');
const doc = readReleaseDoc(`docs/v${VERSION}-graph-export-strategic-evidence-map.md`);
