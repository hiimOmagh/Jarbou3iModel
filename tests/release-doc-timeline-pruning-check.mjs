...
assert.ok(releaseDocExists(`docs/v${VERSION}-provider-router-cost-aware-run-ledger.md`), 'alpha.19 release doc must exist in release history');
const doc = readReleaseDoc(`docs/v${VERSION}-provider-router-cost-aware-run-ledger.md`);
