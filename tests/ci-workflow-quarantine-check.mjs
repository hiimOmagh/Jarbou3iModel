...
assert.ok(workflow.includes(`summary.internal_build_version !== '1.4.0-alpha.43'`), 'browser matrix guard must validate v1.4.0-alpha.28 internal build version');
assert.ok(workflow.includes(`lock-evidence-bundle_1.4.0-alpha.43_`), 'lock evidence artifact must be versioned as v1.4.0-alpha.28');
...
assert.equal(evidenceMatrix.internal_build_version, '1.4.0-alpha.43', 'evidence matrix internal version must identify v1.4.0-alpha.28');
...
for (const marker of [
  ...
  'Targeted Hosted Evidence Capture'
]) {
