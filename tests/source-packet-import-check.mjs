...
assert.equal(schema.$defs.source_import_report.properties.import_version.const, '1.3.0-alpha.3');
...
for (const packet of [fixture, migrationFixture, privacyFixture]) {
  ...
  assert.equal(packet.source_import_report.import_version, '1.3.0-alpha.3');
