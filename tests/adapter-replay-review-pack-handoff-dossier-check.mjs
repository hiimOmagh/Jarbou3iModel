...
assert.ok([VERSION, '1.4.0-alpha.36'].includes(registry.runtime_optimization.version), 'runtime optimization may advance to alpha.36 while preserving alpha.35 handoff dossier');
assert.ok(['adapter_replay_review_pack_handoff_dossier', 'adapter_replay_review_pack_operator_review_console'].includes(registry.runtime_optimization.optimization_scope), 'runtime optimization may advance to alpha.36 operator review console while preserving alpha.35 handoff dossier');
