...
assert.ok([VERSION, '1.4.0-alpha.36'].includes(registry.runtime_optimization.version), 'runtime optimization may advance to alpha.35 while preserving alpha.34 triage workbench');
assert.ok(['adapter_replay_review_pack_triage_workbench', 'adapter_replay_review_pack_operator_review_console'].includes(registry.runtime_optimization.optimization_scope), 'runtime optimization may advance to alpha.35 handoff dossier while preserving alpha.34 triage workbench');
