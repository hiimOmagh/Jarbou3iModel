...
assert.ok([VERSION, '1.4.0-alpha.40'].includes(registry.runtime_optimization.version), 'runtime optimization may advance to alpha.35 while preserving alpha.34 triage workbench');
assert.ok(['adapter_replay_review_pack_triage_workbench', 'source_to_brief_operator_continuity_console', 'source_to_brief_publication_readiness_suite'].includes(registry.runtime_optimization.optimization_scope), 'runtime optimization may advance to alpha.35 handoff dossier while preserving alpha.34 triage workbench');
