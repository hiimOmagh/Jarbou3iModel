...
assert.equal(pkg.version, '1.1.0-rc.2-fix.3', 'package version must be v1.1.0-rc.2-fix.3');
assert.equal(pkg.type, 'module', 'package.json must declare package-level ESM mode');
assert.ok(worker.includes("const VERSION = '1.1.0-rc.2-fix.3'"), 'Worker proxy version must be v1.1.0-rc.2-fix.3');
