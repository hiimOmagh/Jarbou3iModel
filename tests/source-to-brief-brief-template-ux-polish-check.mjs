...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.2 Provider/Source Execution Policy Matrix + Failure UX Contracts');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Provider/Source Execution Policy Matrix + Failure UX Contracts'));
