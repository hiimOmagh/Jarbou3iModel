...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.42 Manual Workflow UX Consolidation');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Manual Workflow UX Consolidation'));
