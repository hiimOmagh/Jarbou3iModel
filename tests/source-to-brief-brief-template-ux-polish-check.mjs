...
assert.equal(matrix.public_version_label, 'v1.3.0-rc.1 Manual Workflow Release Candidate Freeze');
...
assert.ok(matrix.language_rules.en.required.includes('Manual Workflow Release Candidate Freeze'));
