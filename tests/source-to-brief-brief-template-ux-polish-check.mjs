...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.8 Credential Boundary Runtime Drill');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Credential Boundary Runtime Drill'));
