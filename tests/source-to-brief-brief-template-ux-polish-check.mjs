...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.5 Dry-Run Replay Pack + Operator Approval Simulation');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Dry-Run Replay Pack + Operator Approval Simulation'));
