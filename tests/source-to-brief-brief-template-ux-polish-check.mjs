...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.35 Adapter Replay Review Pack Handoff Dossier');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Adapter Replay Review Pack Handoff Dossier'));
