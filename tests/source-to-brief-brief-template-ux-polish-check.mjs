...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.20 Evidence Decision Ledger Handoff Audit');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Evidence Decision Ledger Handoff Audit'));
