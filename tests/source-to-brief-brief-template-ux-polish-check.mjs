...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.11 Manual Execution Safety Cockpit + Session Ledger');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Manual Execution Safety Cockpit + Session Ledger'));
