...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.13 Adapter Contract Test Bench + No-Network Invocation Replay QA');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Adapter Contract Test Bench + No-Network Invocation Replay QA'));
