...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.30 Release Identity Single Source Contract');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Release Identity Single Source Contract'));
