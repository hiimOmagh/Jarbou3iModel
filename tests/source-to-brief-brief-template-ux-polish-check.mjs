...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.27 Adapter Replay Decision Drilldown + Evidence Trace Links');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Adapter Replay Decision Drilldown + Evidence Trace Links'));
