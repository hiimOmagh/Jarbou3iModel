...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.18 Evidence Budget Dashboard Actionability');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Evidence Budget Dashboard Actionability'));
