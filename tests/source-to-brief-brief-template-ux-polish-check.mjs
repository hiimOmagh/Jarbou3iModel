...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.3 Provider/Source Dry-Run Execution Harness + Policy Simulator');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Provider/Source Dry-Run Execution Harness + Policy Simulator'));
