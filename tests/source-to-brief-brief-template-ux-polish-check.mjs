...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.17 Evidence Budget Regression Dashboard');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Evidence Budget Regression Dashboard'));
