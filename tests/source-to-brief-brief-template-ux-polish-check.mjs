...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.29 Adapter Replay Review Pack UI Polish + Export Preview');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Adapter Replay Review Pack UI Polish + Export Preview'));
