...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.26 Adapter Replay Insight UX + Operator Decision Surface');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Adapter Replay Insight UX + Operator Decision Surface'));
