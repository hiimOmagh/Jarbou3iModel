...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.39 Source-to-Brief Operator Control Room');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Source-to-Brief Operator Control Room'));
