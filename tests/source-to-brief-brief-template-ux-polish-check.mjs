...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.4 Dry-Run Trace Inspector + Execution Readiness Report');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Dry-Run Trace Inspector + Execution Readiness Report'));
