...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.22 Handoff Productivity Command Center');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Handoff Productivity Command Center'));
