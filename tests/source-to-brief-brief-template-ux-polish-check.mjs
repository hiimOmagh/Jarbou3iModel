...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.14 Adapter Replay Fixture Corpus + Coverage Matrix');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Adapter Replay Fixture Corpus + Coverage Matrix'));
