...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.7 Source Acquisition Control Surface');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Source Acquisition Control Surface'));
