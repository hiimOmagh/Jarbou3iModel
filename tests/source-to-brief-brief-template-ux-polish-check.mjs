...
assert.equal(matrix.public_version_label, 'v1.3.0-alpha.6 Operator Signoff State + Export Lock Ledger');
...
assert.ok(matrix.language_rules.en.required.includes('Operator Signoff State + Export Lock Ledger'));
