...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.28 Adapter Replay Review Pack + Operator Handoff Export');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Adapter Replay Review Pack + Operator Handoff Export'));
