...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.12 Manual Provider Adapter Sandbox + Ephemeral Invocation Contract');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Manual Provider Adapter Sandbox + Ephemeral Invocation Contract'));
