...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.36 Adapter Replay Review Pack Operator Review Console');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Adapter Replay Review Pack Operator Review Console'));
