...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.32 Adapter Replay Review Pack Evidence Trace Reader');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Adapter Replay Review Pack Evidence Trace Reader'));
