...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.21 Evidence Handoff Readiness Checklist');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Evidence Handoff Readiness Checklist'));
