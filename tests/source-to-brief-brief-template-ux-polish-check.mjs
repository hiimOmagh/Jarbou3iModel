...
assert.equal(matrix.public_version_label, 'v1.4.0-alpha.6 Provider Execution Harness Mock-to-Live Equivalence');
...
assert.ok(matrix.language_rules.en.required.includes('Stable Manual Workflow Release') || matrix.language_rules.en.required.includes('Provider Execution Harness Mock-to-Live Equivalence'));
