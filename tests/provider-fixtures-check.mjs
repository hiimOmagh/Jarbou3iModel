...
for (const file of files) {
  ...
  const validation = core.validateProviderResponse(payload(fixture.task), response, { version: '1.1.0-alpha.23', nowIso: () => '2026-04-28T00:00:00.000Z' });
...
if (report.suite_version !== '1.1.0-alpha.23') fail('fixture suite version mismatch');
