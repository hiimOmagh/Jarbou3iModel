...
const tests = [
  'tests/qa-check.mjs',
  'tests/stable-manual-workflow-release-check.mjs',
  ...
  'tests/source-to-brief-review-quality-diagnostics-check.mjs',
  ...
  'tests/source-to-brief-source-to-claim-gap-closure-check.mjs',
  'tests/source-to-brief-brief-publication-pack-v4-check.mjs',
