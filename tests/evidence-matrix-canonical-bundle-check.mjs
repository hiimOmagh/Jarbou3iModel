...
const PUBLIC_LABEL = 'v1.3.0-alpha.5 Brief Assembly Preview Diff + Export Review Signoff';
...
for (const token of [
  'lock-evidence-bundle_1.3.0-alpha.5_${{ github.run_id }}',
...
assert.ok(workflow.includes("summary.internal_build_version !== '1.3.0-alpha.5'"), 'browser job must assert matrix summary version');
