...
for (const token of [
  'lock-evidence-bundle_1.4.0-alpha.11_${{ github.run_id }}',
...
assert.ok(workflow.includes("summary.internal_build_version !== '1.4.0-alpha.11'"), 'browser job must assert matrix summary version');
