...
const PUBLIC_LABEL = 'v1.2.0-alpha.2 Source-to-Brief Intelligence Workbench';
...
for (const token of [
  'lock-evidence-bundle_1.2.0-alpha.2_${{ github.run_id }}',
...
assert.ok(workflow.includes("summary.internal_build_version !== '1.2.0-alpha.2'"), 'browser job must assert matrix summary version');
