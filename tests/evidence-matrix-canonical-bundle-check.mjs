...
const PUBLIC_LABEL = 'v1.2.0-alpha.6 Operator Command Palette + Review Navigation Shortcuts';
...
for (const token of [
  'lock-evidence-bundle_1.2.0-alpha.6_${{ github.run_id }}',
...
assert.ok(workflow.includes("summary.internal_build_version !== '1.2.0-alpha.6'"), 'browser job must assert matrix summary version');
