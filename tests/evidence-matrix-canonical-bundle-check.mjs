...
const PUBLIC_LABEL = 'v1.2.0-alpha.5 Claim Traceability Console + Review Decision Ledger';
...
for (const token of [
  'lock-evidence-bundle_1.2.0-alpha.5_${{ github.run_id }}',
...
assert.ok(workflow.includes("summary.internal_build_version !== '1.2.0-alpha.5'"), 'browser job must assert matrix summary version');
