...
assert.ok(fs.existsSync(path.join(bundleDir, 'performance-trends', 'hosted-evidence-performance-trend-ledger.json')), 'canonical bundle must include threshold policy ledger JSON');
assert.ok(fs.existsSync(path.join(bundleDir, 'performance-trends', 'hosted-evidence-performance-trend-ledger.md')), 'canonical bundle must include threshold policy ledger Markdown');
