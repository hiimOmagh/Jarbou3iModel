...
assert.equal(registry.VERSION, '1.1.0-fix.1');
...
const blueprint = registry.strategyBlueprint({version:'1.1.0-fix.1', now:'2026-05-02T00:00:00.000Z'});
assert.equal(blueprint.source_strategy_version, '1.1.0-fix.1');
...
assert.equal(schema.$defs.source_capability_registry.properties.source_strategy_version.const, '1.1.0-fix.1');
