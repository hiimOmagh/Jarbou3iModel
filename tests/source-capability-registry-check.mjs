...
assert.equal(registry.VERSION, '1.1.0-fix.2');
...
const blueprint = registry.strategyBlueprint({version:'1.1.0-fix.2', now:'2026-05-02T00:00:00.000Z'});
assert.equal(blueprint.source_strategy_version, '1.1.0-fix.2');
...
assert.equal(schema.$defs.source_capability_registry.properties.source_strategy_version.const, '1.1.0-fix.2');
