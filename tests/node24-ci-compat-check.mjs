...
assert.equal(pkg.version, '1.4.0-alpha.36', 'package.json must identify v1.4.0-alpha.28');
assert.equal(lock.version, '1.4.0-alpha.36', 'package-lock root version must identify v1.4.0-alpha.28');
assert.equal(lock.packages[''].version, '1.4.0-alpha.36', 'package-lock package root must identify v1.4.0-alpha.28');
