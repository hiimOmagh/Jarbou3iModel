...
assert.equal(pkg.version, '1.3.0-alpha.5', 'package.json must identify v1.1.0');
assert.equal(lock.version, '1.3.0-alpha.5', 'package-lock root version must identify v1.1.0');
assert.equal(lock.packages[''].version, '1.3.0-alpha.5', 'package-lock package root must identify v1.1.0');
