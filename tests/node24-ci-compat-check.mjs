...
assert.equal(pkg.version, '1.0.30', 'package.json must identify v1.0.30');
assert.equal(lock.version, '1.0.30', 'package-lock root version must identify v1.0.30');
assert.equal(lock.packages[''].version, '1.0.30', 'package-lock package root must identify v1.0.30');
...
for (const text of [releaseNotes, changelog, manifest, roadmap, qaMatrix]) {
  assert.ok(text.includes('v1.0.30'), 'release documentation must mention v1.0.30');
