...
assert.equal(pkg.version, '1.2.0-alpha.7', 'package.json must identify v1.1.0');
assert.equal(lock.version, '1.2.0-alpha.7', 'package-lock root version must identify v1.1.0');
assert.equal(lock.packages[''].version, '1.2.0-alpha.7', 'package-lock package root must identify v1.1.0');
