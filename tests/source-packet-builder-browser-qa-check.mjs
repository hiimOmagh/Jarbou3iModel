...
for (const packet of [fixture, migrationFixture, privacyFixture]) {
  ...
  assert.equal(packet.source_packet_builder_report.builder_version, '1.1.0-alpha.20');
  assert.equal(packet.last_built_source_packet.workflow_version, '1.1.0-alpha.20');
