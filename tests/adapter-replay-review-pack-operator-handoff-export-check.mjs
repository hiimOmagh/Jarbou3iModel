...
assert.ok([VERSION, '1.4.0-alpha.29', '1.4.0-alpha.31'].includes(registry.runtime_optimization.version), 'runtime optimization may advance to alpha.29 while preserving alpha.28 review-pack check');
assert.ok(['adapter_replay_review_pack_operator_handoff_export', 'adapter_replay_review_pack_ui_export_preview', 'adapter_replay_review_pack_operator_workflow_polish'].includes(registry.runtime_optimization.optimization_scope), 'runtime optimization may advance to alpha.29 while preserving alpha.28 review-pack check');
