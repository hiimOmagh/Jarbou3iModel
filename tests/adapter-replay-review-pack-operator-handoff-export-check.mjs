...
assert.ok([VERSION, '1.4.0-alpha.29', '1.4.0-alpha.42', '1.4.0-alpha.42'].includes(registry.runtime_optimization.version), 'runtime optimization may advance to alpha.29 while preserving alpha.28 review-pack check');
