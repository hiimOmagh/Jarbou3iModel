...
for (const marker of ['v1.4.0-alpha.20 تدقيق تسليم سجل قرارات الأدلة', 'v1.4.0-alpha.20 Audit de remise du registre de décision preuves']) assert.ok(helpers.includes(marker), `localized alpha.1 public label missing ${marker}`);
