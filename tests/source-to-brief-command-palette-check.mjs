...
for (const marker of ['v1.3.0-alpha.7 تنظيف حقيقة الإصدار + ضغط خارطة الطريق', 'v1.3.0-alpha.7 Vérité de release + compression de feuille de route']) assert.ok(helpers.includes(marker), `localized public alpha label missing ${marker}`);
