...
for (const marker of ['v1.4.0-alpha.22 مركز إنتاجية التسليم', 'v1.4.0-alpha.22 Centre de productivité de remise']) assert.ok(helpers.includes(marker), `localized alpha.1 public label missing ${marker}`);
