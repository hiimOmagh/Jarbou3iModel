...
for (const marker of ['v1.4.0-alpha.15 ضغط تجربة محوّل المزوّد اليدوي · حارس ميزانية وقت التشغيل فقط', 'v1.4.0-alpha.15 Compression UX de l’adaptateur fournisseur manuel · Garde budget runtime uniquement']) assert.ok(helpers.includes(marker), `localized alpha.1 public label missing ${marker}`);
