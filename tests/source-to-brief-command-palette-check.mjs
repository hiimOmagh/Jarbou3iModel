...
for (const marker of ['v1.4.0-alpha.25 توحيد نظام الإصدار وحارس الفرق الفعلي', 'v1.4.0-alpha.25 Consolidation du système de release + garde de diff effectif']) assert.ok(helpers.includes(marker), `localized alpha.1 public label missing ${marker}`);
