...
for (const marker of ['v1.3.0-alpha.6 حالة اعتماد المشغّل + سجل قفل التصدير', 'v1.3.0-alpha.6 État de visa opérateur + registre de verrouillage export']) assert.ok(helpers.includes(marker), `localized public alpha label missing ${marker}`);
