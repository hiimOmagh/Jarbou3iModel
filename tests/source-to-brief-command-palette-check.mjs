...
for (const marker of ['v1.4.0-alpha.8 تدريب حدود بيانات الاعتماد وقت التشغيل · أسرار وهمية فقط', 'v1.4.0-alpha.8 Drill runtime de frontière des identifiants · faux secrets uniquement']) assert.ok(helpers.includes(marker), `localized alpha.1 public label missing ${marker}`);
