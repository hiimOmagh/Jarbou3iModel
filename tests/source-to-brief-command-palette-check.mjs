...
for (const marker of ['v1.4.0-alpha.19 سجل قرارات لوحة الأدلة', 'v1.4.0-alpha.19 Registre de décision du tableau preuves']) assert.ok(helpers.includes(marker), `localized alpha.1 public label missing ${marker}`);
