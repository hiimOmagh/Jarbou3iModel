...
for (const marker of ['v1.2.0-alpha.8.1 تثبيت CI + عزل سير العمل', 'v1.2.0-alpha.8.1 Stabilisation CI + quarantaine du workflow']) assert.ok(helpers.includes(marker), `localized public alpha label missing ${marker}`);
