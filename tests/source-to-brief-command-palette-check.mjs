...
for (const marker of ['v1.3.0-alpha.9 حزمة تسليم التصدير المعتمدة + مراجعة سجل القفل', 'v1.3.0-alpha.9 Pack de remise export signé + revue du registre']) assert.ok(helpers.includes(marker), `localized public alpha label missing ${marker}`);
