...
for (const marker of ['v1.3.0-alpha.3 نظام قوالب الموجز + تدقيق متغيرات التجميع', 'v1.3.0-alpha.3 Système de modèles de brief + QA des variantes d’assemblage']) assert.ok(helpers.includes(marker), `localized public alpha label missing ${marker}`);
