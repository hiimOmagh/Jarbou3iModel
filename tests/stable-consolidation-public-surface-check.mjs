...
const CURRENT_PUBLIC = 'v1.4.0-alpha.4 Dry-Run Trace Inspector + Execution Readiness Report';
...
assert.ok(index.includes('content="1.4.0-alpha.4"'), 'hosted metadata must report the alpha.1 internal version');
