...
const CURRENT_PUBLIC = 'v1.4.0-alpha.21 Evidence Handoff Readiness Checklist';
...
assert.equal(registry.release_title, 'v1.4.0-alpha.21 — Alpha.20 Lock Completion + Evidence Handoff Readiness Checklist');
assert.ok(index.includes('content="1.4.0-alpha.21"'), 'hosted metadata must report the alpha.15 internal version');
