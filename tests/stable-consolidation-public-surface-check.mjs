...
const CURRENT_PUBLIC = 'v1.4.0-alpha.42 Manual Workflow UX Consolidation';
...
assert.equal(registry.release_title, 'v1.4.0-alpha.42 — Manual Workflow UX Consolidation');
