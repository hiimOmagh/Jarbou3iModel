...
const CURRENT_PUBLIC = 'v1.4.0-alpha.39 Source-to-Brief Operator Control Room';
...
assert.equal(registry.release_title, 'v1.4.0-alpha.39 — Source-to-Brief Operator Control Room');
