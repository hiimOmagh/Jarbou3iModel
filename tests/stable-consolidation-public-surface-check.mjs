...
const CURRENT_PUBLIC = 'v1.4.0-alpha.40 Source-to-Brief Publication Readiness Suite';
...
assert.equal(registry.release_title, 'v1.4.0-alpha.40 — Source-to-Brief Publication Readiness Suite');
