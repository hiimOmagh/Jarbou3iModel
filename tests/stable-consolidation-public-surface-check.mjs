...
const CURRENT_PUBLIC = 'v1.4.0-alpha.43 Targeted Hosted Evidence Capture';
...
assert.equal(registry.release_title, 'v1.4.0-alpha.43 — Targeted Hosted Evidence Capture');
