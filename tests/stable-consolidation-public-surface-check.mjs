...
const STABLE_PUBLIC = 'v1.3.0-alpha.10 Brief Publication Pack v4';
...
assert.ok(index.includes('content="1.3.0-alpha.10"'), 'hosted metadata must report the stable internal version');
