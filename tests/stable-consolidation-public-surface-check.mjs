...
const STABLE_PUBLIC = 'v1.2.0-alpha.8 Diagnostic Repair Queue + Export Risk Resolution';
...
assert.ok(index.includes('content="1.2.0-alpha.8"'), 'hosted metadata must report the stable internal version');
