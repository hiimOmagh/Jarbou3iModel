...
const CURRENT_PUBLIC = 'v1.4.0-alpha.10 Limited Manual Live-Execution Prototype';
...
assert.ok(index.includes('content="1.4.0-alpha.10"'), 'hosted metadata must report the alpha.1 internal version');
