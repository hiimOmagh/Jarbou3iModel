...
const STABLE_PUBLIC = 'v1.3.0-alpha.9 Source-to-Claim Gap Closure Queue';
...
assert.ok(index.includes('content="1.3.0-alpha.9"'), 'hosted metadata must report the stable internal version');
