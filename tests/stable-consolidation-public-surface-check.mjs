...
const STABLE_PUBLIC = 'v1.2.0-alpha.3 Source-to-Brief UX Compression + Operator Flow Polish';
...
assert.ok(index.includes('content="1.2.0-alpha.3"'), 'hosted metadata must report the stable internal version');
