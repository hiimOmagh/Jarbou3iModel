...
const STABLE_PUBLIC = 'v1.3.0-alpha.1 Guided Research Session Engine + Brief Assembly Workflow';
...
assert.ok(index.includes('content="1.3.0-alpha.1"'), 'hosted metadata must report the stable internal version');
