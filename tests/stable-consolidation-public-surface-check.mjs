...
const STABLE_PUBLIC = 'v1.3.0-alpha.8 Signed Export Handoff Pack + Lock Ledger Review Surface';
...
assert.ok(index.includes('content="1.3.0-alpha.8"'), 'hosted metadata must report the stable internal version');
