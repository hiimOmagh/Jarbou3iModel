...
const STABLE_PUBLIC = 'v1.3.0-alpha.6 Operator Signoff State + Export Lock Ledger';
...
assert.ok(index.includes('content="1.3.0-alpha.6"'), 'hosted metadata must report the stable internal version');
