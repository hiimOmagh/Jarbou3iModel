...
const CURRENT_PUBLIC = 'v1.4.0-alpha.26 Adapter Replay Insight UX + Operator Decision Surface';
...
assert.equal(registry.release_title, 'v1.4.0-alpha.26 — Adapter Replay Insight UX + Operator Decision Surface');
assert.ok(index.includes('content="1.4.0-alpha.26"'), 'hosted metadata must report the alpha.15 internal version');
