...
const CURRENT_PUBLIC = 'v1.4.0-alpha.29 Adapter Replay Review Pack UI Polish + Export Preview';
...
assert.equal(registry.release_title, 'v1.4.0-alpha.29 — Adapter Replay Review Pack UI Polish + Export Preview');
