...
const CURRENT_PUBLIC = 'v1.4.0-alpha.32 Adapter Replay Review Pack Evidence Trace Reader';
...
assert.equal(registry.release_title, 'v1.4.0-alpha.32 — Adapter Replay Review Pack Evidence Trace Reader');
