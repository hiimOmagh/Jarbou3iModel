...
const CURRENT_PUBLIC = 'v1.4.0-alpha.34 Adapter Replay Review Pack Triage Workbench';
...
assert.equal(registry.release_title, 'v1.4.0-alpha.34 — Adapter Replay Review Pack Triage Workbench');
