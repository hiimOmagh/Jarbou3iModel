...
const CURRENT_PUBLIC = 'v1.4.0-alpha.28 Adapter Replay Review Pack + Operator Handoff Export';
...
assert.equal(registry.release_title, 'v1.4.0-alpha.28 — Adapter Replay Review Pack + Operator Handoff Export');
assert.ok(index.includes('content="1.4.0-alpha.28"'), 'hosted metadata must report the alpha.15 internal version');
