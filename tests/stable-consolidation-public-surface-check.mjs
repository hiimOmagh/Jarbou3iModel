...
const CURRENT_PUBLIC = 'v1.4.0-alpha.22 Handoff Productivity Command Center';
...
assert.equal(registry.release_title, 'v1.4.0-alpha.22 — Alpha.21 Lock Completion + Handoff Productivity Command Center');
assert.ok(index.includes('content="1.4.0-alpha.22"'), 'hosted metadata must report the alpha.15 internal version');
