...
const STABLE_PUBLIC = 'v1.3.0-alpha.7 Release Truth Sweep + Roadmap Compression';
...
assert.ok(index.includes('content="1.3.0-alpha.7"'), 'hosted metadata must report the stable internal version');
