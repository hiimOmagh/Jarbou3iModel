...
const CURRENT_PUBLIC = 'v1.4.0-alpha.7 Source Acquisition Control Surface';
...
assert.ok(index.includes('content="1.4.0-alpha.7"'), 'hosted metadata must report the alpha.1 internal version');
