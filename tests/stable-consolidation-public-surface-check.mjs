...
const CURRENT_PUBLIC = 'v1.4.0-alpha.14 Adapter Replay Fixture Corpus + Coverage Matrix';
...
assert.ok(index.includes('content="1.4.0-alpha.14"'), 'hosted metadata must report the alpha.1 internal version');
