...
const STABLE_PUBLIC = 'v1.3.0-rc.1 Manual Workflow Release Candidate Freeze';
...
assert.ok(index.includes('content="1.3.0-rc.1"'), 'hosted metadata must report the stable internal version');
