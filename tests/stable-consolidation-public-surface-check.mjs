...
const STABLE_PUBLIC = 'v1.2.0-alpha.5 Claim Traceability Console + Review Decision Ledger';
...
assert.ok(index.includes('content="1.2.0-alpha.5"'), 'hosted metadata must report the stable internal version');
