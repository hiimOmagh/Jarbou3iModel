...
const STABLE_PUBLIC = 'v1.2.0-alpha.4 Evidence Review Throughput + Source-to-Brief Export Polish';
...
assert.ok(index.includes('content="1.2.0-alpha.4"'), 'hosted metadata must report the stable internal version');
