...
const STABLE_PUBLIC = 'v1.2.0-alpha.1 Post-Stable Capability Roadmap + Expansion Gate';
...
assert.ok(index.includes('content="1.2.0-alpha.1"'), 'hosted metadata must report the stable internal version');
