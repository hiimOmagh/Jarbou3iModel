...
const STABLE_PUBLIC = 'v1.3.0-alpha.2 Guided Session UX Compression + Brief Assembly Export QA';
...
assert.ok(index.includes('content="1.3.0-alpha.2"'), 'hosted metadata must report the stable internal version');
