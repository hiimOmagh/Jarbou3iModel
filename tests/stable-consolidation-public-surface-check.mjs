...
const STABLE_PUBLIC = 'v1.2.0-alpha.8.1 CI Stabilization + Workflow Quarantine';
...
assert.ok(index.includes('content="1.2.0-alpha.8.1"'), 'hosted metadata must report the stable internal version');
