...
const CURRENT_PUBLIC = 'v1.4.0-alpha.17 Evidence Budget Regression Dashboard';
...
assert.equal(registry.release_title, 'v1.4.0-alpha.17 — Alpha.16 Lock Completion + Evidence Budget Regression Dashboard');
assert.ok(index.includes('content="1.4.0-alpha.17"'), 'hosted metadata must report the alpha.15 internal version');
