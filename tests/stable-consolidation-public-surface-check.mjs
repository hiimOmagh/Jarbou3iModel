...
const STABLE_PUBLIC = 'v1.3.0-alpha.5 Brief Assembly Preview Diff + Export Review Signoff';
...
assert.ok(index.includes('content="1.3.0-alpha.5"'), 'hosted metadata must report the stable internal version');
