...
const CURRENT_PUBLIC = 'v1.4.0-alpha.3 Provider/Source Dry-Run Execution Harness + Policy Simulator';
...
assert.ok(index.includes('content="1.4.0-alpha.3"'), 'hosted metadata must report the alpha.1 internal version');
