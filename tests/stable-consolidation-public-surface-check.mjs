...
const CURRENT_PUBLIC = 'v1.4.0-alpha.20 Evidence Decision Ledger Handoff Audit';
...
assert.equal(registry.release_title, 'v1.4.0-alpha.20 — Alpha.19 Lock Completion + Evidence Decision Ledger Handoff Audit');
assert.ok(index.includes('content="1.4.0-alpha.20"'), 'hosted metadata must report the alpha.15 internal version');
