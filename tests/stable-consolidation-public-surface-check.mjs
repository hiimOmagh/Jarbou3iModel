...
const CURRENT_PUBLIC = 'v1.4.0-alpha.36 Adapter Replay Review Pack Operator Review Console';
...
assert.equal(registry.release_title, 'v1.4.0-alpha.36 — Adapter Replay Review Pack Operator Review Console');
