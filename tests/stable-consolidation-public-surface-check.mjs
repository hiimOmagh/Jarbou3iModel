...
const STABLE_PUBLIC = 'v1.2.0-alpha.7 Review Quality Diagnostics + Weak-Claim Repair Suggestions';
...
assert.ok(index.includes('content="1.2.0-alpha.7"'), 'hosted metadata must report the stable internal version');
