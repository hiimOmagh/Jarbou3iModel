...
const CURRENT_PUBLIC = 'v1.4.0-alpha.33 Adapter Replay Review Pack Decision Queue';
...
assert.equal(registry.release_title, 'v1.4.0-alpha.33 — Adapter Replay Review Pack Decision Queue');
