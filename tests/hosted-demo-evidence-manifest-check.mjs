...
assert.ok(migrations.includes("const TARGET_VERSION = '1.3.0-rc.1'"));
assert.ok(migrations.includes("'1.0.26','1.0.27','1.0.28','1.0.29','1.0.30','1.1.0-alpha.1','1.1.0-alpha.2','1.1.0-alpha.3','1.1.0-alpha.8','1.1.0-alpha.9','1.1.0-alpha.10','1.3.0-rc.1'"), 'migration order must preserve v1.0.28 and append v1.1.0');
