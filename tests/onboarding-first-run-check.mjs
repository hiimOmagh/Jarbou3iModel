...
assert.equal(onboarding.VERSION, '1.0.11');
...
assert.equal(schema.properties.onboarding.properties.onboarding_version.const, '1.0.11');
...
const emptyReport = onboarding.firstRunReport({ evidence: [], evidence_review_queue: [] }, onboarding.defaultOnboardingState({ version:'1.0.11', now:'2026-04-30T00:00:00.000Z' }), { version:'1.0.11', now:'2026-04-30T00:00:00.000Z' });
...
const fullReport = onboarding.firstRunReport({ topic_defined:true, plan:{}, evidence:[{evidence_id:'E1'}], evidence_review_queue:[], quality_gate:{}, export_pack:{} }, onboarding.defaultOnboardingState({ version:'1.0.11', now:'2026-04-30T00:00:00.000Z' }), { version:'1.0.11', now:'2026-04-30T00:00:00.000Z' });
...
assert.equal(fixture.onboarding.onboarding_version, '1.0.11');
...
assert.ok(docs.includes('Onboarding + First-Run Success'), 'v1.0.11 docs missing');
