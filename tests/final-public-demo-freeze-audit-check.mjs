...
assert.ok(index.includes('v1.1.0-alpha.11 · Fixture/Test Debt Ledger + Source-File Refactor Readiness Audit'), 'index badge must expose final freeze audit identity');
...
assert.ok(migrations.includes("'1.0.27','1.0.28','1.0.29','1.0.30','1.1.0-alpha.1','1.1.0-alpha.2','1.1.0-alpha.3','1.1.0-alpha.8','1.1.0-alpha.9','1.1.0-alpha.10','1.1.0-alpha.11'"), 'migration order must preserve v1.0.30 freeze baseline and append v1.1.0-alpha.11');
...
for (const file of ['fixtures/migrations/v1.0.28-packet.json','fixtures/privacy/browser-generated-export-v1.0.28.json','fixtures/migrations/v1.1.0-alpha.11-packet.json','fixtures/privacy/browser-generated-export-v1.1.0-alpha.11.json','docs/v1.0.28-hosted-demo-evidence-manifest-gate.md','docs/v1.1.0-alpha.11-fixture-test-debt-ledger-source-file-refactor-readiness-audit.md','tests/version-suite-registry-check.mjs']) assert.ok(exists(file), `missing required baseline/current artifact: ${file}`);
