...
assert.ok(index.includes('v1.0.30 · Mobile Header Geometry Lock / Final Public Demo Visual Freeze'), 'index badge must expose final freeze audit identity');
...
assert.ok(migrations.includes("'1.0.27','1.0.28','1.0.29','1.0.30'"), 'migration order must preserve v1.0.29 baseline and append v1.0.30');
assert.ok(engine.includes("baseVersion:'1.0.29'"), 'engine apply/provenance reports must use v1.0.29 baseline');
...
for (const file of ['fixtures/migrations/v1.0.28-packet.json','fixtures/privacy/browser-generated-export-v1.0.28.json','fixtures/migrations/v1.0.30-packet.json','fixtures/privacy/browser-generated-export-v1.0.30.json','docs/v1.0.28-hosted-demo-evidence-manifest-gate.md','docs/v1.0.30-mobile-header-geometry-lock-final-public-demo-visual-freeze.md','tests/v129-no-browser-suite.mjs']) assert.ok(exists(file), `missing required baseline/current artifact: ${file}`);
