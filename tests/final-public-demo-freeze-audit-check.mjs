...
const releaseDoc = read('docs/v1.0.29-final-public-demo-hardening-release-freeze-audit.md');
...
assert.ok(index.includes('v1.0.29 · Final Public Demo Hardening / Release Freeze Audit'), 'index badge must expose final freeze audit identity');
...
assert.ok(migrations.includes("'1.0.27','1.0.28','1.0.29'"), 'migration order must preserve v1.0.28 baseline and append v1.0.29');
assert.ok(engine.includes("baseVersion:'1.0.28'"), 'engine apply/provenance reports must use v1.0.28 baseline');
...
for (const file of ['fixtures/migrations/v1.0.28-packet.json','fixtures/privacy/browser-generated-export-v1.0.28.json','fixtures/migrations/v1.0.29-packet.json','fixtures/privacy/browser-generated-export-v1.0.29.json','docs/v1.0.28-hosted-demo-evidence-manifest-gate.md','docs/v1.0.29-final-public-demo-hardening-release-freeze-audit.md','tests/v129-no-browser-suite.mjs']) assert.ok(exists(file), `missing required baseline/current artifact: ${file}`);
