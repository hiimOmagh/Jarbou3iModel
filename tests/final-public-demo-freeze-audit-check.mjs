...
assert.ok(index.includes('v1.1.0-alpha.8 · Fixture Registry Payload Compression + Test Organization Audit'), 'index badge must expose final freeze audit identity');
...
assert.ok(migrations.includes("'1.0.27','1.0.28','1.0.29','1.0.30','1.1.0-alpha.1','1.1.0-alpha.2','1.1.0-alpha.3','1.1.0-alpha.8'"), 'migration order must preserve v1.0.30 freeze baseline and append v1.1.0-alpha.8');
...
for (const file of ['fixtures/migrations/v1.0.28-packet.json','fixtures/privacy/browser-generated-export-v1.0.28.json','fixtures/migrations/v1.1.0-alpha.8-packet.json','fixtures/privacy/browser-generated-export-v1.1.0-alpha.8.json','docs/v1.0.28-hosted-demo-evidence-manifest-gate.md','docs/v1.1.0-alpha.8-fixture-registry-payload-compression-test-organization-audit.md','tests/version-suite-registry-check.mjs']) assert.ok(exists(file), `missing required baseline/current artifact: ${file}`);
