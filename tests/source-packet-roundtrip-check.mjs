...
assert.equal(builder.VERSION, '1.2.0-alpha.2');
assert.equal(importer.VERSION, '1.2.0-alpha.2');
assert.equal(roundtrip.VERSION, '1.2.0-alpha.2');
...
assert.equal(result.packet.workflow_version, '1.2.0-alpha.2');
...
assert.equal(schema.$defs.source_packet_roundtrip_report.properties.roundtrip_version.const, '1.2.0-alpha.2');
