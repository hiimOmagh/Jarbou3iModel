...
const corpus = {files:{
  'README.md':'v1.1.0-rc.2-fix.3 current release',
  'CHANGELOG.md':'v1.1.0-rc.2-fix.3 current release',
  'PUBLIC_DEMO.md':'v1.1.0-rc.2-fix.3 current release',
  'docs/current-release.md':'v1.1.0-rc.2-fix.3 current release',
  'docs/qa-matrix.md':'v1.1.0-rc.2-fix.3 current release',
