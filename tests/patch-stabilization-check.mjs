...
assert.equal(fixture.workflow_version, '1.1.0-rc.1-copyfix.1');
assert.equal(fixture.release_candidate.stable_release_version, '1.1.0-rc.1-copyfix.1');
...
assert.ok(migrations.includes("'1.0.0','1.0.1','1.0.2','1.0.3','1.0.4','1.0.5','1.0.6','1.0.7','1.0.8','1.0.9','1.0.10','1.0.11','1.0.12','1.0.13','1.0.14','1.0.15','1.0.16','1.0.17','1.0.18','1.0.19','1.0.20','1.0.21','1.0.22','1.0.23','1.0.24','1.0.25','1.0.26','1.0.27','1.0.28','1.0.29','1.0.30','1.1.0-alpha.1','1.1.0-alpha.2','1.1.0-alpha.3','1.1.0-alpha.8','1.1.0-alpha.9','1.1.0-alpha.10','1.1.0-rc.1-copyfix.1'"), 'migrations must support v1.0.5 → v1.1.0-rc.1-copyfix.1');
...
assert.ok(renderHelpers.includes('v1.1.0 Stable Candidate') && renderHelpers.includes('Stable Consolidation + Public Surface Freeze'), 'English stable badge must be fixed');
...
assert.ok(renderHelpers.includes('Stable consolidation') && renderHelpers.includes('v1.1.0'), 'English hosted evidence body must describe rc.1 stable consolidation scope');
assert.ok(renderHelpers.includes('الدمج المستقر') && renderHelpers.includes('v1.1.0'), 'Arabic hosted evidence body must describe rc.1 stable consolidation scope');
assert.ok(renderHelpers.includes('consolidation stable') && renderHelpers.includes('v1.1.0'), 'French hosted evidence body must describe rc.1 stable consolidation scope');
...
assert.ok(renderHelpers.includes("v1.1.0-rc.1-copyfix.1 · Candidat démo publique"), 'French alpha badge must reflect Stable Consolidation + Public Surface Freeze');
...
assert.equal(renderHelpers.includes("evidenceReviewGateBody:'v1.1.0-rc.1-copyfix.1 preserves the public-demo freeze"), false, 'French evidence review copy must not inherit English alpha.20 prose');
