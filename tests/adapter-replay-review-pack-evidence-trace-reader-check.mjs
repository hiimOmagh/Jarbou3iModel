...
assert.ok([VERSION, '1.4.0-alpha.35', '1.4.0-alpha.35'].includes(registry.runtime_optimization.version), 'runtime optimization may advance to alpha.33 while preserving alpha.32 evidence trace reader check');
assert.ok(['adapter_replay_review_pack_evidence_trace_reader', 'adapter_replay_review_pack_handoff_dossier', 'adapter_replay_review_pack_handoff_dossier'].includes(registry.runtime_optimization.optimization_scope), 'runtime optimization may advance to alpha.33 while preserving alpha.32 evidence trace reader check');
