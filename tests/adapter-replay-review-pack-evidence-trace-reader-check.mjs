...
assert.ok([CURRENT_VERSION, VERSION, '1.4.0-alpha.43', '1.4.0-alpha.43'].includes(registry.runtime_optimization.version), 'runtime optimization may advance to alpha.33 while preserving alpha.32 evidence trace reader check');
