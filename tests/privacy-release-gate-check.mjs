...
const sample = JSON.parse(fs.readFileSync('fixtures/privacy/browser-generated-export-v1.0.7.json', 'utf8'));
assert.equal(sample.privacy_export.audit_version, '1.0.7');
