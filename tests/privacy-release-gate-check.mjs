...
const sample = getPrivacyFixture('fixtures/privacy/browser-generated-export-v1.1.0-alpha.22.json');
assert.equal(sample.privacy_export.audit_version, '1.1.0-alpha.22');
