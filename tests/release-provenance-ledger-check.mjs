...
const CURRENT_VERSION = '1.4.0-alpha.15'; const VERSION = '1.3.0';
...
for (const [actual, label] of [[pkg.version, 'package'], [lock.version, 'lock'], [lock.packages[''].version, 'lock root']]) assert.equal(actual, CURRENT_VERSION, `${label} must be v1.4.0-alpha.15`);
