...
assert.ok(!roadmap.includes('v1.4.0-alpha.14 — Evidence Dashboard Decision Ledger'), 'roadmap must not reuse alpha.14 for the next UX milestone');

for (const token of [
  'evidence_surface_budget_version: 1.4.0-alpha.19',
...
assert.ok(index.includes('Evidence Dashboard Decision Ledger'));
