...
assert.ok(!roadmap.includes('v1.4.0-alpha.14 — Handoff Productivity Command Center'), 'roadmap must not reuse alpha.14 for the next UX milestone');

for (const token of [
  'evidence_surface_budget_version: 1.4.0-alpha.22',
...
assert.ok(index.includes('Handoff Productivity Command Center'));
