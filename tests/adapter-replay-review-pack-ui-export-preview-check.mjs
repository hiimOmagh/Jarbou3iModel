...
assert.ok(index.includes('Adapter Replay Review Pack UI Polish + Export Preview'), 'index must expose alpha.29 visible title');
...
assert.equal(registry.runtime_optimization.optimization_scope, 'adapter_replay_review_pack_ui_export_preview');
