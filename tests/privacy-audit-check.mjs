...
assert.equal(audit.PRIVACY_AUDIT_VERSION, '1.3.0-alpha.10');
...
const result = audit.sanitizeAndAuditPrivacyPayload(payload, { version: '1.3.0-alpha.10' });
assert.equal(result.privacy_export.audit_version, '1.3.0-alpha.10');
