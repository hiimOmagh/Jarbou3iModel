...
assert.equal(audit.PRIVACY_AUDIT_VERSION, '1.0.24');
...
const result = audit.sanitizeAndAuditPrivacyPayload(payload, { version: '1.0.24' });
assert.equal(result.privacy_export.audit_version, '1.0.24');
