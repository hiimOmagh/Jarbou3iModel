...
assert.equal(audit.PRIVACY_AUDIT_VERSION, '1.0.14');
...
const result = audit.sanitizeAndAuditPrivacyPayload(payload, { version: '1.0.14' });
assert.equal(result.privacy_export.audit_version, '1.0.14');
