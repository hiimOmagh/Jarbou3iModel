...
assert.equal(audit.PRIVACY_AUDIT_VERSION, '1.1.0-alpha.23');
...
const result = audit.sanitizeAndAuditPrivacyPayload(payload, { version: '1.1.0-alpha.23' });
assert.equal(result.privacy_export.audit_version, '1.1.0-alpha.23');
