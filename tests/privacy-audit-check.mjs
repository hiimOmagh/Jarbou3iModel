...
assert.equal(audit.PRIVACY_AUDIT_VERSION, '1.0.8');
...
const result = audit.sanitizeAndAuditPrivacyPayload(payload, { version: '1.0.8' });
assert.equal(result.privacy_export.audit_version, '1.0.8');
