...
assert.equal(audit.PRIVACY_AUDIT_VERSION, '1.2.0-alpha.5');
...
const result = audit.sanitizeAndAuditPrivacyPayload(payload, { version: '1.2.0-alpha.5' });
assert.equal(result.privacy_export.audit_version, '1.2.0-alpha.5');
