...
const TARGET_CHECK = 'tests/evidence-surface-budget-enforcement-evidence-runtime-budget-check.mjs';
...
assert.ok(!roadmap.includes('v1.4.0-alpha.14 — Evidence Surface Budget Enforcement'), 'roadmap must not reuse alpha.14 for the next UX milestone');
...
assert.ok(index.includes('Evidence Surface Budget Enforcement'));
