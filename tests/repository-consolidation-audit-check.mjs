...
const DOC = 'docs/v1.1.0-alpha.24-evidence-pack-export-v3-brief-traceability.md';
...
assert.ok(auditSource.includes("const VERSION = '1.1.0-alpha.24'"));
...
assert.ok(registryHasMigrationFixture('fixtures/migrations/v1.1.0-alpha.24-packet.json'), 'alpha.11 migration fixture must exist in registry');
...
assert.ok(registryHasPrivacyFixture('fixtures/privacy/browser-generated-export-v1.1.0-alpha.24.json'), 'alpha.11 privacy fixture must exist in registry');
...
assert.ok(releaseDoc.includes('v1.1.0-alpha.24'));
