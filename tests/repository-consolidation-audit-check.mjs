...
assert.ok(auditSource.includes("const VERSION = '1.2.0-alpha.4'"));
...
assert.ok(registryHasMigrationFixture('fixtures/migrations/v1.2.0-alpha.4-packet.json'), 'alpha.11 migration fixture must exist in registry');
...
assert.ok(registryHasPrivacyFixture('fixtures/privacy/browser-generated-export-v1.2.0-alpha.4.json'), 'alpha.11 privacy fixture must exist in registry');
