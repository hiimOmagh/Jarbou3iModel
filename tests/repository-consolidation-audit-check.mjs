...
assert.ok(registryHasMigrationFixture('fixtures/migrations/v1.3.0-packet.json'), 'alpha.11 migration fixture must exist in registry');
...
assert.ok(registryHasPrivacyFixture('fixtures/privacy/browser-generated-export-v1.3.0.json'), 'alpha.11 privacy fixture must exist in registry');
