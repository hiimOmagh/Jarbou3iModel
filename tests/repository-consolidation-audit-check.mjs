...
const DOC = 'docs/v1.1.0-alpha.23-evidence-pack-export-v3-brief-traceability.md';
...
assert.ok(auditSource.includes("const VERSION = '1.1.0-alpha.23'"));
...
assert.ok(registryHasMigrationFixture('fixtures/migrations/v1.1.0-alpha.23-packet.json'), 'alpha.11 migration fixture must exist in registry');
...
assert.ok(registryHasPrivacyFixture('fixtures/privacy/browser-generated-export-v1.1.0-alpha.23.json'), 'alpha.11 privacy fixture must exist in registry');
...
assert.ok(releaseDoc.includes('v1.1.0-alpha.23'));
