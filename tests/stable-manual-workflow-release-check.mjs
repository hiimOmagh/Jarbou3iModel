...
assert.equal(RUNTIME_SCOPE, 'source_to_brief_operator_continuity_console');
assert.ok(['release-identity-single-source-contract','adapter-replay-review-pack-ui-export-preview','adapter-replay-review-pack-triage-workbench','adapter-replay-review-pack-handoff-dossier','adapter-replay-review-pack-operator-review-console','source-to-brief-operator-continuity-console'].includes(manifest.release_type));
