...
assert.equal(RUNTIME_SCOPE, 'adapter_replay_review_pack_evidence_trace_reader');
assert.ok(['release-identity-single-source-contract','adapter-replay-review-pack-ui-export-preview','adapter-replay-review-pack-evidence-trace-reader'].includes(manifest.release_type));
