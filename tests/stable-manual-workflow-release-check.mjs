...
assert.equal(RUNTIME_SCOPE, 'adapter_replay_review_pack_operator_workflow_polish');
assert.ok(['release-identity-single-source-contract','adapter-replay-review-pack-ui-export-preview','adapter-replay-review-pack-operator-workflow-polish'].includes(manifest.release_type));
