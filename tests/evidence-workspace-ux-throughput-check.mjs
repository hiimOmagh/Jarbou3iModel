...
assert.ok(helpers.includes('Release Candidate Hardening + Final Repo Hygiene'));
assert.ok(helpers.includes('تقوية مرشح الإصدار وتنظيف المستودع النهائي'));
assert.ok(helpers.includes('Durcissement RC + hygiène finale du dépôt'));
