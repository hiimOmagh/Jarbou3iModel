...
assert.ok([CURRENT_VERSION, VERSION, '1.4.0-alpha.43', '1.4.0-alpha.43'].includes(registry.runtime_optimization.version), 'runtime optimization may advance to alpha.32 while preserving alpha.31 workflow check');
assert.ok(['adapter_replay_review_pack_operator_workflow_polish', 'source_to_brief_operator_continuity_console', 'targeted_hosted_evidence_capture', 'source_to_brief_operator_continuity_console', 'targeted_hosted_evidence_capture'].includes(registry.runtime_optimization.optimization_scope), 'runtime optimization may advance to alpha.32 while preserving alpha.31 workflow check');
