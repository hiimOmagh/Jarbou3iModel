...
const identity = abstraction.searchProviderIdentity('brave_search_api', { version:'1.0.7' });
...
const budget = abstraction.buildSearchQueryBudget({ version:'1.0.7', max_queries:99, max_results_per_query:99, counter_evidence_queries:4 });
...
const diagnostics = connectors.sourceDiagnostics({ evidence_matrix:[], workflow_version:'1.0.7' }, req, response);
