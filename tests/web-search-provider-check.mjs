...
const identity = abstraction.searchProviderIdentity('brave_search_api', { version:'1.1.0-rc.1-copyfix.1' });
...
const budget = abstraction.buildSearchQueryBudget({ version:'1.1.0-rc.1-copyfix.1', max_queries:99, max_results_per_query:99, counter_evidence_queries:4 });
...
const diagnostics = connectors.sourceDiagnostics({ evidence_matrix:[], workflow_version:'1.1.0-rc.1-copyfix.1' }, req, response);
