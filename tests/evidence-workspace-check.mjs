...
assert.equal(modules.evidenceWorkspace.VERSION, '1.3.0-alpha.3');
...
assert.ok(parsed.evidence.every((item) => item.workspace_meta?.workspace_version === '1.3.0-alpha.3'));
...
assert.equal(report.workspace_version, '1.3.0-alpha.3');
