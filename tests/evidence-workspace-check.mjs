...
assert.equal(modules.evidenceWorkspace.VERSION, '1.3.0-alpha.1');
...
assert.ok(parsed.evidence.every((item) => item.workspace_meta?.workspace_version === '1.3.0-alpha.1'));
...
assert.equal(report.workspace_version, '1.3.0-alpha.1');
