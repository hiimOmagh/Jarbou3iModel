...
assert.equal(modules.evidenceWorkspace.VERSION, '1.1.0-rc.1');
...
assert.ok(parsed.evidence.every((item) => item.workspace_meta?.workspace_version === '1.1.0-rc.1'));
...
assert.equal(report.workspace_version, '1.1.0-rc.1');
