...
assert.equal(modules.evidenceWorkspace.VERSION, '1.3.0-alpha.6');
...
assert.ok(parsed.evidence.every((item) => item.workspace_meta?.workspace_version === '1.3.0-alpha.6'));
...
assert.equal(report.workspace_version, '1.3.0-alpha.6');
