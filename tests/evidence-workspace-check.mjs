...
assert.equal(modules.evidenceWorkspace.VERSION, '1.1.0-alpha.18');
...
assert.ok(parsed.evidence.every((item) => item.workspace_meta?.workspace_version === '1.1.0-alpha.18'));
...
assert.equal(report.workspace_version, '1.1.0-alpha.18');
