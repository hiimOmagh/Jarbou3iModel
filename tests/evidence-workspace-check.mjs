...
assert.equal(modules.evidenceWorkspace.VERSION, '1.2.0-alpha.8');
...
assert.ok(parsed.evidence.every((item) => item.workspace_meta?.workspace_version === '1.2.0-alpha.8'));
...
assert.equal(report.workspace_version, '1.2.0-alpha.8');
