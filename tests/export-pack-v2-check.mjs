...
assert.equal(exportPack.EXPORT_PACK_VERSION, '1.1.0-alpha.19');
...
assert.equal(fixture.export_pack.export_pack_version, '1.1.0-alpha.19');
...
const pack = exportPack.createExportPack(hostile, { version: '1.1.0-alpha.19' });
assert.equal(pack.export_pack_version, '1.1.0-alpha.19');
assert.equal(pack.manifest.file_count, 14, 'manifest should describe core export artifacts plus seven graph artifacts before manifest insertion');
assert.equal(pack.files.length, 15, 'pack should include manifest plus core and graph artifacts');
...
assert.equal(privacyFile.export_pack_version, '1.1.0-alpha.19');
...
assert.equal(migrated.packet.workflow_version, '1.1.0-alpha.19');
assert.equal(migrated.packet.export_pack.export_pack_version, '1.1.0-alpha.19');
...
assert.equal(schema.properties.export_pack.properties.export_pack_version.const, '1.1.0-alpha.19');
