...
assert.equal(exportPack.EXPORT_PACK_VERSION, '1.1.0-alpha.12');
...
assert.equal(fixture.export_pack.export_pack_version, '1.1.0-alpha.12');
...
const pack = exportPack.createExportPack(hostile, { version: '1.1.0-alpha.12' });
assert.equal(pack.export_pack_version, '1.1.0-alpha.12');
...
assert.equal(privacyFile.export_pack_version, '1.1.0-alpha.12');
...
assert.equal(migrated.packet.workflow_version, '1.1.0-alpha.12');
assert.equal(migrated.packet.export_pack.export_pack_version, '1.1.0-alpha.12');
...
assert.equal(schema.properties.export_pack.properties.export_pack_version.const, '1.1.0-alpha.12');
