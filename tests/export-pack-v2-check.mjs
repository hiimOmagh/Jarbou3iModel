...
assert.equal(exportPack.EXPORT_PACK_VERSION, '1.2.0-alpha.3');
...
assert.equal(fixture.workflow_version, '1.2.0-alpha.3');
assert.equal(fixture.export_pack.export_pack_version, '1.2.0-alpha.3');
...
assert.equal(privacyFile.export_pack_version, '1.2.0-alpha.3');
...
assert.equal(migrated.packet.workflow_version, '1.2.0-alpha.3');
assert.equal(migrated.packet.export_pack.export_pack_version, '1.2.0-alpha.3');
...
assert.equal(schema.properties.export_pack.properties.export_pack_version.const, '1.2.0-alpha.3');
