...
assert.equal(exportPack.EXPORT_PACK_VERSION, '1.3.0-alpha.10');
...
assert.equal(fixture.workflow_version, '1.3.0-alpha.10');
assert.equal(fixture.export_pack.export_pack_version, '1.3.0-alpha.10');
...
const pack = exportPack.createExportPack(hostile, { version: '1.3.0-alpha.10' });
assert.equal(pack.export_pack_version, '1.3.0-alpha.10');
assert.equal(pack.manifest.file_count, 78, 'manifest should describe core export artifacts, graph artifacts, source-to-brief artifacts, provider-router artifacts, review artifacts, and traceability artifacts before manifest insertion');
assert.equal(pack.files.length, 79, 'pack should include manifest plus core, graph, source-to-brief, provider-router, review, and traceability artifacts');
const paths = pack.files.map((file) => file.path);
for (const required of ['export-manifest.json','research-packet.json','analysis-brief.md','evidence-matrix.csv','review-queue.csv','provider-run-ledger.json','quality-report.json','privacy-audit.json','graph/gephi-nodes.csv','graph/gephi-edges.csv','graph/kumu-map.json','graph/neo4j-nodes.csv','graph/neo4j-edges.csv','graph/graph-quality-report.json','graph/graph-export-report.json','source-to-brief/source-to-brief-package.json','source-to-brief/strategic-brief.md','source-to-brief/claim-map.csv','source-to-brief/source-gaps.json','source-to-brief/confidence-review.json','source-to-brief/export-readiness.json','source-to-brief/export-polish-report.json','source-to-brief/review-throughput-summary.json','source-to-brief/claim-traceability-console.json','source-to-brief/claim-traceability.csv','source-to-brief/review-decision-ledger.json','source-to-brief/review-decision-ledger.md','source-to-brief/operator-command-palette.json','source-to-brief/review-navigation-shortcuts.json','source-to-brief/review-quality-diagnostics.json','source-to-brief/weak-claim-repair-suggestions.json','source-to-brief/weak-claim-repair-suggestions.md','source-to-brief/diagnostic-repair-queue.json','source-to-brief/diagnostic-repair-queue.md','source-to-brief/export-risk-resolution.json','source-to-brief/export-risk-resolution.md','source-to-brief/source-to-claim-gap-closure-queue.json','source-to-brief/source-to-claim-gap-closure-queue.md','source-to-brief/brief-publication-pack-v4.json','source-to-brief/brief-publication-pack-v4.md','source-to-brief/publication-ready-brief.md','source-to-brief/evidence-appendix.md','source-to-brief/contradiction-falsifier-appendix.md','source-to-brief/source-gap-appendix.md','source-to-brief/operator-signoff-lock-ledger-appendix.md','source-to-brief/operator-handoff.md','source-to-brief/lock-ledger-review-surface.json','source-to-brief/lock-ledger-review-surface.md','source-to-brief/signed-export-handoff-pack.json','source-to-brief/signed-export-handoff-pack.md','provider/provider-route-plan.json','provider/provider-route-report.json','provider/provider-cost-report.json','provider/provider-router-safety-report.json','review/evidence-workspace-ux-report.json','review/brief-traceability-report.json','traceability/brief-traceability-report.json','traceability/contradiction-falsifier-appendix.json','traceability/bundle-consistency-report.json','traceability/publication-readiness-export-report.json','traceability/evidence-pack-v3-manifest.json','publication-review/claim-classification-report.json','publication-review/claim-boundary-audit-report.json','publication-review/contradiction-falsifier-completeness-report.json','publication-review/publication-review-gate-report.json','publication-review/export-safe-final-review-report.json','golden/golden-workflow-corpus.json','golden/golden-end-to-end-demo-report.json','golden/golden-export-pack-validation-report.json','golden/hosted-demo-scenario-evidence.json','golden/release-readiness-runbook.json','release-candidate/final-repo-hygiene-report.json','release-candidate/stale-release-copy-sweep.json','release-candidate/golden-workflow-regression-lock.json','release-candidate/export-pack-artifact-consistency-lock.json','release-candidate/hosted-demo-evidence-runbook.json','release-candidate/no-browser-browser-ci-parity-report.json','release-candidate/release-candidate-readiness-report.json']) {
...
assert.ok(briefMd.includes('## Source-to-Brief Workbench'), 'markdown source-to-brief section missing');
...
assert.ok(paths.includes('review/review-throughput-report.json'), 'review throughput report alias missing');
assert.ok(paths.includes('source-to-brief/operator-handoff.md'), 'operator handoff export missing');
assert.ok(paths.includes('source-to-brief/signed-export-handoff-pack.json'), 'signed export handoff pack export missing');
assert.ok(paths.includes('source-to-brief/lock-ledger-review-surface.json'), 'lock ledger review surface export missing');
...
assert.ok(paths.includes('source-to-brief/diagnostic-repair-queue.json'), 'diagnostic repair queue export missing');
assert.ok(paths.includes('source-to-brief/export-risk-resolution.json'), 'export risk resolution export missing');
assert.ok(paths.includes('source-to-brief/source-to-claim-gap-closure-queue.json'), 'source-to-claim gap closure queue export missing');
assert.ok(paths.includes('source-to-brief/brief-publication-pack-v4.json'), 'brief publication pack v4 export missing');
assert.ok(paths.includes('source-to-brief/publication-ready-brief.md'), 'publication-ready brief export missing');
assert.ok(paths.includes('source-to-brief/evidence-appendix.md'), 'evidence appendix export missing');
assert.ok(paths.includes('source-to-brief/contradiction-falsifier-appendix.md'), 'contradiction/falsifier appendix export missing');
assert.ok(paths.includes('source-to-brief/source-gap-appendix.md'), 'source gap appendix export missing');
assert.ok(paths.includes('source-to-brief/operator-signoff-lock-ledger-appendix.md'), 'operator signoff/lock ledger appendix export missing');
...
assert.equal(privacyFile.export_pack_version, '1.3.0-alpha.10');
...
assert.equal(migrated.packet.workflow_version, '1.3.0-alpha.10');
assert.equal(migrated.packet.export_pack.export_pack_version, '1.3.0-alpha.10');
...
assert.equal(schema.properties.export_pack.properties.export_pack_version.const, '1.3.0-alpha.10');
