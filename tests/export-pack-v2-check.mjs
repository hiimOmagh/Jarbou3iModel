...
assert.equal(exportPack.EXPORT_PACK_VERSION, '1.1.0-alpha.23');
...
assert.equal(fixture.export_pack.export_pack_version, '1.1.0-alpha.23');
...
const pack = exportPack.createExportPack(hostile, { version: '1.1.0-alpha.23' });
assert.equal(pack.export_pack_version, '1.1.0-alpha.23');
assert.equal(pack.manifest.file_count, 30, 'manifest should describe core export artifacts, graph artifacts, provider-router artifacts, review artifacts, and traceability artifacts before manifest insertion');
assert.equal(pack.files.length, 31, 'pack should include manifest plus core, graph, provider-router, review, and traceability artifacts');
...
assert.equal(privacyFile.export_pack_version, '1.1.0-alpha.23');
...
assert.equal(migrated.packet.workflow_version, '1.1.0-alpha.23');
assert.equal(migrated.packet.export_pack.export_pack_version, '1.1.0-alpha.23');
...
assert.equal(schema.properties.export_pack.properties.export_pack_version.const, '1.1.0-alpha.23');
