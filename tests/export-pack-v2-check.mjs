...
assert.equal(exportPack.EXPORT_PACK_VERSION, '1.0.28');
...
assert.equal(fixture.export_pack.export_pack_version, '1.0.28');
...
const pack = exportPack.createExportPack(hostile, { version: '1.0.28' });
assert.equal(pack.export_pack_version, '1.0.28');
...
assert.equal(privacyFile.export_pack_version, '1.0.28');
...
assert.equal(migrated.packet.workflow_version, '1.0.28');
assert.equal(migrated.packet.export_pack.export_pack_version, '1.0.28');
...
assert.equal(schema.properties.export_pack.properties.export_pack_version.const, '1.0.28');
