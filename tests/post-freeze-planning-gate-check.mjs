...
assert.ok(moduleSource.includes("const VERSION = '1.1.0-rc.1-copyfix.1'"));
...
assert.ok(migrations.includes("'1.0.29','1.0.30','1.1.0-alpha.1','1.1.0-alpha.2','1.1.0-alpha.3','1.1.0-alpha.8','1.1.0-alpha.9','1.1.0-alpha.10','1.1.0-rc.1-copyfix.1'"), 'migration order must preserve v1.0.30 freeze baseline and append v1.1.0-rc.1-copyfix.1');
