...
assert.ok(spec.includes('v121-desktop-'), 'desktop screenshots should use v1.1.0-rc.2-fix.2 artifact names');
assert.ok(spec.includes('v121-mobile-'), 'mobile screenshots should use v1.1.0-rc.2-fix.2 artifact names');
