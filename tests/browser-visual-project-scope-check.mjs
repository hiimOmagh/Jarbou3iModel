...
assert.ok(spec.includes('v120-desktop-'), 'desktop screenshots should use v1.1.0-alpha.4 artifact names');
assert.ok(spec.includes('v120-mobile-'), 'mobile screenshots should use v1.1.0-alpha.4 artifact names');
