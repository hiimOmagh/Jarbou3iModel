...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-rc.1-copyfix.1-evidence-pack-export-v3-brief-traceability.md', '# v1.1.0-rc.1-copyfix.1 — Stable Consolidation + Public Surface Freeze']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-rc.1-copyfix.1`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
