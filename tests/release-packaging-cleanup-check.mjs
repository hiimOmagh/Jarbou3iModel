...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.10-hosted-evidence-capture-polish-visual-artifact-guard.md', '# v1.1.0-alpha.10 — Hosted Evidence Capture Polish + Visual Artifact Guard']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.10`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
