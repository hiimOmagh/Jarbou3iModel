...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.6-root-manifest-release-artifact-consolidation.md', '# v1.1.0-alpha.6 — Root Manifest + Release Artifact Consolidation']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.6`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
