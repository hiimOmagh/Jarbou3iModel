...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.9-test-matrix-runtime-optimization-release-doc-timeline-pruning.md', '# v1.1.0-alpha.9 — Test Matrix Runtime Optimization + Release Doc Timeline Pruning']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.9`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
