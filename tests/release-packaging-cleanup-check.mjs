...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-rc.0-evidence-pack-export-v3-brief-traceability.md', '# v1.1.0-rc.0 — Public Demo Release Candidate']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-rc.0`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
