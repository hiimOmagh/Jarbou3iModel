...
const RELEASE = 'v1.0.29 — Final Public Demo Hardening / Release Freeze Audit';
...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.0.29-final-public-demo-hardening-release-freeze-audit.md', '# v1.0.29 — Final Public Demo Hardening / Release Freeze Audit']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.0.29`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
