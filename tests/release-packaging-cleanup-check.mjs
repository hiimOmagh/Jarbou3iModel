...
const RELEASE = 'v1.0.27 — Release Provenance Ledger Gate';
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.0.27`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
