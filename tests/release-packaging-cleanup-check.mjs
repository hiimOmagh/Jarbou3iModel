...
const RELEASE = 'v1.1.0-alpha.2 — Expansion Lane Acceptance Criteria Matrix';
...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.2-expansion-lane-acceptance-criteria-matrix.md', '# v1.1.0-alpha.2 — Expansion Lane Acceptance Criteria Matrix']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.2`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
