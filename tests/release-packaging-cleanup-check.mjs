...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.8-fixture-registry-payload-compression-test-organization-audit.md', '# v1.1.0-alpha.8 — Fixture Registry Payload Compression + Test Organization Audit']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.8`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
