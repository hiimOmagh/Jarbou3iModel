...
const RELEASE = 'v1.2.0-alpha.4 — Evidence Review Throughput + Source-to-Brief Export Polish';
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.2.0-alpha.4`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
