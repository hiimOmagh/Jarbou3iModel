...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.7-package-script-compression-ci-gate-registry.md', '# v1.1.0-alpha.7 — Package Script Compression + CI Gate Registry']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.7`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
