...
const RELEASE = 'v1.1.0-alpha.25 — Release Candidate Hardening + Final Repo Hygiene';
...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.25-evidence-pack-export-v3-brief-traceability.md', '# v1.1.0-alpha.25 — Release Candidate Hardening + Final Repo Hygiene']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.25`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
