...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.0.19`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions']) {
