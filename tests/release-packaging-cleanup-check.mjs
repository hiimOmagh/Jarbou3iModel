...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.12-dev-productivity-command-center-golden-baseline-automation.md', '# v1.1.0-alpha.12 — Dev Productivity Command Center + Golden Baseline Automation']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.12`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
