...
const RELEASE = 'v1.1.0-alpha.22 — Evidence Pack Export v3 + Brief Traceability';
...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.22-evidence-pack-export-v3-brief-traceability.md', '# v1.1.0-alpha.22 — Evidence Pack Export v3 + Brief Traceability']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.22`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
