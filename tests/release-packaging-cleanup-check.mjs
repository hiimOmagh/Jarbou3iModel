...
const RELEASE = 'v1.1.0-alpha.20 — Provider Router + Cost-Aware Run Ledger';
...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.20-provider-router-cost-aware-run-ledger.md', '# v1.1.0-alpha.20 — Provider Router + Cost-Aware Run Ledger']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.20`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
