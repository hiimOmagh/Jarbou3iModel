...
const RELEASE = 'v1.1.0-alpha.24 — Golden Workflow Corpus + End-to-End Demo Run';
...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.24-evidence-pack-export-v3-brief-traceability.md', '# v1.1.0-alpha.24 — Golden Workflow Corpus + End-to-End Demo Run']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.24`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
