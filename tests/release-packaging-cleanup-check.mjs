...
const RELEASE = 'v1.0.26 — Release Apply Integrity Gate';
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.0.26`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
