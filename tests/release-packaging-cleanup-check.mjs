...
const RELEASE = 'v1.2.0-alpha.3 — Source-to-Brief UX Compression + Operator Flow Polish';
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.2.0-alpha.3`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
