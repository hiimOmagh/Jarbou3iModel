...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.18-controlled-connector-architecture-mvp.md', '# v1.1.0-alpha.18 — Controlled Connector Architecture MVP']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.18`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
