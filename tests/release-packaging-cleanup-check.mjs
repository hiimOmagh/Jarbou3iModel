...
const RELEASE = 'v1.1.0-alpha.17 — Research Planner V2';
...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.17-research-planner-v2.md', '# v1.1.0-alpha.17 — Research Planner V2']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.17`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
