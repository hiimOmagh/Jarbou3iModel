...
const RELEASE = 'v1.1.0-alpha.21 — Evidence Workspace UX Hardening + Review Throughput';
...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.21-evidence-workspace-ux-hardening-review-throughput.md', '# v1.1.0-alpha.21 — Evidence Workspace UX Hardening + Review Throughput']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.21`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
