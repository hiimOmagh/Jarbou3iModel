...
const RELEASE = 'v1.1.0-alpha.15 — Source Cluster + Gap Intelligence';
...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.15-source-cluster-gap-intelligence.md', '# v1.1.0-alpha.15 — Source Cluster + Gap Intelligence']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.15`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
