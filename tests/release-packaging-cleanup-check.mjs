...
const RELEASE = 'v1.1.0-alpha.14 — Evidence Workspace + Source Import V2';
...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.14-prompt-compiler-research-plan-upgrade.md', '# v1.1.0-alpha.14 — Evidence Workspace + Source Import V2']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.14`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
