...
const RELEASE = 'v1.0.28 — Hosted Demo Evidence Manifest Gate';
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.0.28`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
