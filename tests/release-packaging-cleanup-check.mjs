...
const RELEASE = 'v1.1.0-alpha.23 — Publication Review Gate + Claim Boundary Audit';
...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.23-evidence-pack-export-v3-brief-traceability.md', '# v1.1.0-alpha.23 — Publication Review Gate + Claim Boundary Audit']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.23`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
