...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.11-fixture-test-debt-ledger-source-file-refactor-readiness-audit.md', '# v1.1.0-alpha.11 — Fixture/Test Debt Ledger + Source-File Refactor Readiness Audit']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.11`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
