...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.19-graph-export-strategic-evidence-map.md', '# v1.1.0-alpha.19 — Graph Export + Strategic Evidence Map']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.19`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
