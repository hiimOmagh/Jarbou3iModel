...
const expectedDocHeadings = new Map([
  ['docs/v1.0.0-public-beta-stable-research-engine.md', '# v1.0.0 â€” Public Beta / Stable Research Engine'],
  ['docs/v1.0.1-patch-only-stabilization.md', '# v1.0.1 â€” Patch-only Stabilization'],
  ['docs/v1.0.2-ux-stabilization-patch.md', '# v1.0.2 â€” UX Stabilization Patch'],
  ['docs/v1.0.3-screen-discipline-patch.md', '# v1.0.3 â€” Screen Discipline Patch'],
  ['docs/v1.0.4-browser-qa-visual-regression-hardening.md', '# v1.0.4 â€” Browser QA + Visual Regression Hardening'],
  ['docs/v1.0.5-onboarding-first-run-success.md', '# v1.0.5 â€” Onboarding + First-Run Success'],
  ['docs/v1.0.6-documentation-release-packaging-cleanup.md', '# v1.0.6 â€” Documentation + Release Packaging Cleanup'],
  ['docs/v1.0.7-public-demo-readiness-release-notes.md', '# v1.0.7 â€” Public Demo Readiness + Release Notes Polish'],
  ['docs/v1.0.8-hosted-demo-deployment-browser-evidence.md', '# v1.0.8 â€” Hosted Demo Deployment Verification + Browser Evidence Capture'],
  ['docs/v1.0.9-hosted-demo-smoke-fixes-evidence-review.md', '# v1.0.9 â€” Hosted Demo Smoke Fixes + Evidence Review'],
  ['docs/v1.0.10-hosted-url-ci-artifact-review-module-type-warning-fix.md', '# v1.0.10 â€” Hosted URL CI Artifact Review + Module-Type Warning Fix'],
  ['docs/v1.0.11-repository-hygiene-stale-artifact-cleanup.md', '# v1.0.11 â€” Repository Hygiene + Stale Artifact Cleanup'],
  ['docs/v1.0.12-research-source-strategy-blueprint.md', '# v1.0.12 â€” Research Source Strategy Blueprint'],
  ['docs/v1.0.13-manual-source-packet-import.md', '# v1.0.13 â€” Manual Source Packet Import'],
  ['docs/v1.0.14-evidence-scoring-v1.md', '# v1.0.14 â€” Evidence Scoring v1'],
  ['docs/v1.0.15-evidence-scoring-ui-calibration.md', '# v1.0.15 â€” Evidence Scoring UI Explanation + Calibration Pass'],
  ['docs/v1.0.16-source-packet-builder-ui-scoring-review-controls.md', '# v1.0.16 â€” Source Packet Builder UI + Scoring Review Controls'],
  ['docs/v1.0.17-source-packet-builder-browser-qa-ux-tightening.md', '# v1.0.17 â€” Source Packet Builder Browser QA + UX Tightening'],
  ['docs/v1.0.19-source-packet-template-presets.md', '# v1.0.19 â€” Source Packet Template Presets'],
  ['docs/v1.0.20-source-packet-template-browser-qa-copy-safety.md', '# v1.0.20 â€” Source Packet Template Browser QA + Copy Safety'],
  ['docs/v1.0.21-node-24-ci-compatibility.md', '# v1.0.21 â€” Node 24 CI Compatibility + Action Runtime Migration'],
  ['docs/v1.0.25-public-demo-release-lock.md', '# v1.0.25 â€” Public Demo Release Lock'],
  ['docs/v1.0.26-release-apply-integrity-gate.md', '# v1.0.26 â€” Release Apply Integrity Gate'],
  ['docs/v1.0.27-release-provenance-ledger-gate.md', '# v1.0.27 â€” Release Provenance Ledger Gate'],
  ['docs/v1.0.28-hosted-demo-evidence-manifest-gate.md', '# v1.0.28 â€” Hosted Demo Evidence Manifest Gate'],
  ['docs/v1.1.0-evidence-pack-export-v3-brief-traceability.md', '# v1.1.0 â€” Public Demo Stable']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.2.0-alpha.2`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
