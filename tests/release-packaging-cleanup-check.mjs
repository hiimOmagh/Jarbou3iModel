...
const RELEASE = 'v1.1.0-alpha.13 — Prompt Compiler + Research Plan Upgrade';
...
const expectedDocHeadings = new Map([
  ...
  ['docs/v1.1.0-alpha.13-prompt-compiler-research-plan-upgrade.md', '# v1.1.0-alpha.13 — Prompt Compiler + Research Plan Upgrade']
]);
...
for (const token of ['Package: `jarbou3i-research-engine`','Version: `1.1.0-alpha.13`','Runtime capability change: no','Required browser gates before publishing','Release archive exclusions','Required cleanup commands']) {
