...
assert.equal(schema.properties.backend_hardening.properties.hardening_version.const, '1.0.10');
assert.equal(fixture.backend_hardening.hardening_version, '1.0.10');
