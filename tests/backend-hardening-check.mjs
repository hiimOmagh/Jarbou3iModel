...
assert.equal(schema.properties.backend_hardening.properties.hardening_version.const, '1.2.0-alpha.5');
assert.equal(fixture.backend_hardening.hardening_version, '1.2.0-alpha.5');
