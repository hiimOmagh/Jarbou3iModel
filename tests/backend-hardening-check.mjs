...
assert.equal(schema.properties.backend_hardening.properties.hardening_version.const, '1.3.0-rc.2');
assert.equal(fixture.backend_hardening.hardening_version, '1.3.0-rc.2');
