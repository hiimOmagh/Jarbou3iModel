...
assert.equal(schema.properties.backend_hardening.properties.hardening_version.const, '1.0.30');
assert.equal(fixture.backend_hardening.hardening_version, '1.0.30');
