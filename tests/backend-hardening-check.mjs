...
assert.equal(schema.properties.backend_hardening.properties.hardening_version.const, '1.1.0-alpha.6');
assert.equal(fixture.backend_hardening.hardening_version, '1.1.0-alpha.6');
