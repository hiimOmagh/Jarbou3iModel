...
if (fixture.workflow_version !== '1.0.20') fail('fixture version mismatch');
...
if (!fixture.evidence_review_report || fixture.evidence_review_report.review_version !== '1.0.20') fail('fixture review report missing');
