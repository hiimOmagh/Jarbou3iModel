...
if (fixture.workflow_version !== '1.1.0-rc.2-fix.1') fail('fixture version mismatch');
...
if (!fixture.evidence_review_report || fixture.evidence_review_report.review_version !== '1.1.0-rc.2-fix.1') fail('fixture review report missing');
