...
if (fixture.workflow_version !== '1.2.0-alpha.1') fail('fixture version mismatch');
...
if (!fixture.evidence_review_report || fixture.evidence_review_report.review_version !== '1.2.0-alpha.1') fail('fixture review report missing');
