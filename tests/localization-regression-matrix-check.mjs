...
assert.equal(matrixConfig.public_version_labels.en, 'v1.3.0 Stable Manual Workflow Release', 'English public version label must identify v1.3.0');
assert.equal(matrixConfig.public_version_labels.ar, 'v1.3.0 الإصدار المستقر لسير العمل اليدوي', 'Arabic public version label must identify v1.3.0');
assert.equal(matrixConfig.public_version_labels.fr, 'v1.3.0 Version stable du workflow manuel', 'French public version label must identify v1.3.0');
