...
assert.equal(matrixConfig.public_version_labels.en, 'v1.4.0-alpha.4 Dry-Run Trace Inspector + Execution Readiness Report', 'English public version label must identify v1.4.0-alpha.4');
assert.equal(matrixConfig.public_version_labels.ar, 'v1.4.0-alpha.4 عارض أثر التشغيل الجاف + تقرير جاهزية التنفيذ', 'Arabic public version label must identify v1.4.0-alpha.4');
assert.equal(matrixConfig.public_version_labels.fr, 'v1.4.0-alpha.4 Inspecteur de traces dry-run + rapport de préparation à l’exécution', 'French public version label must identify v1.4.0-alpha.4');
