...
assert.equal(matrixConfig.public_version_labels.en, 'v1.3.0-rc.2 RC Evidence Tightening + Release Notes Finalization', 'English public version label must identify v1.3.0-rc.2');
assert.equal(matrixConfig.public_version_labels.ar, 'v1.3.0-rc.2 قائمة إغلاق فجوات المصدر إلى الادعاء', 'Arabic public version label must identify v1.3.0-rc.2');
assert.equal(matrixConfig.public_version_labels.fr, 'v1.3.0-rc.2 File de clôture des écarts source-affirmation', 'French public version label must identify v1.3.0-rc.2');
