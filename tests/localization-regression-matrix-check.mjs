...
assert.equal(matrixConfig.public_version_labels.en, 'v1.4.0-alpha.22 Handoff Productivity Command Center', 'English public version label must identify v1.4.0-alpha.22');
assert.equal(matrixConfig.public_version_labels.ar, 'v1.4.0-alpha.22 مركز إنتاجية التسليم', 'Arabic public version label must identify v1.4.0-alpha.22');
assert.equal(matrixConfig.public_version_labels.fr, 'v1.4.0-alpha.22 Centre de productivité de remise', 'French public version label must identify v1.4.0-alpha.22');
...
for (const body of arabicHostedDemoBodies) {
  assert.ok(body.includes('مركز إنتاجية التسليم جاهز لأدلة الإصدار'), 'Arabic current-release description must identify alpha.20 evidence decision ledger handoff audit');
  for (const staleCurrentDescription of [
    'النموذج الأولي المحدود للتنفيذ الحي اليدوي جاهز لأدلة الإصدار',
    'نموذج أولي محدود للتنفيذ الحي اليدوي',
    'هيكل اشتراك يدوي فقط',
