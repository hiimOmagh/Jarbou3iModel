...
assert.equal(matrixConfig.public_version_labels.en, 'v1.4.0-alpha.19 Evidence Dashboard Decision Ledger', 'English public version label must identify v1.4.0-alpha.19');
assert.equal(matrixConfig.public_version_labels.ar, 'v1.4.0-alpha.19 سجل قرارات لوحة الأدلة', 'Arabic public version label must identify v1.4.0-alpha.19');
assert.equal(matrixConfig.public_version_labels.fr, 'v1.4.0-alpha.19 Registre de décision du tableau preuves', 'French public version label must identify v1.4.0-alpha.19');
