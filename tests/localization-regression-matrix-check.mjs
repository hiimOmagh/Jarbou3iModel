...
assert.equal(matrixConfig.public_version_labels.en, 'v1.4.0-alpha.1 Controlled Provider/Source Execution Preparation', 'English public version label must identify v1.4.0-alpha.1');
assert.equal(matrixConfig.public_version_labels.ar, 'v1.4.0-alpha.1 تحضير تنفيذ المزود/المصدر المضبوط', 'Arabic public version label must identify v1.4.0-alpha.1');
assert.equal(matrixConfig.public_version_labels.fr, 'v1.4.0-alpha.1 Préparation contrôlée fournisseur/source', 'French public version label must identify v1.4.0-alpha.1');
