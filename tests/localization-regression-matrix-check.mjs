...
assert.equal(matrixConfig.public_version_labels.en, 'v1.4.0-alpha.11 Manual Execution Safety Cockpit + Session Ledger', 'English public version label must identify v1.4.0-alpha.11');
assert.equal(matrixConfig.public_version_labels.ar, 'v1.4.0-alpha.11 قمرة أمان التنفيذ اليدوي + سجل الجلسة · محاكاة قمرة الأمان فقط', 'Arabic public version label must identify v1.4.0-alpha.11');
assert.equal(matrixConfig.public_version_labels.fr, 'v1.4.0-alpha.11 Cockpit de sécurité d’exécution manuelle + registre de session · simulation de cockpit uniquement', 'French public version label must identify v1.4.0-alpha.11');
