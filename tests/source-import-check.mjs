...
if (!parsed.evidence.every((e) => e.evidence_scoring?.scoring_version === 'evidence_scoring.v1')) fail('imported evidence needs source packet builder UI and scoring review controls');
...
if (fixture.workflow_version !== '1.0.16') fail('research fixture version mismatch');
...
if (!fixture.source_imports.some((item) => item.queue_only === true)) fail('source imports should be queue_only in v1.0.16');
