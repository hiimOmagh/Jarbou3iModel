...
if (fixture.workflow_version !== '1.0.19') fail('research fixture version mismatch');
...
if (!fixture.source_imports.some((item) => item.queue_only === true)) fail('source imports should be queue_only in v1.0.19');
