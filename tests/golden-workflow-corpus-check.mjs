...
const goldenFixture = JSON.parse(fs.readFileSync('fixtures/research/golden-workflow-corpus-v1.3.0.json', 'utf8'));
...
assert.equal(corpus.corpus_id, 'golden-workflow-alpha25');
