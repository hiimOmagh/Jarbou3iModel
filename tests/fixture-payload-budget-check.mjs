...
const registries = [
  {
    ...
    expectedEntries: 61,
    currentFixture: () => getMigrationFixture('fixtures/migrations/v1.3.0-packet.json')
  },
  {
    label: 'privacy',
    ...
    expectedEntries: 51,
    currentFixture: () => getPrivacyFixture('fixtures/privacy/browser-generated-export-v1.3.0.json')
  }
];
