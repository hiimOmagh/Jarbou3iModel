...
const registries = [
  {
    ...
    expectedEntries: 59,
    currentFixture: () => getMigrationFixture('fixtures/migrations/v1.3.0-alpha.4-packet.json')
  },
  {
    label: 'privacy',
    ...
    expectedEntries: 49,
    currentFixture: () => getPrivacyFixture('fixtures/privacy/browser-generated-export-v1.3.0-alpha.4.json')
  }
];
