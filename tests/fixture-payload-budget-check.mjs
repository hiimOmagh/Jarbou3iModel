...
const registries = [
  {
    ...
    expectedEntries: 58,
    currentFixture: () => getMigrationFixture('fixtures/migrations/v1.1.0-alpha.13-packet.json')
  },
  {
    label: 'privacy',
    ...
    expectedEntries: 48,
    currentFixture: () => getPrivacyFixture('fixtures/privacy/browser-generated-export-v1.1.0-alpha.13.json')
  }
];
