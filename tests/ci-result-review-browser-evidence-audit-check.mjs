...
const CURRENT_VERSION = '1.3.0-alpha.4';
const HISTORICAL_VERSION = '1.0.23';
const HISTORICAL_TITLE = 'CI Result Review + Browser Evidence Artifact Audit';
const CURRENT_TITLE = 'Brief Template UX Polish + Matrix Hygiene Cleanup';
...
assert.ok(migrations.includes("const TARGET_VERSION = '1.3.0-alpha.4'"), 'migration target must be current release');
