...
const CURRENT_TITLE = 'Hosted Demo Evidence Manifest Gate';
...
assert.ok(migrations.includes("const TARGET_VERSION = '1.0.28'"), 'migration target must be current release');
