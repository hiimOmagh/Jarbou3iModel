...
const CURRENT_VERSION = '1.1.0-rc.2-fix.3';
const HISTORICAL_VERSION = '1.0.23';
const HISTORICAL_TITLE = 'CI Result Review + Browser Evidence Artifact Audit';
const CURRENT_TITLE = 'Evidence Workflow Exit-Code + Matrix Activation Fix';
...
assert.ok(migrations.includes("const TARGET_VERSION = '1.1.0-rc.2-fix.3'"), 'migration target must be current release');
