...
const CURRENT_TITLE = 'Final Public Demo Hardening / Release Freeze Audit';
...
assert.ok(migrations.includes("const TARGET_VERSION = '1.0.29'"), 'migration target must be current release');
