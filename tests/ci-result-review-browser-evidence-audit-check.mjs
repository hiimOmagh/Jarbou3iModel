...
const CURRENT_VERSION = '1.1.0-rc.1-copyfix.1';
const HISTORICAL_VERSION = '1.0.23';
const HISTORICAL_TITLE = 'CI Result Review + Browser Evidence Artifact Audit';
const CURRENT_TITLE = 'Stable Consolidation + Public Surface Freeze';
...
assert.ok(migrations.includes("const TARGET_VERSION = '1.1.0-rc.1-copyfix.1'"), 'migration target must be current release');
