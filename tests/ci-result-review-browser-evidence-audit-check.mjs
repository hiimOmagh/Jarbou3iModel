...
const CURRENT_VERSION = '1.3.0-alpha.8';
const HISTORICAL_VERSION = '1.0.23';
const HISTORICAL_TITLE = 'CI Result Review + Browser Evidence Artifact Audit';
const CURRENT_TITLE = 'Signed Export Handoff Pack + Lock Ledger Review Surface';
...
assert.ok(migrations.includes("const TARGET_VERSION = '1.3.0-alpha.8'"), 'migration target must be current release');
