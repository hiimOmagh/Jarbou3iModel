...
const CURRENT_VERSION = '1.1.0-alpha.9';
const HISTORICAL_VERSION = '1.0.23';
const HISTORICAL_TITLE = 'CI Result Review + Browser Evidence Artifact Audit';
const CURRENT_TITLE = 'Test Matrix Runtime Optimization + Release Doc Timeline Pruning';
...
assert.ok(migrations.includes("const TARGET_VERSION = '1.1.0-alpha.9'"), 'migration target must be current release');
