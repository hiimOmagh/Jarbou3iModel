...
const CURRENT_VERSION = '1.3.0-alpha.1';
const HISTORICAL_VERSION = '1.0.23';
const HISTORICAL_TITLE = 'CI Result Review + Browser Evidence Artifact Audit';
const CURRENT_TITLE = 'Guided Research Session Engine + Brief Assembly Workflow';
...
assert.ok(migrations.includes("const TARGET_VERSION = '1.3.0-alpha.1'"), 'migration target must be current release');
