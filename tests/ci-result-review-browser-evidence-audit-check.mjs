...
const CURRENT_VERSION = '1.1.0-alpha.25';
const HISTORICAL_VERSION = '1.0.23';
const HISTORICAL_TITLE = 'CI Result Review + Browser Evidence Artifact Audit';
const CURRENT_TITLE = 'Release Candidate Hardening + Final Repo Hygiene';
...
assert.ok(migrations.includes("const TARGET_VERSION = '1.1.0-alpha.25'"), 'migration target must be current release');
