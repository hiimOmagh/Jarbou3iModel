...
const CURRENT_VERSION = '1.2.0-alpha.7';
const HISTORICAL_VERSION = '1.0.23';
const HISTORICAL_TITLE = 'CI Result Review + Browser Evidence Artifact Audit';
const CURRENT_TITLE = 'Review Quality Diagnostics + Weak-Claim Repair Suggestions';
...
assert.ok(migrations.includes("const TARGET_VERSION = '1.2.0-alpha.7'"), 'migration target must be current release');
