...
const CURRENT_VERSION = '1.3.0-alpha.2';
const HISTORICAL_VERSION = '1.0.23';
const HISTORICAL_TITLE = 'CI Result Review + Browser Evidence Artifact Audit';
const CURRENT_TITLE = 'Guided Session UX Compression + Brief Assembly Export QA';
...
assert.ok(migrations.includes("const TARGET_VERSION = '1.3.0-alpha.2'"), 'migration target must be current release');
