...
const CURRENT_VERSION = '1.2.0-alpha.4';
const HISTORICAL_VERSION = '1.0.23';
const HISTORICAL_TITLE = 'CI Result Review + Browser Evidence Artifact Audit';
const CURRENT_TITLE = 'Evidence Review Throughput + Source-to-Brief Export Polish';
...
assert.ok(migrations.includes("const TARGET_VERSION = '1.2.0-alpha.4'"), 'migration target must be current release');
