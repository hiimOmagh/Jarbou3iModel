...
const CURRENT_VERSION = '1.2.0-alpha.3';
const HISTORICAL_VERSION = '1.0.23';
const HISTORICAL_TITLE = 'CI Result Review + Browser Evidence Artifact Audit';
const CURRENT_TITLE = 'Source-to-Brief UX Compression + Operator Flow Polish';
...
assert.ok(migrations.includes("const TARGET_VERSION = '1.2.0-alpha.3'"), 'migration target must be current release');
