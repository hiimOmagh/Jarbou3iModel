...
const CURRENT_VERSION = '1.1.0-alpha.11';
const HISTORICAL_VERSION = '1.0.23';
const HISTORICAL_TITLE = 'CI Result Review + Browser Evidence Artifact Audit';
const CURRENT_TITLE = 'Fixture/Test Debt Ledger + Source-File Refactor Readiness Audit';
...
assert.ok(migrations.includes("const TARGET_VERSION = '1.1.0-alpha.11'"), 'migration target must be current release');
