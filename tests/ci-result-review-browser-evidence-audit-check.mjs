...
const CURRENT_VERSION = '1.1.0-alpha.8';
const HISTORICAL_VERSION = '1.0.23';
const HISTORICAL_TITLE = 'CI Result Review + Browser Evidence Artifact Audit';
const CURRENT_TITLE = 'Fixture Registry Payload Compression + Test Organization Audit';
...
assert.ok(migrations.includes("const TARGET_VERSION = '1.1.0-alpha.8'"), 'migration target must be current release');
