...
const CURRENT_VERSION = '1.1.0-alpha.21';
const HISTORICAL_VERSION = '1.0.23';
const HISTORICAL_TITLE = 'CI Result Review + Browser Evidence Artifact Audit';
const CURRENT_TITLE = 'Evidence Workspace UX Hardening + Review Throughput';
...
assert.ok(migrations.includes("const TARGET_VERSION = '1.1.0-alpha.21'"), 'migration target must be current release');
