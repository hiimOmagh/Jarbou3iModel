...
const PUBLIC_VERSION_LABEL = 'v1.4.0-alpha.22 Handoff Productivity Command Center';
...
const EXPECTED_AR_CURRENT_RELEASE_DESCRIPTION_TOKENS = Object.freeze([
  'مركز إنتاجية التسليم جاهز لأدلة الإصدار',
...
test.describe('v1.4.0-alpha.22 hosted demo evidence matrix and manifest capture', () => {
