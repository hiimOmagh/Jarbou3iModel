...
const PUBLIC_VERSION_LABEL = 'v1.4.0-alpha.20 Evidence Decision Ledger Handoff Audit';
...
const EXPECTED_AR_CURRENT_RELEASE_DESCRIPTION_TOKENS = Object.freeze([
  'تدقيق تسليم سجل قرارات الأدلة جاهز لأدلة الإصدار',
  'يفحص جاهزية تسليم سجل القرارات',
  'يراجع هوية حزمة القفل',
  'يؤكد حدود السلوك',
  'يحافظ على قرار المشغّل اليدوي',
  'دون توسيع سطح المتصفح',
  'طبقة تدقيق تسليم فقط',
...
test.describe('v1.4.0-alpha.20 hosted demo evidence matrix and manifest capture', () => {
