...
const PUBLIC_VERSION_LABEL = 'v1.4.0-alpha.6 Provider Execution Harness Mock-to-Live Equivalence';
...
test.describe('v1.4.0-alpha.6 hosted demo evidence matrix and manifest capture', () => {
