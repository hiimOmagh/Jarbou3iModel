...
const PUBLIC_VERSION_LABEL = 'v1.4.0-alpha.7 Source Acquisition Control Surface';
...
test.describe('v1.4.0-alpha.7 hosted demo evidence matrix and manifest capture', () => {
