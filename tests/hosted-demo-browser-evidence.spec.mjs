...
const PUBLIC_VERSION_LABEL = 'v1.4.0-alpha.11 Manual Execution Safety Cockpit + Session Ledger';
...
test.describe('v1.4.0-alpha.11 hosted demo evidence matrix and manifest capture', () => {
