...
const PUBLIC_VERSION_LABEL = 'v1.4.0-alpha.18 Evidence Budget Dashboard Actionability';
...
const EXPECTED_AR_CURRENT_RELEASE_DESCRIPTION_TOKENS = Object.freeze([
  'قابلية عمل لوحة ميزانية الأدلة جاهزة لأدلة الإصدار',
  'تحوّل نتائج انحدار ميزانية الأدلة',
  'حالات نجاح وتحذير وفشل ومراجعة مطلوبة',
  'إجراءات المشغّل',
  'دون توسيع سطح المتصفح',
  'طبقة قابلية العمل فقط',
...
test.describe('v1.4.0-alpha.18 hosted demo evidence matrix and manifest capture', () => {
