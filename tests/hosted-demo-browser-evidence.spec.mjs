...
const PUBLIC_VERSION_LABEL = 'v1.4.0-alpha.8 Credential Boundary Runtime Drill';
...
test.describe('v1.4.0-alpha.8 hosted demo evidence matrix and manifest capture', () => {
