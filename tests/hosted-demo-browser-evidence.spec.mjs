...
const PUBLIC_VERSION_LABEL = 'v1.4.0-alpha.21 Evidence Handoff Readiness Checklist';
...
const EXPECTED_AR_CURRENT_RELEASE_DESCRIPTION_TOKENS = Object.freeze([
  'قائمة جاهزية تسليم الأدلة جاهز لأدلة الإصدار',
...
test.describe('v1.4.0-alpha.21 hosted demo evidence matrix and manifest capture', () => {
