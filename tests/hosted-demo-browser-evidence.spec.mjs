...
const PUBLIC_VERSION_LABEL = 'v1.4.0-alpha.14 Adapter Replay Fixture Corpus + Coverage Matrix';
...
const EXPECTED_AR_CURRENT_RELEASE_DESCRIPTION_TOKENS = Object.freeze([
  'مجموعة فيكستشرات إعادة تشغيل المحوّل + مصفوفة التغطية جاهزة لأدلة الإصدار',
...
test.describe('v1.4.0-alpha.14 hosted demo evidence matrix and manifest capture', () => {
