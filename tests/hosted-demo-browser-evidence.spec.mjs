...
const PUBLIC_VERSION_LABEL = 'v1.4.0-alpha.15 Manual Provider Adapter UX Compression';
...
test.describe('v1.4.0-alpha.15 hosted demo evidence matrix and manifest capture', () => {
