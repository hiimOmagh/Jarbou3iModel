...
const PUBLIC_VERSION_LABEL = 'v1.2.0-alpha.2 Source-to-Brief Intelligence Workbench';
...
async function collectVisibleTextSnapshot(page, locale, screenLabel){
  ...
  const expected_locale_markers = { ar:['Ù…Ø®ØªØ¨Ø± Ø§Ù„ØªØ­Ù„ÙŠÙ„ Ø§Ù„Ø§Ø³ØªØ±Ø§ØªÙŠØ¬ÙŠ','Ø§Ù„Ø¹Ø±Ø¶ Ø§Ù„Ø¹Ø§Ù… Ø¬Ø§Ù‡Ø²'], fr:['Atelier dâ€™analyse stratÃ©gique','DÃ©mo publique prÃªte'], en:['Strategic Analysis Workbench','Public demo ready'] };
