...
const PUBLIC_VERSION_LABEL = 'v1.4.0-alpha.5 Dry-Run Replay Pack + Operator Approval Simulation';
...
test.describe('v1.4.0-alpha.5 hosted demo evidence matrix and manifest capture', () => {
