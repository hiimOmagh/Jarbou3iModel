...
const PUBLIC_VERSION_LABEL = 'v1.4.0-alpha.9 Controlled Execution Candidate Gate';
...
test.describe('v1.4.0-alpha.9 hosted demo evidence matrix and manifest capture', () => {
