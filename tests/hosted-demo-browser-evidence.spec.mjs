...
const PUBLIC_VERSION_LABEL = 'v1.4.0-alpha.19 Evidence Dashboard Decision Ledger';
...
const EXPECTED_AR_CURRENT_RELEASE_DESCRIPTION_TOKENS = Object.freeze([
  'سجل قرارات لوحة الأدلة جاهز لأدلة الإصدار',
  'يحوّل حالة لوحة الأدلة إلى مسارات قرار للمشغّل',
  'جاهز لمراجعة القفل',
  'مراجعة ضغط الميزانية',
  'حظر القفل عند الانحدار',
  'التقاط أدلة حالية قبل القفل',
  'دون توسيع سطح المتصفح',
  'طبقة سجل قرارات فقط',
  'دون نداءات مزوّد حية',
  'دون نداءات شبكة مخفية'
]);
...
test.describe('v1.4.0-alpha.19 hosted demo evidence matrix and manifest capture', () => {
