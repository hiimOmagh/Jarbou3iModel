...
assert.equal(release.RELEASE_VERSION, '1.1.0');
...
assert.ok(migrationSource.includes('1.1.0'), 'v1.1.0 target must be supported');

const policy = release.releaseCandidatePolicy({ version: '1.1.0' });
...
}, { version: '1.1.0', externalCiPassed: true, externalCiNotes: 'external CI succeeded' });
assert.equal(report.release_candidate_version, '1.1.0');
assert.equal(report.stable_release_version, '1.1.0');
...
assert.equal(fixture.workflow_version, '1.1.0');
assert.equal(fixture.release_candidate.release_candidate_version, '1.1.0');
assert.equal(fixture.release_candidate.stable_release_version, '1.1.0');
