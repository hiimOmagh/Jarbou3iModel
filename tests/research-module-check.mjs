...
if (engine.length > 160000) fail(`research-engine.js exceeded v1.1.0-alpha.14 orchestration ceiling after alpha.13 prompt compiler integration: ${engine.length} bytes`);
