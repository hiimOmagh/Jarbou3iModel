...
if (engine.length > 192000) fail(`research-engine.js exceeded v1.1.0-alpha.23 orchestration ceiling after evidence workspace UX throughput integration: ${engine.length} bytes`);
