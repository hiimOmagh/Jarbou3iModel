...
if (engine.length > 165000) fail(`research-engine.js exceeded v1.1.0-alpha.16 orchestration ceiling after entity intelligence integration: ${engine.length} bytes`);
