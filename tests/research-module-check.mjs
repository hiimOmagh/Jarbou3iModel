...
if (engine.length > 202000) fail(`research-engine.js exceeded v1.1.0-rc.2 orchestration ceiling after release candidate hygiene integration: ${engine.length} bytes`);
