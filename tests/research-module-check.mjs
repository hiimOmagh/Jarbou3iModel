...
if (engine.length > 196000) fail(`research-engine.js exceeded v1.1.0-alpha.24 orchestration ceiling after golden workflow corpus integration: ${engine.length} bytes`);
