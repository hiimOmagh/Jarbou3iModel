...
if (engine.length > 156000) fail(`research-engine.js exceeded v1.1.0-alpha.11 orchestration ceiling after alpha.11 trilingual shell hardening: ${engine.length} bytes`);
