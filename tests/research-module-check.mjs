...
if (engine.length > 176000) fail(`research-engine.js exceeded v1.1.0-alpha.19 orchestration ceiling after strategic evidence graph integration: ${engine.length} bytes`);
