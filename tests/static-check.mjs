...
if (pkg.version !== '1.4.0-alpha.15') fail('package version must be 1.4.0-alpha.15');
if (!index.includes('name="app-version" content="1.4.0-alpha.15"')) fail('app version metadata missing');
