...
if (pkg.version !== '1.4.0-alpha.29') fail('package version must be 1.4.0-alpha.29');
if (!index.includes('name="app-version" content="1.4.0-alpha.29"')) fail('app version metadata missing');
