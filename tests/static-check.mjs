...
if (pkg.version !== '1.4.0-alpha.39') fail('package version must be 1.4.0-alpha.39');
if (!index.includes('name="app-version" content="1.4.0-alpha.39"')) fail('app version metadata missing');
