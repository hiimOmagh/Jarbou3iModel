...
if (pkg.version !== '1.4.0-alpha.38') fail('package version must be 1.4.0-alpha.38');
if (!index.includes('name="app-version" content="1.4.0-alpha.38"')) fail('app version metadata missing');
