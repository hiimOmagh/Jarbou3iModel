...
assert.ok(docs.includes('Browser QA + Visual Regression Hardening'), 'v1.1.0-alpha.24 docs missing');
assert.equal(fixture.workflow_version, '1.1.0-alpha.24');
assert.equal(fixture.browser_qa_hardening?.hardening_version, '1.1.0-alpha.24');
