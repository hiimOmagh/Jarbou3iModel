...
assert.ok(docs.includes('Browser QA + Visual Regression Hardening'), 'v1.1.0-rc.2-fix.1 docs missing');
assert.equal(fixture.workflow_version, '1.1.0-rc.2-fix.1');
assert.equal(fixture.browser_qa_hardening?.hardening_version, '1.1.0-rc.2-fix.1');
