...
Public label: `v1.3.0-alpha.8 Signed Export Handoff Pack + Lock Ledger Review Surface`. Internal evidence metadata: `1.3.0-alpha.8`.
...
Node 24 CI compatibility is preserved for v1.3.0-alpha.8 and the v1.1.0 stable public-demo baseline.
