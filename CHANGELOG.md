...
Public surface: `v1.1.0 Stable Candidate`. Internal RC validation metadata remains `1.1.0-rc.2-fix.2` until stable lock.
...
Release-lock guard: 1.1.0-rc.2-fix.2 Evidence Matrix + Canonical Bundle Validation requires green no-browser CI, green browser CI, and reviewed hosted-demo evidence. Screenshots alone are insufficient. ZIP existence alone is insufficient. A ZIP archive alone is insufficient.
