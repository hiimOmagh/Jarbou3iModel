...
Public label: `v1.2.0-alpha.8 Diagnostic Repair Queue + Export Risk Resolution`. Internal evidence metadata: `1.2.0-alpha.8`. This controlled alpha improves review-quality triage and weak-claim repair guidance inside the local/manual Source-to-Brief workbench; it does not verify sources, fetch live data, expand providers, enable production OAuth, add backend behavior, or change persistent storage.
