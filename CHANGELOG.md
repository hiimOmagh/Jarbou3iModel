...
Release-lock guard: 1.1.0-rc.2 Canonical Lock Evidence Bundle + Final Stable Handoff requires green no-browser CI, green browser CI, and reviewed hosted-demo evidence. Screenshots alone are insufficient. ZIP existence alone is insufficient. A ZIP archive alone is insufficient.
