...
const publicVersionLabel = 'v1.3.0-alpha.4 Brief Template UX Polish + Matrix Hygiene Cleanup';
const release = `v${version} — Brief Template UX Polish + Matrix Hygiene Cleanup`;
