...
const publicVersionLabel = 'v1.4.0-alpha.27 Adapter Replay Decision Drilldown + Evidence Trace Links';
const release = `v${version} — Adapter Replay Decision Drilldown + Evidence Trace Links`;
