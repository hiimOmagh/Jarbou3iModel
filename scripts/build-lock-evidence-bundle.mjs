...
const publicVersionLabel = 'v1.4.0-alpha.14 Adapter Replay Fixture Corpus + Coverage Matrix';
const release = `v${version} — Adapter Replay Fixture Corpus + Coverage Matrix`;
