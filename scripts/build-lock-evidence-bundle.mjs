...
const publicVersionLabel = 'v1.4.0-alpha.28 Adapter Replay Review Pack + Operator Handoff Export';
const release = `v${version} — Adapter Replay Review Pack + Operator Handoff Export`;
