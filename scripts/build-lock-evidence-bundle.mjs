...
const publicVersionLabel = 'v1.2.0-alpha.3 Source-to-Brief UX Compression + Operator Flow Polish';
const release = `v${version} — Source-to-Brief UX Compression + Operator Flow Polish`;
