...
const publicVersionLabel = 'v1.4.0-alpha.2 Provider/Source Execution Policy Matrix + Failure UX Contracts';
const release = `v${version} — Provider/Source Execution Policy Matrix + Failure UX Contracts`;
