...
const currentTitle = currentReleaseContract.milestone_name || 'Adapter Replay Review Pack Operator Review Console';
const publicVersionLabel = `v${version} ${currentTitle}`;
const release = `v${version} — ${currentTitle}`;
