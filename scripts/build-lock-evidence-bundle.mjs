...
const publicVersionLabel = 'v1.2.0-alpha.8 Diagnostic Repair Queue + Export Risk Resolution';
const release = `v${version} — Diagnostic Repair Queue + Export Risk Resolution`;
