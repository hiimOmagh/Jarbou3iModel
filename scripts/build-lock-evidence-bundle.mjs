...
const publicVersionLabel = 'v1.4.0-alpha.4 Dry-Run Trace Inspector + Execution Readiness Report';
const release = `v${version} — Dry-Run Trace Inspector + Execution Readiness Report`;
