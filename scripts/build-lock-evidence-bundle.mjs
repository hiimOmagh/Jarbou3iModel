...
const publicVersionLabel = 'v1.2.0-alpha.5 Claim Traceability Console + Review Decision Ledger';
const release = `v${version} — Claim Traceability Console + Review Decision Ledger`;
