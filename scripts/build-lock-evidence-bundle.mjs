...
const publicVersionLabel = 'v1.2.0-alpha.7 Review Quality Diagnostics + Weak-Claim Repair Suggestions';
const release = `v${version} — Review Quality Diagnostics + Weak-Claim Repair Suggestions`;
