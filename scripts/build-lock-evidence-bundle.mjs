...
const publicVersionLabel = 'v1.3.0-rc.2 RC Evidence Tightening + Release Notes Finalization';
const release = `v${version} — RC Evidence Tightening + Release Notes Finalization`;
