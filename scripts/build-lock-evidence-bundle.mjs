...
const publicVersionLabel = 'v1.4.0-alpha.25 Release System Consolidation + Effective Diff Guard';
const release = `v${version} — Release System Consolidation + Effective Diff Guard`;
