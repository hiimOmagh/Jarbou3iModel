...
const publicVersionLabel = 'v1.2.0-alpha.6 Operator Command Palette + Review Navigation Shortcuts';
const release = `v${version} — Operator Command Palette + Review Navigation Shortcuts`;
