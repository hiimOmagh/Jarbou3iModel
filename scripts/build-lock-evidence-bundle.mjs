...
const publicVersionLabel = 'v1.3.0-alpha.1 Guided Research Session Engine + Brief Assembly Workflow';
const release = `v${version} — Guided Research Session Engine + Brief Assembly Workflow`;
