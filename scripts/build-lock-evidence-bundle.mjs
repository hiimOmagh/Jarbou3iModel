...
const publicVersionLabel = 'v1.3.0-alpha.5 Brief Assembly Preview Diff + Export Review Signoff';
const release = `v${version} — Brief Assembly Preview Diff + Export Review Signoff`;
