...
const publicVersionLabel = 'v1.2.0-alpha.4 Evidence Review Throughput + Source-to-Brief Export Polish';
const release = `v${version} — Evidence Review Throughput + Source-to-Brief Export Polish`;
