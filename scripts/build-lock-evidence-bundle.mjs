...
const publicVersionLabel = 'v1.4.0-alpha.11 Manual Execution Safety Cockpit + Session Ledger';
const release = `v${version} — Manual Execution Safety Cockpit + Session Ledger`;
