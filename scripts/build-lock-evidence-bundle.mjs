...
const publicVersionLabel = 'v1.3.0-alpha.2 Guided Session UX Compression + Brief Assembly Export QA';
const release = `v${version} — Guided Session UX Compression + Brief Assembly Export QA`;
