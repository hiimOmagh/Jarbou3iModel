...
const publicVersionLabel = 'v1.4.0-alpha.6 Provider Execution Harness Mock-to-Live Equivalence';
const release = `v${version} — Provider Execution Harness Mock-to-Live Equivalence`;
