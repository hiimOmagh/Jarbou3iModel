...
const publicVersionLabel = 'v1.3.0-alpha.8 Signed Export Handoff Pack + Lock Ledger Review Surface';
const release = `v${version} — Signed Export Handoff Pack + Lock Ledger Review Surface`;
