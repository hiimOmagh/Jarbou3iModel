...
const publicVersionLabel = 'v1.4.0-alpha.12 Manual Provider Adapter Sandbox + Ephemeral Invocation Contract';
const release = `v${version} — Manual Provider Adapter Sandbox + Ephemeral Invocation Contract`;
