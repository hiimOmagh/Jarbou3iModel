...
const publicVersionLabel = 'v1.2.0-alpha.1 Post-Stable Capability Roadmap + Expansion Gate';
const release = `v${version} — Post-Stable Capability Roadmap + Expansion Gate`;
