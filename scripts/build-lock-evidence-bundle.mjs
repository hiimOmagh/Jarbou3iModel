...
const publicVersionLabel = 'v1.4.0-alpha.26 Adapter Replay Insight UX + Operator Decision Surface';
const release = `v${version} — Adapter Replay Insight UX + Operator Decision Surface`;
