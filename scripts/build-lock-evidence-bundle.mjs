...
const publicVersionLabel = 'v1.4.0-alpha.13 Adapter Contract Test Bench + No-Network Invocation Replay QA';
const release = `v${version} — Adapter Contract Test Bench + No-Network Invocation Replay QA`;
