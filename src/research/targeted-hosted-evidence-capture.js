/* Jarbou3i Research Engine targeted hosted evidence capture 1.4.0-alpha.63. */
...
(function(global){
  ...
  const VERSION = '1.4.0-alpha.63';
  const MILESTONE = 'v1.4.0-alpha.63 — Evidence Performance Policy Enforcement Wiring';
