/* Jarbou3i Research Engine targeted hosted evidence capture 1.4.0-alpha.46. */
...
(function(global){
  ...
  const VERSION = '1.4.0-alpha.46';
  const MILESTONE = 'v1.4.0-alpha.46 — Module Boundary Regression Guard';
