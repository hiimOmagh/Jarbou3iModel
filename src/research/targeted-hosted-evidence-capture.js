/* Jarbou3i Research Engine targeted hosted evidence capture 1.4.0-alpha.51. */
...
(function(global){
  ...
  const VERSION = '1.4.0-alpha.51';
  const MILESTONE = 'v1.4.0-alpha.51 — Release Lock Dashboard Artifact + Evidence Digest';
