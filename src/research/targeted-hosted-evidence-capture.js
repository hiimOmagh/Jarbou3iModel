/* Jarbou3i Research Engine targeted hosted evidence capture 1.4.0-alpha.57. */
...
(function(global){
  ...
  const VERSION = '1.4.0-alpha.57';
  const MILESTONE = 'v1.4.0-alpha.57 — Visible-Text Token Drift Guard';
  ...
  const REQUIRED_REGIONS = Object.freeze([
    ...
    Object.freeze({ region_id:'hosted-demo-release-contract', evidence_root_selector:'[data-evidence-region="hosted-demo-release-contract"]', proof_selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', surface:'hosted-demo', claim:'Current release visible-token drift guard and browser-evidence preflight requirements are visible.', expected_tokens:Object.freeze(['Visible-Text Token Drift Guard','visible-token drift','static guard','browser evidence']), max_width:MAX_TARGETED_WIDTH, max_height:MAX_TARGETED_HEIGHT }),
