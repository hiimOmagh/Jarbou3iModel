/* Jarbou3i Research Engine targeted hosted evidence capture 1.4.0-alpha.49. */
...
(function(global){
  ...
  const VERSION = '1.4.0-alpha.49';
  const MILESTONE = 'v1.4.0-alpha.49 — Diagnosis Report Artifact Export + Operator Handoff Snapshot';
  ...
  const REQUIRED_REGIONS = Object.freeze([
    ...
    Object.freeze({ region_id:'hosted-demo-release-contract', evidence_root_selector:'[data-evidence-region="hosted-demo-release-contract"]', proof_selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', surface:'hosted-demo', claim:'Current release diagnosis report artifact export and operator handoff snapshot requirements are visible.', expected_tokens:Object.freeze(['Diagnosis Report Artifact Export + Operator Handoff Snapshot','diagnosis report JSON','operator handoff snapshot','artifact output contract']), max_width:MAX_TARGETED_WIDTH, max_height:MAX_TARGETED_HEIGHT }),
