/* Jarbou3i Research Engine targeted hosted evidence capture 1.4.0-alpha.60. */
...
(function(global){
  ...
  const VERSION = '1.4.0-alpha.60';
  const MILESTONE = 'v1.4.0-alpha.60 — Evidence Performance Ledger Reader + Trend Diff Guard';
  ...
  const REQUIRED_REGIONS = Object.freeze([
    ...
    Object.freeze({ region_id:'hosted-demo-release-contract', evidence_root_selector:'[data-evidence-region="hosted-demo-release-contract"]', proof_selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', surface:'hosted-demo', claim:'Current release hosted evidence trend diff ledger and slowest-phase timing summary are visible.', expected_tokens:Object.freeze(['Evidence Performance Ledger Reader + Trend Diff Guard','trend diff','ledger reader','hosted evidence']), max_width:MAX_TARGETED_WIDTH, max_height:MAX_TARGETED_HEIGHT }),
