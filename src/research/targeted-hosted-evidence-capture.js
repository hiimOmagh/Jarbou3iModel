/* Jarbou3i Research Engine targeted hosted evidence capture 1.4.0-alpha.52. */
...
(function(global){
  ...
  const VERSION = '1.4.0-alpha.52';
  const MILESTONE = 'v1.4.0-alpha.52 — Release Digest Regression Guard + Lock Bundle Schema Contract';
  ...
  const REQUIRED_REGIONS = Object.freeze([
    ...
    Object.freeze({ region_id:'hosted-demo-release-contract', evidence_root_selector:'[data-evidence-region="hosted-demo-release-contract"]', proof_selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', surface:'hosted-demo', claim:'Current release lock dashboard and evidence digest requirements are visible.', expected_tokens:Object.freeze(['Release Digest Regression Guard + Lock Bundle Schema Contract','release lock dashboard','evidence digest','lockable reviewer decision']), max_width:MAX_TARGETED_WIDTH, max_height:MAX_TARGETED_HEIGHT }),
