/* Jarbou3i Research Engine targeted hosted evidence capture 1.4.0-alpha.53. */
...
(function(global){
  ...
  const VERSION = '1.4.0-alpha.53';
  const MILESTONE = 'v1.4.0-alpha.53 — Lock Bundle Schema Enforcement in CI';
