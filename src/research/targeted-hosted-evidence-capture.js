/* Jarbou3i Research Engine targeted hosted evidence capture 1.4.0-alpha.47. */
...
(function(global){
  ...
  const VERSION = '1.4.0-alpha.47';
  const MILESTONE = 'v1.4.0-alpha.47 — Patch Package Safety + Release Identity Sweep Guard';
  ...
  const REQUIRED_REGIONS = Object.freeze([
    ...
    Object.freeze({ region_id:'hosted-demo-release-contract', evidence_root_selector:'[data-evidence-region="hosted-demo-release-contract"]', proof_selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', surface:'hosted-demo', claim:'Current release patch package safety and release identity sweep requirements are visible.', expected_tokens:Object.freeze(['Patch Package Safety + Release Identity Sweep Guard','patch package collision guard','release identity sweep','bulk diagnosis']), max_width:MAX_TARGETED_WIDTH, max_height:MAX_TARGETED_HEIGHT }),
