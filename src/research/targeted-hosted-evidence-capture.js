/* Jarbou3i Research Engine targeted hosted evidence capture 1.4.0-alpha.48. */
...
(function(global){
  ...
  const VERSION = '1.4.0-alpha.48';
  const MILESTONE = 'v1.4.0-alpha.48 — Bulk Diagnosis UX + Gate Failure Family Report';
  ...
  const REQUIRED_REGIONS = Object.freeze([
    ...
    Object.freeze({ region_id:'hosted-demo-release-contract', evidence_root_selector:'[data-evidence-region="hosted-demo-release-contract"]', proof_selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', surface:'hosted-demo', claim:'Current release bulk diagnosis UX and gate failure family report requirements are visible.', expected_tokens:Object.freeze(['Bulk Diagnosis UX + Gate Failure Family Report','failure-family summary','affected files','recommended next command']), max_width:MAX_TARGETED_WIDTH, max_height:MAX_TARGETED_HEIGHT }),
