/* Jarbou3i Research Engine targeted hosted evidence capture 1.4.0-alpha.64. */
...
(function(global){
  ...
  const VERSION = '1.4.0-alpha.64';
  const MILESTONE = 'v1.4.0-alpha.64 — Live Evidence Performance Trend Diff Bundle Inclusion';
