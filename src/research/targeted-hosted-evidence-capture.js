/* Jarbou3i Research Engine targeted hosted evidence capture 1.4.0-alpha.50. */
...
(function(global){
  ...
  const VERSION = '1.4.0-alpha.50';
  const MILESTONE = 'v1.4.0-alpha.50 — Diagnosis Artifact Lifecycle Guard + CI Artifact Hygiene';
  ...
  const REQUIRED_REGIONS = Object.freeze([
    ...
    Object.freeze({ region_id:'hosted-demo-release-contract', evidence_root_selector:'[data-evidence-region="hosted-demo-release-contract"]', proof_selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', surface:'hosted-demo', claim:'Current release diagnosis artifact lifecycle and CI artifact hygiene requirements are visible.', expected_tokens:Object.freeze(['Diagnosis Artifact Lifecycle Guard + CI Artifact Hygiene','artifact lifecycle guard','CI artifact hygiene','static-mode artifact skip']), max_width:MAX_TARGETED_WIDTH, max_height:MAX_TARGETED_HEIGHT }),
