/* Jarbou3i Research Engine targeted hosted evidence capture 1.4.0-alpha.54. */
...
(function(global){
  ...
  const VERSION = '1.4.0-alpha.54';
  const MILESTONE = 'v1.4.0-alpha.54 — Lock Evidence Review CLI + Digest Reader';
  ...
  const REQUIRED_REGIONS = Object.freeze([
    ...
    Object.freeze({ region_id:'hosted-demo-release-contract', evidence_root_selector:'[data-evidence-region="hosted-demo-release-contract"]', proof_selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', surface:'hosted-demo', claim:'Current release lock evidence review CLI and digest reader requirements are visible.', expected_tokens:Object.freeze(['Lock Evidence Review CLI + Digest Reader','lock bundle ZIP','dashboard digest','next action']), max_width:MAX_TARGETED_WIDTH, max_height:MAX_TARGETED_HEIGHT }),
