/* Jarbou3i Research Engine targeted hosted evidence capture 1.4.0-alpha.58. */
...
(function(global){
  ...
  const VERSION = '1.4.0-alpha.58';
  const MILESTONE = 'v1.4.0-alpha.58 — Hosted Evidence Capture Timeout Budget Guard';
  ...
  const REQUIRED_REGIONS = Object.freeze([
    ...
    Object.freeze({ region_id:'hosted-demo-release-contract', evidence_root_selector:'[data-evidence-region="hosted-demo-release-contract"]', proof_selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', selector:'[data-evidence-region="hosted-demo-release-contract"] > div:first-child', surface:'hosted-demo', claim:'Current release hosted evidence capture timing budget and browser-evidence timeout guard are visible.', expected_tokens:Object.freeze(['Hosted Evidence Capture Timeout Budget Guard','capture timing','timeout budget','browser evidence']), max_width:MAX_TARGETED_WIDTH, max_height:MAX_TARGETED_HEIGHT }),
