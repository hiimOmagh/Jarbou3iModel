/* Jarbou3i Research Engine render helpers v1.1.0-alpha.4. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.1.0-alpha.4 · Migration + Privacy Fixture Registry Consolidation',
    ...
    ar: {
      ...
      alphaBadge:'v1.1.0-alpha.4 · بوابة تخطيط ما بعد التجميد' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.1.0-alpha.4 · Portail de planification post-gel',
