/* Jarbou3i Research Engine render helpers v1.0.28. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.28 · Hosted Demo Evidence Manifest Gate',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.28 · بيان أدلة العرض' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.28 · Manifeste de preuves',
