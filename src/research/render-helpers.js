/* v1.4.0-alpha.20 · Evidence Decision Ledger Handoff Audit. Runtime-budget guard only; disabled by default. */
...
(function(global){
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.4.0-alpha.20 Evidence Decision Ledger Handoff Audit · Runtime-Budget Guard Only',
    ...
    ar: {
      ...
      alphaBadge:'v1.4.0-alpha.20 تدقيق تسليم سجل قرارات الأدلة · مراجعة المشغّل' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.4.0-alpha.20 Audit de remise du registre de décision preuves · revue opérateur',
  ...
  Object.assign(COPY.en, {
    ...
    hostedDemoVerificationBody:'Evidence Decision Ledger Handoff Audit is ready for release evidence: it maps dashboard status into lock-review-ready, budget-pressure-review, regression-blocked, and evidence-capture-required operator decision paths without expanding browser scope. Hosted evidence must report 1.4.0-alpha.20 internally while showing v1.4.0-alpha.20 Evidence Decision Ledger Handoff Audit to users. Decision-ledger layer only: no live provider calls, hidden network requests, OAuth/token lifecycle, credential persistence, live source fetching, automatic verification, signoff, export lock, cryptographic signature claim, or publication permission is enabled.',
  ...
  Object.assign(COPY.fr, {
    ...
    hostedDemoVerificationBody:'L’audit de remise du registre de décision preuves est prêt pour les preuves de release : il vérifie la remise du registre, l’identité du bundle de verrouillage, les limites de comportement et la décision opérateur manuelle sans élargir la portée navigateur. Les preuves hébergées doivent annoncer 1.4.0-alpha.20 en interne tout en affichant v1.4.0-alpha.20 Audit de remise du registre de décision preuves · revue opérateur aux utilisateurs. Couche audit de remise uniquement : aucun appel fournisseur réel, appel réseau caché, OAuth/cycle de token réel, persistance d’identifiants, fetch source live, vérification, visa, verrou ou publication automatique.',
  ...
  Object.assign(COPY.en, {
    analysisReleaseNote:'1.4.0-alpha.20 converts evidence-budget regression results into pass, warn, fail, and review-required operator actions without network calls.',
  ...
  Object.assign(COPY.ar, {
    analysisReleaseNote:'يحوّل 1.4.0-alpha.20 نتائج انحدار ميزانية الأدلة إلى نجاح وتحذير وفشل ومراجعة مطلوبة مع إجراءات المشغّل دون نداءات شبكة.',
  ...
  Object.assign(COPY.fr, {
    analysisReleaseNote:'1.4.0-alpha.20 convertit les résultats de régression du budget preuves en actions opérateur pass, warn, fail et revue requise sans appels réseau.',
  ...
  Object.assign(COPY.en, {
    adapterContractTestBenchTitle:'Evidence Decision Ledger Handoff Audit',
  ...
  Object.assign(COPY.ar, {
    adapterContractTestBenchTitle:'تدقيق تسليم سجل قرارات الأدلة',
    adapterContractTestBenchSubtitle:'تحوّل حالة لوحة الأدلة إلى مسارات قرار للمشغّل دون توسيع سطح المتصفح.',
    adapterContractTestBenchPolicyNote:'طبقة تدقيق تسليم فقط: لا نداءات مزوّد حقيقية ولا طلبات شبكة مخفية ولا OAuth/دورة رموز ولا تخزين بيانات اعتماد ولا جلب مصادر حي ولا تحقق أو توقيع أو قفل تصدير أو إذن نشر آلي.'
  });
  Object.assign(COPY.fr, {
    adapterContractTestBenchTitle:'Audit de remise du registre de décision preuves',
    ...
    adapterContractTestBenchPolicyNote:'Couche audit de remise uniquement : aucun appel fournisseur réel, requête réseau cachée, OAuth/cycle de token, persistance d’identifiants, fetch source live, vérification, visa, verrou d’export ou permission de publication automatique.'
  });
