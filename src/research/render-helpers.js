/* Jarbou3i Research Engine render helpers v1.0.26. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.26 · Release Apply Integrity Gate',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.26 · قفل سلامة التطبيق' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.26 · Verrou d’application',
