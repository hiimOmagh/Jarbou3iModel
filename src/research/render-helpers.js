/* Jarbou3i Research Engine render helpers v1.1.0-alpha.25. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.1.0-alpha.25 · Release Candidate Hardening + Final Repo Hygiene',
    ...
    ar: {
      ...
      alphaBadge:'v1.1.0-alpha.25 · تقوية مرشح الإصدار وتنظيف المستودع النهائي' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.1.0-alpha.25 · Durcissement RC + hygiène finale du dépôt',
  ...
  Object.assign(COPY.en, {
    ...
    hostedDemoVerificationBody:'Planning gate only: no live search, no scraping, no real OAuth, no automatic provider execution, and no automated source verification are enabled. v1.1.0-alpha.25 adds release-candidate hardening, stale release-copy sweep, final repo hygiene audit, golden workflow regression lock, Export Pack v3 artifact consistency lock, hosted-demo evidence runbook, and CI parity readiness.',
    ...
    evidenceReviewGateBody:'v1.1.0-alpha.25 preserves the public-demo freeze while adding final repo hygiene audit, stale release-copy sweep, golden workflow regression lock, Export Pack v3 consistency lock, hosted-demo evidence runbook tightening, and release-candidate readiness reporting. Evidence Review Queue and privacy guards remain required.',
  ...
  Object.assign(COPY.ar, {
    ...
    hostedDemoVerificationBody:'بوابة تخطيط فقط: لا يوجد بحث حي أو scraping أو OAuth حقيقي أو تنفيذ مزود تلقائي أو تحقق آلي من المصادر. تضيف v1.1.0-alpha.25 تقوية مرشح الإصدار وتنظيف المستودع النهائي: كنس نسخ الإصدار القديمة، قفل رجوع المجموعة الذهبية، اتساق Export Pack v3، وrunbook أدلة العرض المستضاف.',
    ...
    evidenceReviewGateBody:'تحافظ v1.1.0-alpha.25 على تجميد العرض العام وتضيف تدقيق نظافة المستودع، كنس نسخ الإصدار القديمة، قفل رجوع المجموعة الذهبية، قفل اتساق التصدير، وتقرير جاهزية مرشح الإصدار. تبقى مراجعة الأدلة وحراس الخصوصية مطلوبة.',
  ...
  Object.assign(COPY.fr, {
    ...
    hostedDemoVerificationBody:'Porte de planification uniquement: aucune recherche live, aucun scraping, aucun OAuth réel, aucune exécution fournisseur automatique et aucune vérification automatique des sources. v1.1.0-alpha.25 ajoute durcissement RC, balayage des copies obsolètes, hygiène finale du dépôt, verrou golden workflow, cohérence Export Pack v3 et runbook de preuves hébergées.',
    ...
    evidenceReviewGateBody:'v1.1.0-alpha.25 préserve le gel de la démo publique tout en ajoutant audit d’hygiène du dépôt, balayage des copies obsolètes, verrou golden workflow, verrou cohérence Export Pack v3, runbook hébergé et rapport de préparation RC. La revue des preuves et les garde-fous de confidentialité restent requis.',
  ...
  Object.assign(COPY.en, {
    analysisReleaseNote:'v1.1.0-alpha.25 adds Release Candidate Hardening + Final Repo Hygiene: deterministic source/evidence/entity/cluster/graph/brief fixture, end-to-end workflow verification, Export Pack v3 golden validation, hosted-demo scenario evidence, and release-readiness runbook without live connectors, provider execution, OAuth/backend, or source verification claims.',
  ...
  Object.assign(COPY.ar, {
    analysisReleaseNote:'تضيف v1.1.0-alpha.25 تقوية مرشح الإصدار وتنظيف المستودع النهائي: تدقيق النظافة، كنس النسخ القديمة، قفل رجوع المجموعة الذهبية، قفل اتساق Export Pack v3، runbook العرض المستضاف، وتقرير جاهزية مرشح الإصدار دون scraping أو OAuth/backend.',
  ...
  Object.assign(COPY.fr, {
    analysisReleaseNote:'v1.1.0-alpha.25 ajoute Durcissement RC + hygiène finale du dépôt: audit hygiène, balayage copies obsolètes, verrou golden workflow, verrou cohérence Export Pack v3, runbook hébergé, rapport préparation RC et parité CI sans nouvelle surface majeure.',
