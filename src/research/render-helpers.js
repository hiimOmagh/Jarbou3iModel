/* Jarbou3i Research Engine render helpers v1.0.20. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.20 · Source Packet Templates',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.20 · قوالب حزمة المصادر' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.20 · Modèles de paquet source',
