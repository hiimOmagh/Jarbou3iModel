/* Jarbou3i Research Engine render helpers v1.1.0-alpha.8. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.1.0-alpha.8 · Fixture Registry Payload Compression + Test Organization Audit',
    ...
    ar: {
      ...
      alphaBadge:'v1.1.0-alpha.8 · بوابة تخطيط ما بعد التجميد' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.1.0-alpha.8 · Portail de planification post-gel',
