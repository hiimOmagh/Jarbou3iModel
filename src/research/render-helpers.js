/* Jarbou3i Research Engine render helpers v1.1.0-alpha.11. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.1.0-alpha.11 · Fixture/Test Debt Ledger + Source-File Refactor Readiness Audit',
    ...
    ar: {
      ...
      alphaBadge:'v1.1.0-alpha.11 · سجل ديون الاختبارات وجاهزية إعادة هيكلة ملفات المصدر' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.1.0-alpha.11 · Registre de dette tests/fixtures et audit de préparation au refactor source',
  ...
  Object.assign(COPY.en, {
    analysisReleaseNote:'v1.1.0-alpha.11 adds the fixture/test debt ledger, source-file refactor readiness audit, and hosted-evidence visual guard without changing runtime behavior.',
    ...
    statusLabels:{review_required:'review required', draft_only:'draft only', blocked:'blocked', pass:'pass', publication_candidate:'publication candidate', research_ready:'research ready', reviewable_draft:'reviewable draft', synthesis_ready:'synthesis ready', provider_ready:'provider ready', empty:'empty', review_resolved:'review resolved'},
  ...
  Object.assign(COPY.ar, {
    analysisReleaseNote:'تضيف v1.1.0-alpha.11 سجل دين الاختبارات والفيكستشرات، وتدقيق جاهزية تفكيك ملفات المصدر، وحارس الشوائب البصرية لأدلة الاستضافة دون تغيير سلوك التشغيل.',
  ...
  Object.assign(COPY.fr, {
    analysisReleaseNote:'v1.1.0-alpha.11 ajoute le registre de dette fixtures/tests, l’audit de préparation au refactor des fichiers source et le garde-fou visuel des preuves hébergées sans changer le comportement runtime.',
    ...
    qualityScoringTitle:'Calibration du score des preuves', reliabilityLabel:'fiabilité', attentionLabel:'attention', traceabilityLabel:'traçabilité', calibrationWarnings:'alertes de calibration', evidenceScoringPolicyNote:'Attention = visibilité publique seulement. Fiabilité = force de source, traçabilité, spécificité, confiance et récence. Le poids de synthèse aide à prioriser, pas à établir la vérité.', guardLabel:'Garde-fou',
    qualityFixEvidence:'Ajoutez des preuves traçables avec URLs, dates, types de sources et valeurs evidence_strength plus fortes.', qualityFixContradiction:'Ajoutez des contre-preuves et des énoncés liés aux contradictions avant de traiter l’analyse comme robuste.', qualityFixDiversity:'Diversifiez les types de sources ; évitez de dépendre d’une seule classe média ou signal.', qualityFixReliability:'Améliorez la fiabilité des preuves : privilégiez les sources officielles, primaires, académiques ou bien documentées plutôt que les seuls signaux d’attention.', qualityFixAttention:'Séparez l’attention publique de la valeur de vérité ; les items sociaux très engagés exigent une corroboration indépendante avant de peser davantage dans la synthèse.', qualityFixCausal:'Ajoutez des liens causaux appuyés par preuves entre intérêts, acteurs, outils, narratif, résultats et rétroaction.', qualityFixProvider:'Exécutez la validation fournisseur dry-run/fixtures et confirmez que key_exported reste false.', qualityFixPrivacy:'Lancez l’audit d’export confidentialité et résolvez tous les problèmes post-rédaction avant partage.', qualityFixMigration:'Réimportez via la couche migration et confirmez que packet_migration_report.import_safe vaut true.', qualityFixProceed:'Passez à la revue de publication : vérifiez manuellement les sources, la direction causale et les falsificateurs de scénarios.',
    statusLabels:{review_required:'revue requise', draft_only:'brouillon seulement', blocked:'bloqué', pass:'validé', publication_candidate:'candidat publication', research_ready:'prêt recherche', reviewable_draft:'brouillon révisable', synthesis_ready:'prêt synthèse', provider_ready:'fournisseur prêt', empty:'vide', review_resolved:'revue résolue'},
