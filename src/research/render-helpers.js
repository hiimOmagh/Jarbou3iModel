/* v1.1.0-rc.2 · Canonical Lock Evidence Bundle + Final Stable Handoff; public surface displays v1.1.0 Stable Candidate.  Jarbou3i Research Engine render helpers v1.1.0-rc.2. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.1.0 Stable Candidate · Canonical Lock Evidence Bundle + Final Stable Handoff',
  ...
  Object.assign(COPY.en, {
    ...
    hostedDemoVerificationBody:'Public surface freeze for v1.1.0 stable candidate: feature surface is frozen, alpha/RC residue is removed from demo copy, the golden workflow and Export Pack v3 remain locked, and hosted evidence must report 1.1.0-rc.2. No live scraping, real OAuth, backend expansion, live provider execution, or automatic source verification is enabled.',
  ...
  Object.assign(COPY.ar, {
    ...
    hostedDemoVerificationBody:'تجميد السطح العام لمرشح v1.1.0 المستقر: سطح الوظائف مجمّد، بقايا alpha/RC أزيلت من نسخة العرض، المجموعة الذهبية وExport Pack v3 مقفولان، ويجب أن تعلن أدلة الاستضافة 1.1.0-rc.2. لا يوجد scraping أو OAuth حقيقي أو توسيع خلفية أو تنفيذ مزود حي أو ادعاء تحقق آلي من المصادر.',
  ...
  Object.assign(COPY.en, {
    analysisReleaseNote:'1.1.0-rc.2 corrects the public-surface localization freeze: English, Arabic, and French release copy are language-pure, public copy stays aligned to v1.1.0 stable candidate, and internal evidence metadata remains 1.1.0-rc.2.',
  ...
  Object.assign(COPY.ar, {
    analysisReleaseNote:'تصحح 1.1.0-rc.2 تجميد ترجمة السطح العام: نسخة الإنجليزية والعربية والفرنسية صارت نقية لغويًا، نسخة العرض تبقى موجهة نحو v1.1.0 المستقر، وبيانات أدلة الاستضافة الداخلية تبقى 1.1.0-rc.2.',
  ...
  Object.assign(COPY.fr, {
    analysisReleaseNote:'1.1.0-rc.2 corrige le gel de localisation de la surface publique: les copies anglaise, arabe et française restent dans leur langue, la surface publique vise v1.1.0 candidat stable, et les métadonnées internes de preuve restent 1.1.0-rc.2.',
