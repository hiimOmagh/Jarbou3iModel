/* v1.3.0-alpha.10 · Brief Publication Pack v4; public surface displays v1.3.0-alpha.10 Brief Publication Pack v4.  Jarbou3i Research Engine render helpers v1.1.0. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.3.0-alpha.10 Brief Publication Pack v4 · Signed Handoff + Lock Review',
    ...
    ar: {
      ...
      alphaBadge:'v1.3.0-alpha.10 حزمة تسليم التصدير المعتمدة + مراجعة سجل القفل' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.3.0-alpha.10 Pack de remise export signé + revue du registre',
  ...
  Object.assign(COPY.en, {
    ...
    hostedDemoVerificationBody:'Brief Publication Pack v4 is ready for release evidence: the public copy is stable, the golden workflow and Export Pack v3 remain locked, and hosted evidence must report 1.3.0-alpha.10 internally while showing v1.3.0-alpha.10 Brief Publication Pack v4 to users. No live scraping, real OAuth, backend expansion, live provider execution, or automatic source verification is enabled.',
  ...
  Object.assign(COPY.ar, {
    ...
    hostedDemoVerificationBody:'العرض العام المستقر جاهز لأدلة الإصدار: النسخة العامة مستقرة، المجموعة الذهبية وExport Pack v3 مقفولان، ويجب أن تعلن أدلة الاستضافة داخليًا 1.3.0-alpha.10 مع عرض v1.3.0-alpha.10 حزمة تسليم التصدير المعتمدة + مراجعة سجل القفل للمستخدمين. لا يوجد scraping أو OAuth حقيقي أو توسيع خلفية أو تنفيذ مزود حي أو ادعاء تحقق آلي من المصادر.',
  ...
  Object.assign(COPY.fr, {
    ...
    hostedDemoVerificationBody:'La démo publique stable est prête pour les preuves de release : la copie publique est stable, le golden workflow et Export Pack v3 restent verrouillés, et les preuves hébergées doivent annoncer 1.3.0-alpha.10 en interne tout en affichant v1.3.0-alpha.10 Pack de remise export signé + revue du registre aux utilisateurs. Aucun scraping, OAuth réel, extension backend, fournisseur live ni vérification automatique des sources.',
  ...
  Object.assign(COPY.en, {
    analysisReleaseNote:'1.3.0-alpha.10 corrects stable public localization: English, Arabic, and French release copy are language-pure, public copy shows v1.3.0-alpha.10 Brief Publication Pack v4, and internal evidence metadata reports 1.3.0-alpha.10.',
  ...
  Object.assign(COPY.ar, {
    analysisReleaseNote:'تصحح 1.3.0-alpha.10 ترجمة السطح العام المستقر: نسخة الإنجليزية والعربية والفرنسية صارت نقية لغويًا، النسخة العامة تعرض v1.3.0-alpha.10 حزمة تسليم التصدير المعتمدة + مراجعة سجل القفل، وبيانات أدلة الاستضافة الداخلية تعلن 1.3.0-alpha.10.',
  ...
  Object.assign(COPY.fr, {
    analysisReleaseNote:'1.3.0-alpha.10 corrige la localisation publique stable : les copies anglaise, arabe et française restent dans leur langue, la surface publique affiche v1.3.0-alpha.10 Pack de remise export signé + revue du registre, et les métadonnées internes de preuve annoncent 1.3.0-alpha.10.',
  ...
  Object.assign(COPY.en, {
    alphaBadge:'v1.3.0-alpha.10 Brief Publication Pack v4 · Publication Pack',
  ...
  Object.assign(COPY.ar, {
    alphaBadge:'v1.3.0-alpha.10 قائمة إغلاق فجوات المصدر إلى الادعاء',
  ...
  Object.assign(COPY.fr, {
    alphaBadge:'v1.3.0-alpha.10 File de clôture des écarts source-affirmation',
  ...
  Object.assign(COPY.en, {
    hostedDemoVerificationBody:'Brief Publication Pack v4 is ready for release evidence: final brief, evidence appendix, contradiction/falsifier appendix, source-gap appendix, and operator signoff/lock-ledger appendix are consolidated into one local publication handoff. Hosted evidence must report 1.3.0-alpha.10 internally while showing v1.3.0-alpha.10 Brief Publication Pack v4 to users. No live scraping, real OAuth, backend expansion, live provider execution, automatic signoff, automatic export lock, cryptographic signature claim, publishing permission claim, or automatic source verification is enabled.',
    analysisReleaseNote:'1.3.0-alpha.10 adds Brief Publication Pack v4: a final brief plus evidence, contradiction/falsifier, source-gap, and operator signoff/lock-ledger appendices are packaged for manual publication review while live/provider/OAuth/backend/storage boundaries remain unchanged.'
  });
  Object.assign(COPY.ar, {
    hostedDemoVerificationBody:'حزمة النشر v4 جاهزة لأدلة الإصدار: يتم تجميع المسودة النهائية وملحق الأدلة وملحق التناقضات/شروط الإبطال وملحق فجوات المصادر وملحق توقيع المشغل وسجل القفل في تسليم محلي واحد. يجب أن تعلن أدلة الاستضافة داخلياً 1.3.0-alpha.10 مع عرض v1.3.0-alpha.10 حزمة النشر v4 للمستخدمين. لا يوجد scraping أو OAuth حقيقي أو توسيع خلفية أو تنفيذ مزود حي أو توقيع تلقائي أو قفل تصدير تلقائي أو توقيع تشفيري أو ادعاء إذن نشر أو تحقق آلي من المصادر.',
    analysisReleaseNote:'تضيف 1.3.0-alpha.10 حزمة النشر v4: مسودة نهائية مع ملاحق الأدلة والتناقضات/الإبطال وفجوات المصادر وتوقيع المشغل/سجل القفل للمراجعة اليدوية قبل النشر مع بقاء حدود التنفيذ الحي والمزود وOAuth والخلفية والتخزين دون تغيير.'
  });
  Object.assign(COPY.fr, {
    hostedDemoVerificationBody:'Le Brief Publication Pack v4 est prêt pour les preuves de release : brief final, annexe des preuves, annexe contradictions/falsificateurs, annexe des écarts de sources et annexe visa opérateur/registre de verrouillage sont consolidés en une remise locale. Les preuves hébergées doivent annoncer 1.3.0-alpha.10 en interne tout en affichant v1.3.0-alpha.10 Brief Publication Pack v4 aux utilisateurs. Aucun scraping, OAuth réel, extension backend, fournisseur live, visa automatique, verrouillage automatique, signature cryptographique, permission de publication revendiquée ni vérification automatique des sources n’est activé.',
    analysisReleaseNote:'1.3.0-alpha.10 ajoute Brief Publication Pack v4 : brief final et annexes preuves, contradictions/falsificateurs, écarts de sources et visa opérateur/registre de verrouillage pour revue manuelle avant publication, sans changer les limites live/fournisseur/OAuth/backend/stockage.'
  });


  Object.assign(COPY.en, {
    briefPublicationPackTitle:'Brief Publication Pack v4',
    publicationPackStatus:'publication status',
    publicationReady:'publication ready',
    briefPublicationPackBoundary:'Brief Publication Pack v4 is local/manual. It consolidates the final brief and appendices without publishing, fetching, verifying, or signing cryptographically.'
  });
  Object.assign(COPY.ar, {
  ...
  Object.assign(COPY.fr, {
    ...
    briefPublicationPackBoundary:'Brief Publication Pack v4 est local/manuel. Il consolide le brief final et les annexes sans publication, récupération, vérification ni signature cryptographique.'
  });
