/* Jarbou3i Research Engine render helpers v1.0.9. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.9 · Hosted Demo Smoke Fixes + Evidence Review',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.9 · إصلاح فحص العرض المستضاف ومراجعة الأدلة' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.9 · Corrections de démo hébergée et revue des preuves',
