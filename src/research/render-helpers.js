/* Jarbou3i Research Engine render helpers v1.0.19. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.19 · Source Packet Templates',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.19 · قوالب حزمة المصادر' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.19 · Modèles de paquet source',
