/* Jarbou3i Research Engine render helpers v1.0.8. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.8 · Hosted Demo Deployment Verification + Browser Evidence Capture',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.8 · جاهزية العرض العام وملاحظات الإصدار' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.8 · Démo publique et notes de publication',
