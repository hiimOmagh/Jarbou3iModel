/* Jarbou3i Research Engine render helpers v1.0.7. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.7 · Public Demo Readiness + Release Notes Polish',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.7 · جاهزية العرض العام وملاحظات الإصدار' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.7 · Démo publique et notes de publication',
