/* Jarbou3i Research Engine render helpers v1.0.25. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.25 · Public Demo Release Lock',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.25 · قفل إصدار العرض العام' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.25 · Verrou de démo publique',
