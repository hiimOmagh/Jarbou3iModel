/* Jarbou3i Research Engine render helpers v1.1.0-alpha.1. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.1.0-alpha.1 · Post-Freeze Product Expansion Planning Gate',
    ...
    ar: {
      ...
      alphaBadge:'v1.1.0-alpha.1 · بوابة تخطيط ما بعد التجميد' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.1.0-alpha.1 · Portail de planification post-gel',
