/* Jarbou3i Research Engine render helpers v1.1.0-alpha.9. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.1.0-alpha.9 · Test Matrix Runtime Optimization + Release Doc Timeline Pruning',
    ...
    ar: {
      ...
      alphaBadge:'v1.1.0-alpha.9 · بوابة تخطيط ما بعد التجميد' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.1.0-alpha.9 · Portail de planification post-gel',
