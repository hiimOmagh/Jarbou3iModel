/* Jarbou3i Research Engine render helpers v1.1.0-alpha.7. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.1.0-alpha.7 · Package Script Compression + CI Gate Registry',
    ...
    ar: {
      ...
      alphaBadge:'v1.1.0-alpha.7 · بوابة تخطيط ما بعد التجميد' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.1.0-alpha.7 · Portail de planification post-gel',
