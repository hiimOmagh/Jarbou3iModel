/* v1.4.0-alpha.6 · Provider Execution Harness Mock-to-Live Equivalence. Planning/preflight only; no live execution. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.4.0-alpha.6 Provider Execution Harness Mock-to-Live Equivalence · Planning/Preflight Only',
  ...
  Object.assign(COPY.en, {
    ...
    hostedDemoVerificationBody:'Provider Execution Harness Mock-to-Live Equivalence is ready for release evidence: the public copy is stable, the golden workflow and Export Pack v3 remain locked, and hosted evidence must report 1.4.0-alpha.6 internally while showing v1.4.0-alpha.6 Provider Execution Harness Mock-to-Live Equivalence to users. No live scraping, real OAuth, backend expansion, live provider execution, or automatic source verification is enabled.',
  ...
  Object.assign(COPY.en, {
    hostedDemoVerificationBody:'Provider Execution Harness Mock-to-Live Equivalence is ready for release evidence: final brief, evidence appendix, contradiction/falsifier appendix, source-gap appendix, and operator signoff/lock-ledger appendix are consolidated into one local publication handoff. Hosted evidence must report 1.4.0-alpha.6 internally while showing v1.4.0-alpha.6 Provider Execution Harness Mock-to-Live Equivalence to users. No live scraping, real OAuth, backend expansion, live provider execution, automatic signoff, automatic export lock, cryptographic signature claim, publishing permission claim, or automatic source verification is enabled.',
