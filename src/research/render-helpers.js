/* Jarbou3i Research Engine render helpers v1.1.0-alpha.23. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.1.0-alpha.23 · Publication Review Gate + Claim Boundary Audit',
    ...
    ar: {
      ...
      alphaBadge:'v1.1.0-alpha.23 · بوابة مراجعة النشر وتدقيق حدود الادعاءات' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.1.0-alpha.23 · Revue publication + audit des limites de revendication',
  ...
  Object.assign(COPY.en, {
    ...
    hostedDemoVerificationBody:'Planning gate only: no live search, no scraping, no real OAuth, no automatic provider execution, and no automated source verification are enabled. v1.1.0-alpha.23 adds a Publication Review Gate with observation/inference/estimate claim classification, claim-boundary audit, unsupported-conclusion detection, contradiction/falsifier completeness checks, blocker reasons, and visible traceability warnings.',
    ...
    evidenceReviewGateBody:'v1.1.0-alpha.23 preserves the public-demo freeze while adding claim-boundary audit before export, unsupported-conclusion detection, contradiction/falsifier completeness checks, export-safe final review reporting, and visible traceability warnings in quality/export. Evidence Review Queue and privacy guards remain required.',
  ...
  Object.assign(COPY.ar, {
    ...
    hostedDemoVerificationBody:'بوابة تخطيط فقط: لا يوجد بحث حي أو scraping أو OAuth حقيقي أو تنفيذ مزود تلقائي أو تحقق آلي من المصادر. تضيف v1.1.0-alpha.23 بوابة مراجعة النشر مع تصنيف الادعاءات إلى ملاحظة/استنتاج/تقدير، تدقيق حدود الادعاءات، كشف الخلاصات غير المدعومة، وفحص اكتمال التناقضات وشروط الإبطال.',
    ...
    evidenceReviewGateBody:'تحافظ v1.1.0-alpha.23 على تجميد العرض العام وتضيف تدقيق حدود الادعاءات قبل التصدير، كشف الاستنتاجات غير المدعومة، فحص اكتمال التناقضات وشروط الإبطال، وتقرير مراجعة نهائي آمن للتصدير. تبقى مراجعة الأدلة وحراس الخصوصية مطلوبة.',
  ...
  Object.assign(COPY.fr, {
    ...
    hostedDemoVerificationBody:'Porte de planification uniquement: aucune recherche live, aucun scraping, aucun OAuth réel, aucune exécution fournisseur automatique et aucune vérification automatique des sources. v1.1.0-alpha.23 ajoute une revue de publication avec classification observation/inférence/estimation, audit des limites de revendication, détection des conclusions non appuyées et contrôle contradictions/falsificateurs.',
    ...
    evidenceReviewGateBody:'v1.1.0-alpha.23 préserve le gel de la démo publique tout en ajoutant audit des limites de revendication avant export, détection des conclusions non appuyées, contrôle contradictions/falsificateurs, rapport final sûr pour export et avertissements de traçabilité visibles. La revue des preuves et les garde-fous de confidentialité restent requis.',
  ...
  Object.assign(COPY.en, {
    analysisReleaseNote:'v1.1.0-alpha.23 adds Publication Review Gate and claim boundary audit: paragraph-to-evidence ID mapping, Export Pack v3 manifest, source/evidence/entity/cluster/graph bundle consistency, contradiction/falsifier appendix, and publication-readiness export report without scraping, provider execution, OAuth/backend, or source verification claims.',
  ...
  Object.assign(COPY.ar, {
    analysisReleaseNote:'تضيف v1.1.0-alpha.23 بوابة مراجعة النشر وتدقيق حدود الادعاءات: تصنيف الملاحظة/الاستنتاج/التقدير، كشف الخلاصات غير المدعومة، فحص التناقضات وشروط الإبطال، أسباب الحجب، وتقرير مراجعة نهائي آمن للتصدير دون scraping أو تنفيذ مزود أو OAuth/backend.',
  ...
  Object.assign(COPY.fr, {
    analysisReleaseNote:'v1.1.0-alpha.23 ajoute Revue publication + audit des limites de revendication: classification observation/inférence/estimation, conclusions non appuyées, contrôle contradictions/falsificateurs, raisons de blocage et rapport final sûr pour export sans scraping, exécution fournisseur ni OAuth/backend.',
