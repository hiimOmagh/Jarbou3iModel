/* Jarbou3i Research Engine render helpers v1.0.29. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.29 · Final Public Demo Hardening / Release Freeze Audit',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.29 · بيان أدلة العرض' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.29 · Manifeste de preuves',
