...
(function(global){
  ...
  Object.assign(COPY.en, {
    ...
    statusLabels:{review_required:'review required', template_presets_ready:'template presets ready', draft_only:'draft only', blocked:'blocked', pass:'pass', publication_candidate:'publication candidate', research_ready:'research ready', reviewable_draft:'reviewable draft', synthesis_ready:'synthesis ready', provider_ready:'provider ready', empty:'empty', review_resolved:'review resolved', high:'high', medium:'medium', low:'low'},
