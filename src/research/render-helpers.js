/* Jarbou3i Research Engine render helpers v1.0.10. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.10 · Hosted URL CI Artifact Review + Module-Type Warning Fix',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.10 · إصلاح فحص العرض المستضاف ومراجعة الأدلة' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.10 · Corrections de démo hébergée et revue des preuves',
