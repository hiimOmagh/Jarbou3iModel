...
(function(global){
  ...
  Object.assign(COPY.ar, {
    ...
    hostedDemoVerificationBody:'قائمة جاهزية تسليم الأدلة جاهز لأدلة الإصدار: يفحص جاهزية تسليم سجل القرارات، يراجع هوية حزمة القفل، يؤكد حدود السلوك، ويحافظ على قرار المشغّل اليدوي دون توسيع سطح المتصفح. يجب أن تعلن أدلة الاستضافة داخلياً 1.4.0-alpha.21 مع عرض v1.4.0-alpha.21 قائمة جاهزية تسليم الأدلة · مراجعة المشغّل للمستخدمين. طبقة تدقيق تسليم فقط: دون نداءات مزوّد حية، دون نداءات شبكة مخفية، دون OAuth/دورة رموز حقيقية، دون تخزين بيانات اعتماد، دون جلب مصادر حي، ودون تحقق أو توقيع أو قفل أو نشر آلي.',
