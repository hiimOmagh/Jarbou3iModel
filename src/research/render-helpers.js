/* v1.4.0-alpha.17 · Evidence Budget Regression Dashboard. Runtime-budget guard only; disabled by default. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.4.0-alpha.17 Evidence Budget Regression Dashboard · Runtime-Budget Guard Only',
    ...
    ar: {
      ...
      alphaBadge:'v1.4.0-alpha.17 ضغط تجربة محوّل المزوّد اليدوي · حارس ميزانية وقت التشغيل فقط' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.4.0-alpha.17 Compression UX de l’adaptateur fournisseur manuel · Garde budget runtime uniquement',
  ...
  Object.assign(COPY.en, {
    ...
    hostedDemoVerificationBody:'Evidence Budget Regression Dashboard is ready for release evidence: it compresses adapter replay evidence review, preserves coverage signals, and keeps browser evidence within a bounded runtime surface. Hosted evidence must report 1.4.0-alpha.17 internally while showing v1.4.0-alpha.17 Evidence Budget Regression Dashboard to users. UX/runtime-budget guard only: no live provider calls, hidden network requests, OAuth/token lifecycle, credential persistence, live source fetching, automatic verification, signoff, export lock, cryptographic signature claim, or publication permission is enabled.',
  ...
  Object.assign(COPY.en, {
    analysisReleaseNote:'1.4.0-alpha.17 compresses manual provider adapter evidence review, preserves alpha.14 coverage signals, and adds a bounded evidence/runtime budget guard without network calls.',
  ...
  Object.assign(COPY.ar, {
    analysisReleaseNote:'يضغط 1.4.0-alpha.17 مراجعة أدلة محوّل المزوّد اليدوي، ويحافظ على إشارات تغطية alpha.14، ويضيف حارس ميزانية أدلة/وقت تشغيل محدوداً دون نداءات شبكة.',
  ...
  Object.assign(COPY.fr, {
    analysisReleaseNote:'1.4.0-alpha.17 compresse la revue des preuves d’adaptateur fournisseur manuel, préserve les signaux de couverture alpha.14 et ajoute un garde budget preuves/runtime borné sans appels réseau.',
  ...
  Object.assign(COPY.en, {
    adapterContractTestBenchTitle:'Evidence Budget Regression Dashboard',
...
/* v1.4.0-alpha.17 · Evidence Budget Regression Dashboard */
