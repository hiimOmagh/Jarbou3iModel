/* v1.3.0-alpha.9 · Source-to-Claim Gap Closure Queue; public surface displays v1.3.0-alpha.9 Source-to-Claim Gap Closure Queue.  Jarbou3i Research Engine render helpers v1.1.0. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.3.0-alpha.9 Source-to-Claim Gap Closure Queue · Signed Handoff + Lock Review',
    ...
    ar: {
      ...
      alphaBadge:'v1.3.0-alpha.9 حزمة تسليم التصدير المعتمدة + مراجعة سجل القفل' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.3.0-alpha.9 Pack de remise export signé + revue du registre',
  ...
  Object.assign(COPY.en, {
    ...
    hostedDemoVerificationBody:'Source-to-Claim Gap Closure Queue is ready for release evidence: the public copy is stable, the golden workflow and Export Pack v3 remain locked, and hosted evidence must report 1.3.0-alpha.9 internally while showing v1.3.0-alpha.9 Source-to-Claim Gap Closure Queue to users. No live scraping, real OAuth, backend expansion, live provider execution, or automatic source verification is enabled.',
  ...
  Object.assign(COPY.ar, {
    ...
    hostedDemoVerificationBody:'العرض العام المستقر جاهز لأدلة الإصدار: النسخة العامة مستقرة، المجموعة الذهبية وExport Pack v3 مقفولان، ويجب أن تعلن أدلة الاستضافة داخليًا 1.3.0-alpha.9 مع عرض v1.3.0-alpha.9 حزمة تسليم التصدير المعتمدة + مراجعة سجل القفل للمستخدمين. لا يوجد scraping أو OAuth حقيقي أو توسيع خلفية أو تنفيذ مزود حي أو ادعاء تحقق آلي من المصادر.',
  ...
  Object.assign(COPY.fr, {
    ...
    hostedDemoVerificationBody:'La démo publique stable est prête pour les preuves de release : la copie publique est stable, le golden workflow et Export Pack v3 restent verrouillés, et les preuves hébergées doivent annoncer 1.3.0-alpha.9 en interne tout en affichant v1.3.0-alpha.9 Pack de remise export signé + revue du registre aux utilisateurs. Aucun scraping, OAuth réel, extension backend, fournisseur live ni vérification automatique des sources.',
  ...
  Object.assign(COPY.en, {
    analysisReleaseNote:'1.3.0-alpha.9 corrects stable public localization: English, Arabic, and French release copy are language-pure, public copy shows v1.3.0-alpha.9 Source-to-Claim Gap Closure Queue, and internal evidence metadata reports 1.3.0-alpha.9.',
  ...
  Object.assign(COPY.ar, {
    analysisReleaseNote:'تصحح 1.3.0-alpha.9 ترجمة السطح العام المستقر: نسخة الإنجليزية والعربية والفرنسية صارت نقية لغويًا، النسخة العامة تعرض v1.3.0-alpha.9 حزمة تسليم التصدير المعتمدة + مراجعة سجل القفل، وبيانات أدلة الاستضافة الداخلية تعلن 1.3.0-alpha.9.',
  ...
  Object.assign(COPY.fr, {
    analysisReleaseNote:'1.3.0-alpha.9 corrige la localisation publique stable : les copies anglaise, arabe et française restent dans leur langue, la surface publique affiche v1.3.0-alpha.9 Pack de remise export signé + revue du registre, et les métadonnées internes de preuve annoncent 1.3.0-alpha.9.',
  ...
  Object.assign(COPY.en, {
    alphaBadge:'v1.3.0-alpha.9 Source-to-Claim Gap Closure Queue · Gap Closure',
  ...
  Object.assign(COPY.ar, {
    alphaBadge:'v1.3.0-alpha.9 قائمة إغلاق فجوات المصدر إلى الادعاء',
  ...
  Object.assign(COPY.fr, {
    alphaBadge:'v1.3.0-alpha.9 File de clôture des écarts source-affirmation',
  ...
  Object.assign(COPY.en, {
    hostedDemoVerificationBody:'Source-to-Claim Gap Closure Queue is ready for release evidence: unresolved claim/evidence gaps, weak linkage, contradiction gaps, counter-evidence target gaps, and falsifier gaps are exposed before export. Hosted evidence must report 1.3.0-alpha.9 internally while showing v1.3.0-alpha.9 Source-to-Claim Gap Closure Queue to users. No live scraping, real OAuth, backend expansion, live provider execution, automatic signoff, automatic export lock, cryptographic signature claim, or automatic source verification is enabled.',
    analysisReleaseNote:'1.3.0-alpha.9 adds the Source-to-Claim Gap Closure Queue: claims missing evidence, weak evidence links, unresolved contradictions, counter-evidence target gaps, and scenario falsifier gaps are surfaced before export while live/provider/OAuth/backend/storage boundaries remain unchanged.'
  });
  Object.assign(COPY.ar, {
    hostedDemoVerificationBody:'قائمة إغلاق فجوات المصدر إلى الادعاء جاهزة لأدلة الإصدار: يتم عرض فجوات الادعاءات والأدلة، وضعف الربط، والتناقضات غير المحسومة، وفجوات الأدلة المضادة، وشروط الإبطال قبل التصدير. يجب أن تعلن أدلة الاستضافة داخلياً 1.3.0-alpha.9 مع عرض v1.3.0-alpha.9 قائمة إغلاق فجوات المصدر إلى الادعاء للمستخدمين. لا يوجد scraping أو OAuth حقيقي أو توسيع خلفية أو تنفيذ مزود حي أو توقيع تلقائي أو قفل تصدير تلقائي أو توقيع تشفيري أو تحقق آلي من المصادر.',
    analysisReleaseNote:'تضيف 1.3.0-alpha.9 قائمة إغلاق فجوات المصدر إلى الادعاء: يتم عرض الادعاءات بلا أدلة، وضعف روابط الأدلة، والتناقضات غير المحسومة، وفجوات الأدلة المضادة، وشروط الإبطال قبل التصدير مع بقاء حدود التنفيذ الحي والمزود وOAuth والخلفية والتخزين دون تغيير.'
  });
  Object.assign(COPY.fr, {
    hostedDemoVerificationBody:'La file de clôture des écarts source-affirmation est prête pour les preuves de release : les écarts entre énoncés et preuves, liens faibles, contradictions non résolues, cibles de contre-preuve et falsificateurs manquants sont exposés avant export. Les preuves hébergées doivent annoncer 1.3.0-alpha.9 en interne tout en affichant v1.3.0-alpha.9 File de clôture des écarts source-affirmation aux utilisateurs. Aucun scraping, OAuth réel, extension backend, fournisseur live, visa automatique, verrouillage automatique, signature cryptographique ni vérification automatique des sources n’est activé.',
    analysisReleaseNote:'1.3.0-alpha.9 ajoute la file de clôture des écarts source-affirmation : preuves manquantes, liens faibles, contradictions non résolues, cibles de contre-preuve et falsificateurs absents sont exposés avant export, sans changer les limites live/fournisseur/OAuth/backend/stockage.'
  });
