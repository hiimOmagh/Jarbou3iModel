/* v1.4.0-alpha.25 · Release System Consolidation + Effective Diff Guard. Runtime-budget guard only; disabled by default. */
...
(function(global){
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.4.0-alpha.25 Release System Consolidation + Effective Diff Guard · Runtime-Budget Guard Only',
    ...
    ar: {
      ...
      alphaBadge:'v1.4.0-alpha.25 توحيد نظام الإصدار وحارس الفرق الفعلي · مراجعة المشغّل' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.4.0-alpha.25 Consolidation du système de release + garde de diff effectif · revue opérateur',
  ...
  Object.assign(COPY.en, {
    ...
    hostedDemoVerificationBody:'Release System Consolidation + Effective Diff Guard is ready for release evidence: it turns handoff productivity evidence into a deterministic operator runbook for lock review, budget pressure, blocker repair, and missing-evidence capture without expanding browser scope. Hosted evidence must report 1.4.0-alpha.25 internally while showing v1.4.0-alpha.25 Release System Consolidation + Effective Diff Guard to users. Runbook gate layer only: no live provider calls, hidden network requests, OAuth/token lifecycle, credential persistence, live source fetching, automatic verification, signoff, export lock, cryptographic signature claim, or publication permission is enabled.',
  ...
  Object.assign(COPY.ar, {
    ...
    hostedDemoVerificationBody:'توحيد نظام الإصدار وحارس الفرق الفعلي جاهز لأدلة الإصدار: يتحقق من حزمة الملفات المعدلة، يرفض التصحيحات بلا أثر، يطلب سكربت تنظيف ذاتي الحذف، ويمنع بقايا اختبارات قديمة دون توسيع سطح المتصفح. يرتب خطوات دليل تشغيل القفل، يراجع هوية حزمة القفل، ويؤكد حدود المشغّل. يجب أن تعلن أدلة الاستضافة داخلياً 1.4.0-alpha.25 مع عرض v1.4.0-alpha.25 توحيد نظام الإصدار وحارس الفرق الفعلي · مراجعة المشغّل للمستخدمين. طبقة توحيد فقط: دون نداءات مزوّد حية، دون نداءات شبكة مخفية، دون OAuth/دورة رموز حقيقية، دون تخزين بيانات اعتماد، دون جلب مصادر حي، ودون تحقق أو توقيع أو قفل أو نشر آلي.',
  ...
  Object.assign(COPY.en, {
    analysisReleaseNote:'1.4.0-alpha.25 converts evidence-budget regression results into pass, warn, fail, and review-required operator actions without network calls.',
  ...
  Object.assign(COPY.ar, {
    analysisReleaseNote:'يحوّل 1.4.0-alpha.25 نتائج انحدار ميزانية الأدلة إلى نجاح وتحذير وفشل ومراجعة مطلوبة مع إجراءات المشغّل دون نداءات شبكة.',
  ...
  Object.assign(COPY.fr, {
    analysisReleaseNote:'1.4.0-alpha.25 convertit les résultats de régression du budget preuves en actions opérateur pass, warn, fail et revue requise sans appels réseau.',
