/* v1.4.0-alpha.26 · Adapter Replay Insight UX + Operator Decision Surface. Runtime-budget guard only; disabled by default. */
...
(function(global){
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.4.0-alpha.26 Adapter Replay Insight UX + Operator Decision Surface · Runtime-Budget Guard Only',
    ...
    ar: {
      ...
      alphaBadge:'v1.4.0-alpha.26 رؤى إعادة تشغيل المحوّل وسطح قرار المشغّل · مراجعة المشغّل' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.4.0-alpha.26 Insights de rejeu adaptateur + surface de décision opérateur · revue opérateur',
  ...
  Object.assign(COPY.en, {
    analysisReleaseNote:'1.4.0-alpha.26 converts evidence-budget regression results into pass, warn, fail, and review-required operator actions without network calls.',
  ...
  Object.assign(COPY.ar, {
    analysisReleaseNote:'يحوّل 1.4.0-alpha.26 نتائج انحدار ميزانية الأدلة إلى نجاح وتحذير وفشل ومراجعة مطلوبة مع إجراءات المشغّل دون نداءات شبكة.',
  ...
  Object.assign(COPY.fr, {
    analysisReleaseNote:'1.4.0-alpha.26 convertit les résultats de régression du budget preuves en actions opérateur pass, warn, fail et revue requise sans appels réseau.',
  ...
  Object.assign(COPY.en, {
    adapterContractTestBenchTitle:'Adapter Replay Insight UX + Operator Decision Surface',
