/* Jarbou3i Research Engine render helpers v1.1.0-alpha.24. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.1.0-alpha.24 · Golden Workflow Corpus + End-to-End Demo Run',
    ...
    ar: {
      ...
      alphaBadge:'v1.1.0-alpha.24 · مجموعة العمل الذهبية وتشغيل العرض الكامل' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.1.0-alpha.24 · Corpus doré + démo de bout en bout',
  ...
  Object.assign(COPY.en, {
    ...
    hostedDemoVerificationBody:'Planning gate only: no live search, no scraping, no real OAuth, no automatic provider execution, and no automated source verification are enabled. v1.1.0-alpha.24 adds a deterministic golden workflow corpus, end-to-end demo run, Export Pack v3 golden validation, hosted-demo scenario evidence, and release-readiness runbook without adding a new live feature surface.',
    ...
    evidenceReviewGateBody:'v1.1.0-alpha.24 preserves the public-demo freeze while adding a curated golden demo project, source/evidence/entity/cluster/graph/brief fixture, end-to-end verification, Export Pack v3 golden validation, hosted-demo scenario evidence, and release-readiness runbook. Evidence Review Queue and privacy guards remain required.',
  ...
  Object.assign(COPY.ar, {
    ...
    hostedDemoVerificationBody:'بوابة تخطيط فقط: لا يوجد بحث حي أو scraping أو OAuth حقيقي أو تنفيذ مزود تلقائي أو تحقق آلي من المصادر. تضيف v1.1.0-alpha.24 مجموعة عمل ذهبية حتمية، تشغيل عرض كامل، تحقق Export Pack v3، دليل سيناريو العرض المستضاف، وrunbook جاهزية الإصدار دون إضافة سطح ميزة حي جديد.',
    ...
    evidenceReviewGateBody:'تحافظ v1.1.0-alpha.24 على تجميد العرض العام وتضيف مشروع عرض ذهبيًا، fixture للمصدر/الدليل/الكيان/العنقود/الرسم/الموجز، تحققًا end-to-end، تحقق Export Pack v3، ودليل جاهزية الإصدار. تبقى مراجعة الأدلة وحراس الخصوصية مطلوبة.',
  ...
  Object.assign(COPY.fr, {
    ...
    hostedDemoVerificationBody:'Porte de planification uniquement: aucune recherche live, aucun scraping, aucun OAuth réel, aucune exécution fournisseur automatique et aucune vérification automatique des sources. v1.1.0-alpha.24 ajoute un corpus doré déterministe, une démo de bout en bout, une validation Export Pack v3, des preuves de scénario hébergé et un runbook de préparation release.',
    ...
    evidenceReviewGateBody:'v1.1.0-alpha.24 préserve le gel de la démo publique tout en ajoutant projet démo doré, fixture sources/preuves/entités/clusters/graphe/brief, vérification de bout en bout, validation Export Pack v3 et runbook release. La revue des preuves et les garde-fous de confidentialité restent requis.',
  ...
  Object.assign(COPY.en, {
    analysisReleaseNote:'v1.1.0-alpha.24 adds Golden Workflow Corpus + End-to-End Demo Run: deterministic source/evidence/entity/cluster/graph/brief fixture, end-to-end workflow verification, Export Pack v3 golden validation, hosted-demo scenario evidence, and release-readiness runbook without live connectors, provider execution, OAuth/backend, or source verification claims.',
  ...
  Object.assign(COPY.ar, {
    analysisReleaseNote:'تضيف v1.1.0-alpha.24 مجموعة العمل الذهبية وتشغيل العرض الكامل: fixture حتمي للمصدر/الدليل/الكيان/العنقود/الرسم/الموجز، تحقق end-to-end، تحقق Export Pack v3، دليل سيناريو مستضاف، وrunbook جاهزية الإصدار دون scraping أو تنفيذ مزود أو OAuth/backend.',
  ...
  Object.assign(COPY.fr, {
    analysisReleaseNote:'v1.1.0-alpha.24 ajoute Corpus doré + démo de bout en bout: fixture déterministe sources/preuves/entités/clusters/graphe/brief, vérification end-to-end, validation Export Pack v3, scénario hébergé et runbook release sans scraping, exécution fournisseur ni OAuth/backend.',
