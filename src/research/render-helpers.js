/* Jarbou3i Research Engine render helpers v1.1.0-alpha.2. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.1.0-alpha.2 · Expansion Lane Acceptance Criteria Matrix',
    ...
    ar: {
      ...
      alphaBadge:'v1.1.0-alpha.2 · بوابة تخطيط ما بعد التجميد' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.1.0-alpha.2 · Portail de planification post-gel',
