/* Jarbou3i Research Engine render helpers v1.0.27. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.27 · Release Provenance Ledger Gate',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.27 · قفل سلامة التطبيق' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.27 · Verrou d’application',
