...
(function(global){
  ...
  Object.assign(COPY.en, {
    ...
    statusLabels:{review_required:'review required', draft_only:'draft only', blocked:'blocked', pass:'pass', publication_candidate:'publication candidate', research_ready:'research ready', reviewable_draft:'reviewable draft', synthesis_ready:'synthesis ready', provider_ready:'provider ready', empty:'empty', review_resolved:'review resolved', high:'high', medium:'medium', low:'low'},
  ...
  Object.assign(COPY.ar, {
    ...
    statusLabels:{review_required:'تحتاج مراجعة', draft_only:'مسودة فقط', blocked:'محظور', pass:'ناجح', publication_candidate:'مرشح للنشر', research_ready:'جاهز بحثيًا', reviewable_draft:'مسودة قابلة للمراجعة', synthesis_ready:'جاهز للتوليف', provider_ready:'المزوّد جاهز', empty:'فارغ', review_resolved:'المراجعة محلولة', high:'عالٍ', medium:'متوسط', low:'منخفض'},
