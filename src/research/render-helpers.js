/* Jarbou3i Research Engine render helpers v1.1.0-alpha.5. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.1.0-alpha.5 · Version Suite Registry + Package Script Compression',
    ...
    ar: {
      ...
      alphaBadge:'v1.1.0-alpha.5 · بوابة تخطيط ما بعد التجميد' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.1.0-alpha.5 · Portail de planification post-gel',
