/* Jarbou3i Research Engine render helpers v1.0.18. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.18 · Source Packet Builder QA',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.18 · منشئ حزمة المصادر' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.18 · Constructeur de paquet source',
