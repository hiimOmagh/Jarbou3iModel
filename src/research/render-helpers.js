/* Jarbou3i Research Engine render helpers v1.1.0-alpha.3. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.1.0-alpha.3 · Repository Consolidation Audit + Retention Registry',
    ...
    ar: {
      ...
      alphaBadge:'v1.1.0-alpha.3 · بوابة تخطيط ما بعد التجميد' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.1.0-alpha.3 · Portail de planification post-gel',
