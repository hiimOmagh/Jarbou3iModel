/* Jarbou3i Research Engine render helpers v1.1.0-alpha.6. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.1.0-alpha.6 · Root Manifest + Release Artifact Consolidation',
    ...
    ar: {
      ...
      alphaBadge:'v1.1.0-alpha.6 · بوابة تخطيط ما بعد التجميد' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.1.0-alpha.6 · Portail de planification post-gel',
