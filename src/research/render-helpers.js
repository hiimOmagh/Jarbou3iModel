/* Jarbou3i Research Engine render helpers v1.0.30. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.30 · Mobile Header Geometry Lock / Final Public Demo Visual Freeze',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.30 · بيان أدلة العرض' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.30 · Manifeste de preuves',
