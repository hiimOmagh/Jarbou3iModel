/* Jarbou3i Research Engine render helpers v1.0.11. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.11 · Repository Hygiene + Stale Artifact Cleanup',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.11 · تنظيف المستودع وإزالة الآثار القديمة' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.11 · Hygiène du dépôt et nettoyage des artefacts obsolètes',
