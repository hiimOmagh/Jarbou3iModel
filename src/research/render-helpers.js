/* v1.3.0-alpha.6 · Operator Signoff State + Export Lock Ledger; public surface displays v1.3.0-alpha.6 Operator Signoff State + Export Lock Ledger.  Jarbou3i Research Engine render helpers v1.1.0. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.3.0-alpha.6 Operator Signoff State + Export Lock Ledger · Guided Session + Brief Assembly',
    ...
    ar: {
      ...
      alphaBadge:'v1.3.0-alpha.6 حالة اعتماد المشغّل + سجل قفل التصدير' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.3.0-alpha.6 État de visa opérateur + registre de verrouillage export',
  ...
  Object.assign(COPY.en, {
    ...
    hostedDemoVerificationBody:'Operator Signoff State + Export Lock Ledger is ready for release evidence: the public copy is stable, the golden workflow and Export Pack v3 remain locked, and hosted evidence must report 1.3.0-alpha.6 internally while showing v1.3.0-alpha.6 Operator Signoff State + Export Lock Ledger to users. No live scraping, real OAuth, backend expansion, live provider execution, or automatic source verification is enabled.',
  ...
  Object.assign(COPY.ar, {
    ...
    hostedDemoVerificationBody:'العرض العام المستقر جاهز لأدلة الإصدار: النسخة العامة مستقرة، المجموعة الذهبية وExport Pack v3 مقفولان، ويجب أن تعلن أدلة الاستضافة داخليًا 1.3.0-alpha.6 مع عرض v1.3.0-alpha.6 حالة اعتماد المشغّل + سجل قفل التصدير للمستخدمين. لا يوجد scraping أو OAuth حقيقي أو توسيع خلفية أو تنفيذ مزود حي أو ادعاء تحقق آلي من المصادر.',
  ...
  Object.assign(COPY.fr, {
    ...
    hostedDemoVerificationBody:'La démo publique stable est prête pour les preuves de release : la copie publique est stable, le golden workflow et Export Pack v3 restent verrouillés, et les preuves hébergées doivent annoncer 1.3.0-alpha.6 en interne tout en affichant v1.3.0-alpha.6 État de visa opérateur + registre de verrouillage export aux utilisateurs. Aucun scraping, OAuth réel, extension backend, fournisseur live ni vérification automatique des sources.',
  ...
  Object.assign(COPY.en, {
    analysisReleaseNote:'1.3.0-alpha.6 corrects stable public localization: English, Arabic, and French release copy are language-pure, public copy shows v1.3.0-alpha.6 Operator Signoff State + Export Lock Ledger, and internal evidence metadata reports 1.3.0-alpha.6.',
  ...
  Object.assign(COPY.ar, {
    analysisReleaseNote:'تصحح 1.3.0-alpha.6 ترجمة السطح العام المستقر: نسخة الإنجليزية والعربية والفرنسية صارت نقية لغويًا، النسخة العامة تعرض v1.3.0-alpha.6 حالة اعتماد المشغّل + سجل قفل التصدير، وبيانات أدلة الاستضافة الداخلية تعلن 1.3.0-alpha.6.',
  ...
  Object.assign(COPY.fr, {
    analysisReleaseNote:'1.3.0-alpha.6 corrige la localisation publique stable : les copies anglaise, arabe et française restent dans leur langue, la surface publique affiche v1.3.0-alpha.6 État de visa opérateur + registre de verrouillage export, et les métadonnées internes de preuve annoncent 1.3.0-alpha.6.',
  ...
  Object.assign(COPY.en, {
    alphaBadge:'v1.3.0-alpha.6 Operator Signoff State + Export Lock Ledger · Preview Diff + Export Signoff',
