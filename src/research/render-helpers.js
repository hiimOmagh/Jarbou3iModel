/* v1.3.0-alpha.2 · Guided Session UX Compression + Brief Assembly Export QA; public surface displays v1.3.0-alpha.2 Guided Session UX Compression + Brief Assembly Export QA.  Jarbou3i Research Engine render helpers v1.1.0. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.3.0-alpha.2 Guided Session UX Compression + Brief Assembly Export QA · Guided Session + Brief Assembly',
    ...
    ar: {
      ...
      alphaBadge:'v1.3.0-alpha.2 ضغط تجربة الجلسة الموجّهة + تدقيق تصدير تجميع الموجز' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.3.0-alpha.2 Compression UX de session guidée + QA export assemblage du brief',
  ...
  Object.assign(COPY.en, {
    ...
    hostedDemoVerificationBody:'Guided Session UX Compression + Brief Assembly Export QA is ready for release evidence: the public copy is stable, the golden workflow and Export Pack v3 remain locked, and hosted evidence must report 1.3.0-alpha.2 internally while showing v1.3.0-alpha.2 Guided Session UX Compression + Brief Assembly Export QA to users. No live scraping, real OAuth, backend expansion, live provider execution, or automatic source verification is enabled.',
  ...
  Object.assign(COPY.ar, {
    ...
    hostedDemoVerificationBody:'العرض العام المستقر جاهز لأدلة الإصدار: النسخة العامة مستقرة، المجموعة الذهبية وExport Pack v3 مقفولان، ويجب أن تعلن أدلة الاستضافة داخليًا 1.3.0-alpha.2 مع عرض v1.3.0-alpha.2 ضغط تجربة الجلسة الموجّهة + تدقيق تصدير تجميع الموجز للمستخدمين. لا يوجد scraping أو OAuth حقيقي أو توسيع خلفية أو تنفيذ مزود حي أو ادعاء تحقق آلي من المصادر.',
  ...
  Object.assign(COPY.fr, {
    ...
    hostedDemoVerificationBody:'La démo publique stable est prête pour les preuves de release : la copie publique est stable, le golden workflow et Export Pack v3 restent verrouillés, et les preuves hébergées doivent annoncer 1.3.0-alpha.2 en interne tout en affichant v1.3.0-alpha.2 Compression UX de session guidée + QA export assemblage du brief aux utilisateurs. Aucun scraping, OAuth réel, extension backend, fournisseur live ni vérification automatique des sources.',
  ...
  Object.assign(COPY.en, {
    analysisReleaseNote:'1.3.0-alpha.2 corrects stable public localization: English, Arabic, and French release copy are language-pure, public copy shows v1.3.0-alpha.2 Guided Session UX Compression + Brief Assembly Export QA, and internal evidence metadata reports 1.3.0-alpha.2.',
  ...
  Object.assign(COPY.ar, {
    analysisReleaseNote:'تصحح 1.3.0-alpha.2 ترجمة السطح العام المستقر: نسخة الإنجليزية والعربية والفرنسية صارت نقية لغويًا، النسخة العامة تعرض v1.3.0-alpha.2 ضغط تجربة الجلسة الموجّهة + تدقيق تصدير تجميع الموجز، وبيانات أدلة الاستضافة الداخلية تعلن 1.3.0-alpha.2.',
  ...
  Object.assign(COPY.fr, {
    analysisReleaseNote:'1.3.0-alpha.2 corrige la localisation publique stable : les copies anglaise, arabe et française restent dans leur langue, la surface publique affiche v1.3.0-alpha.2 Compression UX de session guidée + QA export assemblage du brief, et les métadonnées internes de preuve annoncent 1.3.0-alpha.2.',
