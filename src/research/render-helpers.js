/* Jarbou3i Research Engine render helpers v1.1.0-alpha.10. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.1.0-alpha.10 · Hosted Evidence Capture Polish + Visual Artifact Guard',
    ...
    ar: {
      ...
      alphaBadge:'v1.1.0-alpha.10 · بوابة تخطيط ما بعد التجميد' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.1.0-alpha.10 · Portail de planification post-gel',
