/* Jarbou3i Research Engine render helpers v1.0.12. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.12 · Research Source Strategy Blueprint',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.12 · مخطط استراتيجية مصادر البحث' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.12 · Plan stratégique des sources de recherche',
