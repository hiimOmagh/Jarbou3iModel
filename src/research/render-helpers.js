/* Jarbou3i Research Engine render helpers v1.0.21. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.21 · Source Packet Templates',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.21 · قوالب حزمة المصادر' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.21 · Modèles de paquet source',
