/* Jarbou3i Research Engine render helpers v1.0.22. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.0.22 · Source Packet Templates',
    ...
    ar: {
      ...
      alphaBadge:'v1.0.22 · قوالب حزمة المصادر' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.0.22 · Modèles de paquet source',
