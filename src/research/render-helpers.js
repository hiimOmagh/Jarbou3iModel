...
(function(global){
  ...
  Object.assign(COPY.ar, {
    ...
    hostedDemoVerificationBody:'سجل قرارات لوحة الأدلة جاهزة لأدلة الإصدار: تحوّل حالة لوحة الأدلة إلى مسارات قرار للمشغّل دون توسيع سطح المتصفح. يجب أن تعلن أدلة الاستضافة داخلياً 1.4.0-alpha.19 مع عرض v1.4.0-alpha.19 سجل قرارات لوحة الأدلة · مراجعة المشغّل للمستخدمين. طبقة سجل قرارات فقط: دون نداءات مزوّد حية، دون نداءات شبكة مخفية، دون OAuth/دورة رموز حقيقية، دون تخزين بيانات اعتماد، دون جلب مصادر حي، ودون تحقق أو توقيع أو قفل أو نشر آلي.',
