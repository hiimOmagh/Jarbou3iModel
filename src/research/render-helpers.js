/* v1.4.0-alpha.7 · Source Acquisition Control Surface. Source-mode control only; no live fetching. */
(function(global){
  'use strict';
  ...
  const COPY = {
    en: {
      ...
      alphaBadge:'v1.4.0-alpha.7 Source Acquisition Control Surface · Source-Mode Control Only',
    ...
    ar: {
      ...
      alphaBadge:'v1.4.0-alpha.7 سطح التحكم في اكتساب المصادر · تحكم بأنماط المصادر فقط' ,
      planTitle:'خطة البحث',
    ...
    fr: {
      ...
      alphaBadge:'v1.4.0-alpha.7 Surface de contrôle d’acquisition des sources · contrôle des modes source uniquement',
  ...
  Object.assign(COPY.en, {
    ...
    hostedDemoVerificationBody:'Source Acquisition Control Surface is ready for release evidence: manual/imported/fixture/provider-proposed/blocked/future-fetch source modes are classified without fetching, scraping, auto-verification, or provider-source bypass. Hosted evidence must report 1.4.0-alpha.7 internally while showing v1.4.0-alpha.7 Source Acquisition Control Surface to users. No live scraping, real OAuth, backend expansion, live provider execution, hidden background fetching, or automatic source verification is enabled.',
  ...
  Object.assign(COPY.ar, {
    ...
    hostedDemoVerificationBody:'سطح التحكم في اكتساب المصادر جاهز لأدلة الإصدار: يتم تصنيف أنماط المصدر اليدوي والمستورد والاختباري والمقترح من المزوّد والمحظور والجلب المستقبلي دون جلب أو scraping أو تحقق آلي أو تجاوز لمراجعة المصادر. يجب أن تعلن أدلة الاستضافة داخلياً 1.4.0-alpha.7 مع عرض v1.4.0-alpha.7 سطح التحكم في اكتساب المصادر · تحكم بأنماط المصادر فقط للمستخدمين. لا يوجد scraping أو OAuth حقيقي أو توسيع خلفية أو تنفيذ مزود حي أو جلب خفي في الخلفية أو تحقق آلي من المصادر.',
  ...
  Object.assign(COPY.fr, {
    ...
    hostedDemoVerificationBody:'La surface de contrôle d’acquisition des sources est prête pour les preuves de release : les modes manuel/importé/fixture/proposé par fournisseur/bloqué/futur fetch contrôlé sont classés sans récupération, scraping, vérification automatique ni contournement de revue. Les preuves hébergées doivent annoncer 1.4.0-alpha.7 en interne tout en affichant v1.4.0-alpha.7 Surface de contrôle d’acquisition des sources aux utilisateurs. Aucun scraping, OAuth réel, extension backend, fournisseur live, fetch caché ni vérification automatique des sources.',
  ...
  Object.assign(COPY.en, {
    analysisReleaseNote:'1.4.0-alpha.7 adds Source Acquisition Control Surface while preserving the locked v1.3.0 manual workflow baseline, locked v1.4.0-alpha.6 mock-to-live baseline, and all live/provider/OAuth/backend/storage boundaries.',
  ...
  Object.assign(COPY.ar, {
    analysisReleaseNote:'تضيف 1.4.0-alpha.7 سطح التحكم في اكتساب المصادر مع الحفاظ على خط العمل اليدوي المستقر v1.3.0 وخط alpha.6 لمعادلة التنفيذ وكل حدود التنفيذ الحي وOAuth والخلفية والتخزين.',
  ...
  Object.assign(COPY.fr, {
    analysisReleaseNote:'1.4.0-alpha.7 ajoute la surface de contrôle d’acquisition des sources tout en conservant le workflow manuel stable v1.3.0, la baseline alpha.6 mock-vers-live et les limites live/OAuth/backend/stockage.',
  ...
  Object.assign(COPY.en, {
    hostedDemoVerificationBody:'Source Acquisition Control Surface is ready for release evidence: source acquisition modes, review routing, provenance/risk labels, source-gap warnings, and source-to-claim linkage rules are visible without live fetching. Hosted evidence must report 1.4.0-alpha.7 internally while showing v1.4.0-alpha.7 Source Acquisition Control Surface to users. No live scraping, real OAuth, backend expansion, live provider execution, hidden background fetching, automatic signoff, automatic export lock, cryptographic signature claim, publishing permission claim, or automatic source verification is enabled.',
    analysisReleaseNote:'1.4.0-alpha.7 prepares Source Acquisition Control Surface: source candidates are classified into manual, imported, fixture, provider-proposed, blocked, or future-fetch states while review, provenance, risk, gap, and claim-linkage boundaries remain explicit.'
  });
  Object.assign(COPY.ar, {
    hostedDemoVerificationBody:'سطح التحكم في اكتساب المصادر جاهز لأدلة الإصدار: يتم تصنيف أنماط المصدر اليدوي والمستورد والاختباري والمقترح من المزوّد والمحظور والجلب المستقبلي دون جلب أو scraping أو تحقق آلي أو تجاوز لمراجعة المصادر. يجب أن تعلن أدلة الاستضافة داخلياً 1.4.0-alpha.7 مع عرض v1.4.0-alpha.7 سطح التحكم في اكتساب المصادر · تحكم بأنماط المصادر فقط للمستخدمين. لا يوجد scraping أو OAuth حقيقي أو توسيع خلفية أو تنفيذ مزود حي أو جلب خفي في الخلفية أو تحقق آلي من المصادر.',
    analysisReleaseNote:'تحضّر 1.4.0-alpha.7 سطح التحكم في اكتساب المصادر: يتم تصنيف المرشحات إلى يدوي، مستورد، اختباري، مقترح من المزوّد، محظور، أو جلب مستقبلي مع بقاء حدود المراجعة والمنشأ والمخاطر والفجوات وروابط الادعاءات واضحة.'
  });
  Object.assign(COPY.fr, {
    hostedDemoVerificationBody:'La surface de contrôle d’acquisition des sources est prête pour les preuves de release : les modes manuel/importé/fixture/proposé par fournisseur/bloqué/futur fetch contrôlé sont classés sans récupération, scraping, vérification automatique ni contournement de revue. Les preuves hébergées doivent annoncer 1.4.0-alpha.7 en interne tout en affichant v1.4.0-alpha.7 Surface de contrôle d’acquisition des sources · contrôle des modes source uniquement aux utilisateurs. Aucun scraping, OAuth réel, extension backend, fournisseur live, fetch caché ni vérification automatique des sources.',
    analysisReleaseNote:'1.4.0-alpha.7 prépare la surface de contrôle d’acquisition des sources : les candidats source sont classés en manuel, importé, fixture, proposé par fournisseur, bloqué ou futur fetch tout en conservant les limites de revue, provenance, risque, écart et lien claim.'
  });
