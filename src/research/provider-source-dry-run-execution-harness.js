/* Jarbou3i Research Engine provider/source dry-run execution harness v1.4.0-alpha.6. */
...
(function(global){
  ...
  function runDryRunHarness(opts) {
    ...
    return Object.freeze({
      ...
      boundary_statement: 'Dry-run harness executes deterministic fixtures only. v1.4.0-alpha.6 does not perform live provider execution, live source fetching, production OAuth, backend expansion, or storage expansion.'
    });
  }
