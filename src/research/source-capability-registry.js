/* Jarbou3i Research Engine source capability registry v1.1.0-alpha.13. No live source expansion. */
(function(global){
  'use strict';
  ...
  const CAPABILITIES = Object.freeze({
    ...
    manual_source_packet: {
      ...
      notes:['Available in v1.1.0-alpha.13. Imports structured user-collected source packets into the review queue. No live fetching, scraping, or verification claims.']
    },
  ...
  function strategyBlueprint({version = VERSION, now = new Date().toISOString()} = {}){
    ...
    return {
      ...
      registry:values(),
      audit,
      next_safe_increment:'v1.1.0-alpha.13 source packet builder browser QA and UX tightening',
