/* Jarbou3i Research Engine migrations v1.0.7. */
(function(global){
  'use strict';
  const root = global.Jarbou3iResearchModules = global.Jarbou3iResearchModules || {};
  const MIGRATION_VERSION = '1.0.7';
  ...
  function migrationPath(sourceVersion, targetVersion){
    ...
    const order = ['0.11.0-beta','0.12.0-beta','0.13.0-beta','0.14.0-beta','0.15.0-beta','0.16.0-beta','0.17.0-beta','0.18.0-beta','0.19.0-beta','0.20.0-beta','0.21.0-beta','0.22.0-beta','0.23.0-beta','0.24.0-beta','0.25.0-beta','0.26.0-beta','0.27.0-beta','0.28.0-beta','0.29.0-rc.1','1.0.0','1.0.1','1.0.2','1.0.3','1.0.4','1.0.5','1.0.6','1.0.7'];
  ...
  function defaultReleaseNotes(){
    return {release_notes_version:TARGET_VERSION, generated_at:nowIso(), release_title:'v1.0.7 — Public Demo Readiness + Release Notes Polish', release_type:'patch', runtime_capability_change:false, summary:'Public-demo-facing documentation, release notes, and readiness metadata were polished without enabling new live provider, OAuth, backend, or source behavior.', notable_changes:['Added a public demo checklist and operator script for first-run demonstrations.','Added release notes that clearly separate visible polish from unchanged runtime boundaries.','Added schema/fixture coverage for public demo readiness and release-note metadata.','Extended no-browser CI with a public-demo readiness gate.'], unchanged_boundaries:['Manual/private mode remains the default.','No production OAuth path is enabled.','No new live source connector is enabled.','No provider key or raw token is exported.','No backend endpoint behavior is changed.'], publish_checklist:['Run no-browser CI gates.','Run browser QA before publishing the public demo.','Verify GitHub Pages deployment uses the current package files.','Confirm release archive excludes generated and secret-bearing files.'], release_gate:'release_notes_polished'};
  }
