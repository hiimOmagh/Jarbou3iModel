/* Jarbou3i Research Engine migrations v1.0.16. */
(function(global){
  'use strict';
  const root = global.Jarbou3iResearchModules = global.Jarbou3iResearchModules || {};
  const MIGRATION_VERSION = '1.0.16';
  const TARGET_VERSION = '1.0.16';
  ...
  function defaultReleaseNotes(){
    return {release_notes_version:TARGET_VERSION, generated_at:nowIso(), release_title:'v1.0.16 — Source Packet Builder UI + Scoring Review Controls', release_type:'patch', runtime_capability_change:false, summary:'Repository hygiene and stale artifact cleanup were tightened without enabling new live provider, OAuth, backend, source, or storage behavior.', notable_changes:['Added v1.0.16 repository hygiene cleanup gates.','Repaired migration fixture coverage for the v1.0.4 source version.','Added stale artifact and release drift checks to CI.','Kept runtime behavior and public-demo boundaries unchanged.'], unchanged_boundaries:['Manual/private mode remains the default.','No production OAuth path is enabled.','No new live source connector is enabled.','No provider key or raw token is exported.','No backend endpoint behavior is changed.'], publish_checklist:['Run no-browser CI gates.','Run hosted-demo browser evidence capture before publishing.','Verify GitHub Pages deployment uses the current package files.','Confirm release archive excludes generated and secret-bearing files.'], release_gate:'release_notes_polished'};
  }
