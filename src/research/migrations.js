/* Jarbou3i Research Engine migrations v1.0.9. */
(function(global){
  'use strict';
  const root = global.Jarbou3iResearchModules = global.Jarbou3iResearchModules || {};
  const MIGRATION_VERSION = '1.0.9';
  ...
  function migrationPath(sourceVersion, targetVersion){
    ...
    const order = ['0.11.0-beta','0.12.0-beta','0.13.0-beta','0.14.0-beta','0.15.0-beta','0.16.0-beta','0.17.0-beta','0.18.0-beta','0.19.0-beta','0.20.0-beta','0.21.0-beta','0.22.0-beta','0.23.0-beta','0.24.0-beta','0.25.0-beta','0.26.0-beta','0.27.0-beta','0.28.0-beta','0.29.0-rc.1','1.0.0','1.0.1','1.0.2','1.0.3','1.0.4','1.0.5','1.0.6','1.0.7','1.0.8','1.0.9'];
  ...
  function defaultReleaseNotes(){
    return {release_notes_version:TARGET_VERSION, generated_at:nowIso(), release_title:'v1.0.9 — Hosted Demo Smoke Fixes + Evidence Review', release_type:'patch', runtime_capability_change:false, summary:'Hosted-demo deployment verification and browser evidence capture were added without enabling new live provider, OAuth, backend, source, or storage behavior.', notable_changes:['Added hosted-demo verification metadata and deployment readiness gates.','Added browser evidence capture metadata for desktop, mobile, provider-mode, and quality/export proof.','Added hosted-demo CI/documentation gates while preserving public-demo onboarding.','Removed a stale empty source artifact and hardened repository hygiene checks.'], unchanged_boundaries:['Manual/private mode remains the default.','No production OAuth path is enabled.','No new live source connector is enabled.','No provider key or raw token is exported.','No backend endpoint behavior is changed.'], publish_checklist:['Run no-browser CI gates.','Run hosted-demo browser evidence capture before publishing.','Verify GitHub Pages deployment uses the current package files.','Confirm release archive excludes generated and secret-bearing files.'], release_gate:'release_notes_polished'};
  }
