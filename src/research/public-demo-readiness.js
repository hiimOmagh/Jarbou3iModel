/* Jarbou3i Research Engine public demo readiness + release notes helpers v1.0.8. */
(function(global){
  'use strict';
  ...
  function releaseNotes({version = VERSION, now = nowIso()} = {}){
    return {
      ...
      generated_at:now,
      release_title:'v1.0.8 — Hosted Demo Deployment Verification + Browser Evidence Capture',
      release_type:'patch',
