/* Jarbou3i Research Engine provider fixtures v1.1.0-alpha.13. */
(function(global){
  'use strict';
  ...
  function payload(task){
    ...
    return {
      request_version:'1.1.0-alpha.13',
      provider:'fixture',
      ...
      packet:{workflow_version:'1.1.0-alpha.13'}
    };
  }
  ...
  function runContractFixtureSuite(core = root.providerCore){
    const results = contractFixtures().map((fixture) => {
      ...
      const validation = core.validateProviderResponse(p, response, {version:'1.1.0-alpha.13', nowIso:()=>'2026-04-28T00:00:00.000Z'});
