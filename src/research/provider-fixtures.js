/* Jarbou3i Research Engine provider fixtures v1.1.0-rc.2-fix.1. */
(function(global){
  'use strict';
  ...
  function payload(task){
    ...
    return {
      request_version:'1.1.0-rc.2-fix.1',
      provider:'fixture',
      ...
      packet:{workflow_version:'1.1.0-rc.2-fix.1'}
    };
  }
  ...
  function runContractFixtureSuite(core = root.providerCore){
    const results = contractFixtures().map((fixture) => {
      ...
      const validation = core.validateProviderResponse(p, response, {version:'1.1.0-rc.2-fix.1', nowIso:()=>'2026-04-28T00:00:00.000Z'});
    ...
    return {
      suite_version:'1.1.0-rc.2-fix.1',
