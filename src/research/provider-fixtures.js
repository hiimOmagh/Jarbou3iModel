/* Jarbou3i Research Engine provider fixtures v1.0.25. */
(function(global){
  'use strict';
  ...
  function payload(task){
    ...
    return {
      ...
      packet:{workflow_version:'1.0.25'}
    };
  }
  ...
  function runContractFixtureSuite(core = root.providerCore){
    const results = contractFixtures().map((fixture) => {
      ...
      const validation = core.validateProviderResponse(p, response, {version:'1.0.25', nowIso:()=>'2026-04-28T00:00:00.000Z'});
