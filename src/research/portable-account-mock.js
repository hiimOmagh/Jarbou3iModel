...
(function(){
  ...
  function disconnected(version = '1.0.11'){
    return {
  ...
  function connect({version = '1.0.11', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.11'} = {}){
  ...
  function status(session, {version = '1.0.11'} = {}){
