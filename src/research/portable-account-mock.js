...
(function(){
  ...
  function disconnected(version = '1.3.0'){
    return {
  ...
  function connect({version = '1.3.0', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.3.0'} = {}){
  ...
  function status(session, {version = '1.3.0'} = {}){
