...
(function(){
  ...
  function disconnected(version = '1.0.28'){
    return {
  ...
  function connect({version = '1.0.28', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.28'} = {}){
  ...
  function status(session, {version = '1.0.28'} = {}){
