...
(function(){
  ...
  function disconnected(version = '1.0.7'){
    return {
  ...
  function connect({version = '1.0.7', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.7'} = {}){
  ...
  function status(session, {version = '1.0.7'} = {}){
