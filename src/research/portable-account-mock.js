...
(function(){
  ...
  function disconnected(version = '1.0.15'){
    return {
  ...
  function connect({version = '1.0.15', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.15'} = {}){
  ...
  function status(session, {version = '1.0.15'} = {}){
