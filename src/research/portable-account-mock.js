...
(function(){
  ...
  function disconnected(version = '1.0.16'){
    return {
  ...
  function connect({version = '1.0.16', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.16'} = {}){
  ...
  function status(session, {version = '1.0.16'} = {}){
