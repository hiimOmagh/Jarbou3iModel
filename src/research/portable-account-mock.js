...
(function(){
  ...
  function disconnected(version = '1.0.14'){
    return {
  ...
  function connect({version = '1.0.14', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.14'} = {}){
  ...
  function status(session, {version = '1.0.14'} = {}){
