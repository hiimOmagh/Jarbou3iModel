...
(function(){
  ...
  function disconnected(version = '1.0.23'){
    return {
  ...
  function connect({version = '1.0.23', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.23'} = {}){
  ...
  function status(session, {version = '1.0.23'} = {}){
