...
(function(){
  ...
  function disconnected(version = '1.1.0-rc.1'){
    return {
  ...
  function connect({version = '1.1.0-rc.1', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.1.0-rc.1'} = {}){
  ...
  function status(session, {version = '1.1.0-rc.1'} = {}){
