...
(function(){
  ...
  function disconnected(version = '1.0.18'){
    return {
  ...
  function connect({version = '1.0.18', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.18'} = {}){
  ...
  function status(session, {version = '1.0.18'} = {}){
