...
(function(){
  ...
  function disconnected(version = '1.0.10'){
    return {
  ...
  function connect({version = '1.0.10', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.10'} = {}){
  ...
  function status(session, {version = '1.0.10'} = {}){
