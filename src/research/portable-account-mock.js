...
(function(){
  ...
  function disconnected(version = '1.0.26'){
    return {
  ...
  function connect({version = '1.0.26', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.26'} = {}){
  ...
  function status(session, {version = '1.0.26'} = {}){
