...
(function(){
  ...
  function disconnected(version = '1.0.30'){
    return {
  ...
  function connect({version = '1.0.30', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.30'} = {}){
  ...
  function status(session, {version = '1.0.30'} = {}){
