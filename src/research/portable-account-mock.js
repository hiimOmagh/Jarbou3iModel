...
(function(){
  ...
  function disconnected(version = '1.3.0-alpha.3'){
    return {
  ...
  function connect({version = '1.3.0-alpha.3', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.3.0-alpha.3'} = {}){
  ...
  function status(session, {version = '1.3.0-alpha.3'} = {}){
