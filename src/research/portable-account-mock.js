...
(function(){
  ...
  function disconnected(version = '1.0.13'){
    return {
  ...
  function connect({version = '1.0.13', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.13'} = {}){
  ...
  function status(session, {version = '1.0.13'} = {}){
