...
(function(){
  ...
  function disconnected(version = '1.0.12'){
    return {
  ...
  function connect({version = '1.0.12', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.12'} = {}){
  ...
  function status(session, {version = '1.0.12'} = {}){
