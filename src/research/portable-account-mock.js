...
(function(){
  ...
  function disconnected(version = '1.0.27'){
    return {
  ...
  function connect({version = '1.0.27', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.27'} = {}){
  ...
  function status(session, {version = '1.0.27'} = {}){
