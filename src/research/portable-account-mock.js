...
(function(){
  ...
  function disconnected(version = '1.3.0-alpha.4'){
    return {
  ...
  function connect({version = '1.3.0-alpha.4', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.3.0-alpha.4'} = {}){
  ...
  function status(session, {version = '1.3.0-alpha.4'} = {}){
