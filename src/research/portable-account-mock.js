...
(function(){
  ...
  function disconnected(version = '1.2.0-alpha.8.1'){
    return {
  ...
  function connect({version = '1.2.0-alpha.8.1', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.2.0-alpha.8.1'} = {}){
  ...
  function status(session, {version = '1.2.0-alpha.8.1'} = {}){
