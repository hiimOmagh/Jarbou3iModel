...
(function(){
  ...
  function disconnected(version = '1.0.29'){
    return {
  ...
  function connect({version = '1.0.29', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.29'} = {}){
  ...
  function status(session, {version = '1.0.29'} = {}){
