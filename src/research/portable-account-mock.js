...
(function(){
  ...
  function disconnected(version = '1.1.0-fix.2'){
    return {
  ...
  function connect({version = '1.1.0-fix.2', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.1.0-fix.2'} = {}){
  ...
  function status(session, {version = '1.1.0-fix.2'} = {}){
