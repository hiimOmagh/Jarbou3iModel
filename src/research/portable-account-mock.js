...
(function(){
  ...
  function disconnected(version = '1.0.20'){
    return {
  ...
  function connect({version = '1.0.20', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.20'} = {}){
  ...
  function status(session, {version = '1.0.20'} = {}){
