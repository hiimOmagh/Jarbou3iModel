...
(function(){
  ...
  function disconnected(version = '1.0.22'){
    return {
  ...
  function connect({version = '1.0.22', accountHint = 'demo-portable-user'} = {}){
  ...
  function refresh(session, {version = '1.0.22'} = {}){
  ...
  function status(session, {version = '1.0.22'} = {}){
