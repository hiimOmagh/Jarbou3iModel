  ...
  const contract = Object.freeze({
    ...
    copy: Object.freeze({
      ...
      ar: Object.freeze({
        ...
        hostedDemoVerificationBody: 'التقاط أدلة الاستضافة المستهدفة جاهز لأدلة الإصدار: يجب أن تعتمد أدلة العرض المستضاف الآن على لقطات محددة بالمحدّد، وربط المنطقة بالادعاء، وصناديق حدود، وإثبات رموز متوقعة، وحدود حجم للقطات المستهدفة، واستمرارية لوحة مراحل operator control room، وmanifest يرفض لا دليل بصفحة كاملة فقط. يجب أن تعلن أدلة الاستضافة داخلياً 1.4.0-alpha.44 مع عرض v1.4.0-alpha.44 دلالات مصفوفة الأدلة + تقوية الإثبات المستهدف للمستخدمين. التقاط أدلة فقط: دون نداءات مزوّد حية، دون طلبات شبكة مخفية، دون OAuth أو دورة رموز، دون تخزين بيانات اعتماد، دون جلب مصادر حي، ودون تحقق آلي من المصادر أو توقيع أو قفل تصدير أو حفظ حالة أو تعديل دفعات أو حفظ حالة التنقل أو تصريح نشر. تبقى لقطات الصفحة الكاملة سياقاً فقط؛ يجب أن تستهدف لقطات الإثبات منطقة الواجهة المحددة التي يتم التحقق منها.',
        analysisReleaseNote: 'يضيف 1.4.0-alpha.44 التقاط أدلة الاستضافة المستهدفة مع لقطات محددة بالمحدّد وربط المنطقة بالادعاء وصناديق حدود ورموز متوقعة ورفض دليل الصفحة الكاملة فقط مع البقاء بلا شبكة.',
