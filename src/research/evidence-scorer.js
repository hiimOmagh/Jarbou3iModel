/* Jarbou3i Research Engine source packet builder browser QA and UX tightening — v1.1.0-alpha.16. Separates attention from reliability and explains score meaning. */
(function(global){
  'use strict';
