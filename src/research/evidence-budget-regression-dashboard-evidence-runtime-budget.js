/* Jarbou3i Research Engine evidence budget regression dashboard + evidence/runtime budget v1.4.0-alpha.17. */
...
(function(global){
  ...
  const MILESTONE = 'v1.4.0-alpha.17 — Alpha.16 Lock Completion + Evidence Budget Regression Dashboard';
