...
(function(global){
  ...
  const RELEASE_TITLE = 'v1.2.0-alpha.6 — Operator Command Palette + Review Navigation Shortcuts';
  const ARTIFACT_NAME = 'jarbou3i-research-engine-v1.2.0-alpha.6-post-stable-capability-roadmap-expansion-gate.zip';
