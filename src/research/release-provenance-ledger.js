/* Jarbou3i Research Engine release provenance ledger helpers v1.0.27. */
(function(global){
  'use strict';
  ...
  const REQUIRED_EVIDENCE = Object.freeze([
    {evidence_id:'version_lock', label:'package/schema/fixtures identify v1.0.27', required:true},
    {evidence_id:'base_version_recorded', label:'base version v1.0.26 is recorded', required:true},
  ...
  function buildReleaseProvenanceLedger(input = {}, {version = VERSION, baseVersion = BASE_VERSION, now = nowIso(), artifactName = ARTIFACT_NAME, artifactSha256 = 'computed_after_packaging'} = {}){
    ...
    return {
      ...
      generated_at: now,
      release_title: `v${version} — Release Provenance Ledger Gate`,
      ...
      blocked_claims: [
        ...
        'Do not publish from a patch that was not applied to v1.0.26 and revalidated.',
