...
(function(global){
  ...
  const RELEASE_TITLE = 'v1.2.0-alpha.5 — Claim Traceability Console + Review Decision Ledger';
  const ARTIFACT_NAME = 'jarbou3i-research-engine-v1.2.0-alpha.5-post-stable-capability-roadmap-expansion-gate.zip';
