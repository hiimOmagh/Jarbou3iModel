...
(function(global){
  ...
  const RELEASE_TITLE = 'v1.3.0-alpha.6 — Operator Signoff State + Export Lock Ledger';
  const ARTIFACT_NAME = 'jarbou3i-research-engine-v1.3.0-alpha.6-post-stable-capability-roadmap-expansion-gate.zip';
